...
SuitAttributes = {
    'f': {
        'name': Localizer.SuitFlunky,
        'singularname': Localizer.SuitFlunkyS,
        'pluralname': Localizer.SuitFlunkyP,
        'level': 0,
        'hp': (6, 12, 20, 30, 42),
        'def': (2, 5, 10, 12, 15),
        'freq': (50, 30, 10, 5, 5),
    ...
    'p': {
        'name': Localizer.SuitPencilPusher,
        'singularname': Localizer.SuitPencilPusherS,
        'pluralname': Localizer.SuitPencilPusherP,
        'level': 1,
        'hp': (12, 20, 30, 42, 56),
        'def': (5, 10, 15, 20, 25),
        'freq': (50, 30, 10, 5, 5),
    ...
    'ym': {
        'name': Localizer.SuitYesman,
        'singularname': Localizer.SuitYesmanS,
        'pluralname': Localizer.SuitYesmanP,
        'level': 2,
        'hp': (20, 30, 42, 56, 72),
        'def': (10, 15, 20, 25, 30),
        'freq': (50, 30, 10, 5, 5),
    ...
    'mm': {
        'name': Localizer.SuitMicromanager,
        'singularname': Localizer.SuitMicromanagerS,
        'pluralname': Localizer.SuitMicromanagerP,
        'level': 3,
        'hp': (30, 42, 56, 72, 90),
        'def': (15, 20, 25, 30, 35),
        'freq': (50, 30, 10, 5, 5),
    ...
    'ds': {
        'name': Localizer.SuitDownsizer,
        'singularname': Localizer.SuitDownsizerS,
        'pluralname': Localizer.SuitDownsizerP,
        'level': 4,
        'hp': (42, 56, 72, 90, 110),
        'def': (20, 25, 30, 35, 40),
        'freq': (50, 30, 10, 5, 5),
        'acc': (35, 40, 45, 50, 55),
        'attacks': (('Canned', (5, 6, 8, 10, 12), (60, 75, 80, 85, 90), (25, 25, 25, 25, 25)), ('Downsize', (8, 9, 11, 13, 15), (50, 65, 70, 75, 80), (35, 35, 35, 35, 35)), ('PinkSlip', (4, 5, 6, 7, 8), (60, 65, 75, 80, 85), (25, 25, 25, 25, 25)), ('ReOrg', (6, 8, 10, 12, 14), (70, 75, 80, 85, 90), (0, 0, 0, 0, 0)), ('Sacked', (5, 6, 7, 8, 9), (50, 50, 50, 50, 50), (15, 15, 15, 15, 15))) },
    'hh': {
        'name': Localizer.SuitHeadHunter,
        'singularname': Localizer.SuitHeadHunterS,
        'pluralname': Localizer.SuitHeadHunterP,
        'level': 5,
        'hp': (56, 72, 90, 110, 132),
        'def': (25, 30, 35, 40, 45),
        'freq': (50, 30, 10, 5, 5),
    ...
    'cr': {
        'name': Localizer.SuitCorporateRaider,
        'singularname': Localizer.SuitCorporateRaiderS,
        'pluralname': Localizer.SuitCorporateRaiderP,
        'level': 6,
    ...
    'tbc': {
        'name': Localizer.SuitTheBigCheese,
        'singularname': Localizer.SuitTheBigCheeseS,
        'pluralname': Localizer.SuitTheBigCheeseP,
        'level': 7,
    ...
    'cc': {
        'name': Localizer.SuitColdCaller,
        'singularname': Localizer.SuitColdCallerS,
        'pluralname': Localizer.SuitColdCallerP,
        'level': 0,
        'hp': (6, 12, 20, 30, 42),
        'def': (2, 5, 10, 12, 15),
        'freq': (50, 30, 10, 5, 5),
    ...
    'tm': {
        'name': Localizer.SuitTelemarketer,
        'singularname': Localizer.SuitTelemarketerS,
        'pluralname': Localizer.SuitTelemarketerP,
        'level': 1,
        'hp': (12, 20, 30, 42, 56),
        'def': (5, 10, 15, 20, 25),
        'freq': (50, 30, 10, 5, 5),
    ...
    'nd': {
        'name': Localizer.SuitNameDropper,
        'singularname': Localizer.SuitNameDropperS,
        'pluralname': Localizer.SuitNameDropperP,
        'level': 2,
        'hp': (20, 30, 42, 56, 72),
        'def': (10, 15, 20, 25, 30),
        'freq': (50, 30, 10, 5, 5),
    ...
    'gh': {
        'name': Localizer.SuitGladHander,
        'singularname': Localizer.SuitGladHanderS,
        'pluralname': Localizer.SuitGladHanderP,
        'level': 3,
        'hp': (30, 42, 56, 72, 90),
        'def': (15, 20, 25, 30, 35),
        'freq': (50, 30, 10, 5, 5),
    ...
    'ms': {
        'name': Localizer.SuitMoverShaker,
        'singularname': Localizer.SuitMoverShakerS,
        'pluralname': Localizer.SuitMoverShakerP,
        'level': 4,
        'hp': (42, 56, 72, 90, 110),
        'def': (20, 25, 30, 35, 40),
        'freq': (50, 30, 10, 5, 5),
    ...
    'tf': {
        'name': Localizer.SuitTwoFace,
        'singularname': Localizer.SuitTwoFaceS,
        'pluralname': Localizer.SuitTwoFaceP,
        'level': 5,
        'hp': (56, 72, 90, 110, 132),
        'def': (25, 30, 35, 40, 45),
        'freq': (50, 30, 10, 5, 5),
    ...
    'm': {
        'name': Localizer.SuitTheMingler,
        'singularname': Localizer.SuitTheMinglerS,
        'pluralname': Localizer.SuitTheMinglerP,
        'level': 6,
        'hp': (72, 90, 110, 132, 156),
        'def': (30, 35, 40, 45, 50),
        'freq': (50, 30, 10, 5, 5),
    ...
    'mh': {
        'name': Localizer.SuitMrHollywood,
        'singularname': Localizer.SuitMrHollywoodS,
        'pluralname': Localizer.SuitMrHollywoodP,
        'level': 7,
        'hp': (90, 110, 132, 156, 200),
        'def': (35, 40, 45, 50, 55),
        'freq': (50, 30, 10, 5, 5),
        'acc': (35, 40, 45, 50, 55),
        'attacks': (('PowerTrip', (10, 12, 15, 18, 20), (55, 65, 75, 85, 95), (50, 50, 50, 50, 50)), ('RazzleDazzle', (8, 11, 14, 17, 20), (70, 75, 85, 90, 95), (50, 50, 50, 50, 50)), ('SandTrap', (14, 15, 17, 19, 20), (60, 65, 70, 75, 80), (0, 0, 0, 0, 0)), ('SongAndDance', (12, 14, 16, 18, 20), (65, 75, 80, 85, 95), (0, 0, 0, 0, 0))) },
    'sc': {
        'name': Localizer.SuitShortChange,
        'singularname': Localizer.SuitShortChangeS,
        'pluralname': Localizer.SuitShortChangeP,
        'level': 0,
        'hp': (6, 12, 20, 30, 42),
        'def': (2, 5, 10, 12, 15),
        'freq': (50, 30, 10, 5, 5),
    ...
    'pp': {
        'name': Localizer.SuitPennyPincher,
        'singularname': Localizer.SuitPennyPincherS,
        'pluralname': Localizer.SuitPennyPincherP,
        'level': 1,
        'hp': (12, 20, 30, 42, 56),
        'def': (5, 10, 15, 20, 25),
        'freq': (50, 30, 10, 5, 5),
    ...
    'tw': {
        'name': Localizer.SuitTightwad,
        'singularname': Localizer.SuitTightwadS,
        'pluralname': Localizer.SuitTightwadP,
        'level': 2,
        'hp': (20, 30, 42, 56, 72),
        'def': (10, 15, 20, 25, 30),
        'freq': (50, 30, 10, 5, 5),
    ...
    'bc': {
        'name': Localizer.SuitBeanCounter,
        'singularname': Localizer.SuitBeanCounterS,
        'pluralname': Localizer.SuitBeanCounterP,
        'level': 3,
        'hp': (30, 42, 56, 72, 90),
        'def': (15, 20, 25, 30, 35),
        'freq': (50, 30, 10, 5, 5),
    ...
    'nc': {
        'name': Localizer.SuitNumberCruncher,
        'singularname': Localizer.SuitNumberCruncherS,
        'pluralname': Localizer.SuitNumberCruncherP,
        'level': 4,
        'hp': (42, 56, 72, 90, 110),
        'def': (20, 25, 30, 35, 40),
        'freq': (50, 30, 10, 5, 5),
    ...
    'mb': {
        'name': Localizer.SuitMoneyBags,
        'singularname': Localizer.SuitMoneyBagsS,
        'pluralname': Localizer.SuitMoneyBagsP,
        'level': 5,
        'hp': (56, 72, 90, 110, 132),
        'def': (25, 30, 35, 40, 45),
        'freq': (50, 30, 10, 5, 5),
    ...
    'ls': {
        'name': Localizer.SuitLoanShark,
        'singularname': Localizer.SuitLoanSharkS,
        'pluralname': Localizer.SuitLoanSharkP,
        'level': 6,
        'hp': (72, 90, 110, 132, 156),
        'def': (30, 35, 40, 45, 50),
        'freq': (50, 30, 10, 5, 5),
    ...
    'rb': {
        'name': Localizer.SuitRobberBaron,
        'singularname': Localizer.SuitRobberBaronS,
        'pluralname': Localizer.SuitRobberBaronP,
        'level': 7,
        'hp': (90, 110, 132, 156, 200),
        'def': (35, 40, 45, 50, 55),
        'freq': (50, 30, 10, 5, 5),
        'acc': (35, 40, 45, 50, 55),
        'attacks': (('FiveOClockShadow', (14, 17, 19, 21, 24), (55, 65, 75, 85, 95), (0, 0, 0, 0, 0)), ('FloodTheMarket', (12, 15, 18, 21, 24), (70, 75, 85, 90, 95), (0, 0, 0, 0, 0)), ('PowerTrip', (11, 14, 16, 18, 21), (60, 65, 70, 75, 80), (50, 50, 50, 50, 50)), ('TeeOff', (10, 12, 14, 16, 18), (60, 65, 75, 85, 90), (50, 50, 50, 50, 50))) },
    'bf': {
        'name': Localizer.SuitBottomFeeder,
        'singularname': Localizer.SuitBottomFeederS,
        'pluralname': Localizer.SuitBottomFeederP,
        'level': 0,
        'hp': (6, 12, 20, 30, 42),
        'def': (2, 5, 10, 12, 15),
        'freq': (50, 30, 10, 5, 5),
    ...
    'b': {
        'name': Localizer.SuitBloodsucker,
        'singularname': Localizer.SuitBloodsuckerS,
        'pluralname': Localizer.SuitBloodsuckerP,
        'level': 1,
        'hp': (12, 20, 30, 42, 56),
        'def': (5, 10, 15, 20, 25),
        'freq': (50, 30, 10, 5, 5),
    ...
    'dt': {
        'name': Localizer.SuitDoubleTalker,
        'singularname': Localizer.SuitDoubleTalkerS,
        'pluralname': Localizer.SuitDoubleTalkerP,
        'level': 2,
        'hp': (20, 30, 42, 56, 72),
        'def': (10, 15, 20, 25, 30),
        'freq': (50, 30, 10, 5, 5),
    ...
    'ac': {
        'name': Localizer.SuitAmbulanceChaser,
        'singularname': Localizer.SuitAmbulanceChaserS,
        'pluralname': Localizer.SuitAmbulanceChaserP,
        'level': 3,
        'hp': (30, 42, 56, 72, 90),
        'def': (15, 20, 25, 30, 35),
        'freq': (50, 30, 10, 5, 5),
    ...
    'bs': {
        'name': Localizer.SuitBackStabber,
        'singularname': Localizer.SuitBackStabberS,
        'pluralname': Localizer.SuitBackStabberP,
        'level': 4,
        'hp': (42, 56, 72, 90, 110),
        'def': (20, 25, 30, 35, 40),
        'freq': (50, 30, 10, 5, 5),
    ...
    'sd': {
        'name': Localizer.SuitSpinDoctor,
        'singularname': Localizer.SuitSpinDoctorS,
        'pluralname': Localizer.SuitSpinDoctorP,
        'level': 5,
        'hp': (56, 72, 90, 110, 132),
        'def': (25, 30, 35, 40, 45),
        'freq': (50, 30, 10, 5, 5),
    ...
    'le': {
        'name': Localizer.SuitLegalEagle,
        'singularname': Localizer.SuitLegalEagleS,
        'pluralname': Localizer.SuitLegalEagleP,
        'level': 6,
        'hp': (72, 90, 110, 132, 156),
        'def': (30, 35, 40, 45, 50),
        'freq': (50, 30, 10, 5, 5),
    ...
    'bw': {
        'name': Localizer.SuitBigWig,
        'singularname': Localizer.SuitBigWigS,
        'pluralname': Localizer.SuitBigWigP,
        'level': 7,
        'hp': (90, 110, 132, 156, 200),
        'def': (35, 40, 45, 50, 55),
        'freq': (50, 30, 10, 5, 5),
        'acc': (35, 40, 45, 50, 55),
        'attacks': (('CigarSmoke', (12, 14, 16, 18, 20), (65, 75, 85, 90, 95), (0, 0, 0, 0, 0)), ('Gavel', (14, 16, 19, 22, 24), (70, 75, 85, 90, 95), (0, 0, 0, 0, 0)), ('PowerTrip', (10, 11, 13, 15, 16), (75, 80, 85, 90, 95), (50, 50, 50, 50, 50)), ('ThrowBook', (13, 15, 17, 19, 21), (80, 85, 85, 85, 90), (50, 50, 50, 50, 50))) } }
ATK_TGT_UNKNOWN = 1
ATK_TGT_SINGLE = 2
ATK_TGT_GROUP = 3
SuitAttacks = {
...
def getFaceoffTaunt(suitName, doId):
    if SuitFaceoffTaunts.has_key(suitName):
        ...
        taunts = Localizer.SuitFaceoffDefaultTaunts
    return taunts[doId % len(taunts)]

SuitFaceoffTaunts = Localizer.SuitFaceoffTaunts
...
SuitAttackTaunts = Localizer.SuitAttackTaunts
