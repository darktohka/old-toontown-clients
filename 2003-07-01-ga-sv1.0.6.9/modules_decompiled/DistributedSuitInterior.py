...
class DistributedSuitInterior(DistributedObject.DistributedObject):
    ...
    def handleAnnounceGenerate(self, obj):
        ...
        self.sendUpdate('setAvatarJoined', [
            ...
            toonbase.localToon.getStyle().makeNetString()])
    ...
    def _DistributedSuitInterior__playElevator(self, ts, name, callback):
        ...
        track = Sequence(Wait(0.5), LerpPosInterval(camera, 0.5, Point3(0, 14, 3.7999999999999998), startPos = Point3(0, 14, 4), blendType = 'easeOut'), LerpPosInterval(camera, 0.5, Point3(0, 14, 4), startPos = Point3(0, 14, 3.7999999999999998)), Wait(BattleBase.ELEVATOR_T - 3.0), LerpPosInterval(camera, 0.5, Point3(0, 14, 4.2000000000000002), startPos = Point3(0, 14, 4), blendType = 'easeOut'), LerpPosInterval(camera, 1.0, Point3(0, 14, 4), startPos = Point3(0, 14, 4.2000000000000002)), Parallel(SoundInterval(self.openSfx), LerpPosInterval(self.leftDoorIn, ELEVATOR_OPEN_TIME, Point3(0, 0, 0), startPos = Point3(3.5, 0, 0), blendType = 'easeOut'), LerpPosInterval(self.rightDoorIn, ELEVATOR_OPEN_TIME, Point3(0, 0, 0), startPos = Point3(-3.5, 0, 0), blendType = 'easeOut')), Func(camera.wrtReparentTo, render))
        for toon in self.toons:
