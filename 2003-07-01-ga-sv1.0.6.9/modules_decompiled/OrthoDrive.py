...
class OrthoDrive:
    ...
    def start(self):
        ...
        taskMgr.add(self._OrthoDrive__update, self.TASK_NAME, priority = self.priority)
    ...
    def stop(self):
        ...
        taskMgr.remove(self.SET_ATREST_HEADING_TASK)
        ...
        toonbase.localToon.setSpeed(0, 0)
            ...
            if not yVel:
                ...
                if self.lastXVel and self.lastYVel:
                    ...
                    if not yVel:
                        ...
                        taskMgr.doMethodLater(0.050000000000000003, setAtRestHeading, self.SET_ATREST_HEADING_TASK)
                    else:
