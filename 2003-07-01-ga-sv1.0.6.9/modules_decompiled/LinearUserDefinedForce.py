...
class LinearUserDefinedForce(LinearForce.LinearForce, FFIExternalObject.FFIExternalObject):
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._LinearUserDefinedForce__overloaded_constructor()
        elif numArgs == 1:
            if isinstance(_args[0], LinearUserDefinedForce):
                return self._LinearUserDefinedForce__overloaded_constructor_ptrConstLinearUserDefinedForce(_args[0])
            else:
