...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    def load(self):
        ...
        self.deleteHelpText = DirectLabel(parent = self.invFrame, relief = None, pos = (0.27200000000000002, 0.29999999999999999, -0.90700000000000003), text = Localizer.InventoryDeleteHelp, text_fg = (0, 0, 0, 1), text_scale = 0.080000000000000002, textMayChange = 0)
        self.deleteHelpText.hide()
        self.detailFrame = DirectFrame(parent = self.invFrame, relief = None, pos = (1.05, 0, -0.080000000000000002))
        self.detailNameLabel = DirectLabel(parent = self.detailFrame, text = '', text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), scale = 0.050000000000000003, pos = (0.01, 0, 0), text_font = getInterfaceFont(), relief = None, image = self.invModels[0][0])
        self.detailAmountLabel = DirectLabel(parent = self.detailFrame, text = '', text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), scale = 0.050000000000000003, pos = (0.19, 0, -0.19), text_font = getInterfaceFont(), text_align = TextNode.ARight, relief = None)
        self.detailDataLabel = DirectLabel(parent = self.detailFrame, text = '', text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), scale = 0.050000000000000003, pos = (-0.19, 0, -0.23999999999999999), text_font = getInterfaceFont(), text_align = TextNode.ALeft, relief = None)
        self.detailCreditLabel = DirectLabel(parent = self.detailFrame, text = Localizer.InventorySkillCreditNone, text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), scale = 0.050000000000000003, pos = (-0.19, 0, -0.39000000000000001), text_font = getInterfaceFont(), text_align = TextNode.ALeft, relief = None)
        self.detailCreditLabel.hide()
        self.totalLabel = DirectLabel(text = '', parent = self.detailFrame, pos = (0.0050000000000000001, 0, -0.095000000000000001), scale = 0.050000000000000003, text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), text_font = getInterfaceFont(), relief = None)
        ...
        for track in range(0, len(Tracks)):
            ...
            self.trackNameLabels.append(DirectLabel(text = Tracks[track].upper(), parent = self.trackRows[track], pos = (-0.71999999999999997, -0.10000000000000001, 0.01), scale = 0.050000000000000003, relief = None, text_fg = (0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 1), text_font = getInterfaceFont(), text_align = TextNode.ALeft, textMayChange = 0))
    ...
    def showDetail(self, track, level):
        ...
        self.detailAmountLabel.configure(text = Localizer.InventoryDetailAmount % {
            'numItems': self.numItem(track, level),
            'maxItems': self.getMax(track, level) })
        self.detailDataLabel.show()
        self.detailDataLabel.configure(text = Localizer.InventoryDetailData % {
        ...
        if self.itemIsCredit(track, level):
            self.setDetailCredit(track, (level + 1) * self._InventoryNew__battleCreditMultiplier * self._InventoryNew__invasionCreditMultiplier)
        else:
    ...
    def purchaseDeleteActivateButtons(self):
        ...
        self.detailFrame.setPos(1.1000000000000001, 0, 0)
    ...
    def battleActivateButtons(self):
        ...
        self.invFrame.setScale(1)
        self.detailFrame.setPos(1.05, 0, -0.080000000000000002)
    ...
    def showTrack(self, trackIndex):
        ...
        self.trackBars[trackIndex]['text'] = Localizer.InventoryTrackExp % {
            'curExp': curExp,
            'nextExp': nextExp }
        return None
    ...
    def updateGUI(self, track = None, level = None):
        ...
        if track == None and level == None:
            for track in range(len(Tracks)):
                ...
                self.trackBars[track]['text'] = Localizer.InventoryTrackExp % {
                    'curExp': curExp,
                    'nextExp': nextExp }
    ...
    def loadBattleFrame(self):
        ...
        self.runButton = DirectButton(parent = self.battleFrame, relief = None, pos = (0.68000000000000005, 0, -0.39600000000000002), text = Localizer.InventoryRun, text_scale = 0.050000000000000003, text_pos = (0, -0.02), text_fg = Vec4(1, 1, 1, 1), textMayChange = 0, image = (self.upButton, self.downButton, self.rolloverButton), image_scale = 1.05, image_color = (0, 0.59999999999999998, 1, 1), command = self._InventoryNew__handleRun)
        self.sosButton = DirectButton(parent = self.battleFrame, relief = None, pos = (0.91000000000000003, 0, -0.39600000000000002), text = Localizer.InventorySOS, text_scale = 0.050000000000000003, text_pos = (0, -0.02), text_fg = Vec4(1, 1, 1, 1), textMayChange = 0, image = (self.upButton, self.downButton, self.rolloverButton), image_scale = 1.05, image_color = (0, 0.59999999999999998, 1, 1), command = self._InventoryNew__handleSOS)
        self.passButton = DirectButton(parent = self.battleFrame, relief = None, pos = (0.91000000000000003, 0, -0.23699999999999999), text = Localizer.InventoryPass, text_scale = 0.050000000000000003, text_pos = (0, -0.02), text_fg = Vec4(1, 1, 1, 1), textMayChange = 0, image = (self.upButton, self.downButton, self.rolloverButton), image_scale = 1.05, image_color = (0, 0.59999999999999998, 1, 1), command = self._InventoryNew__handlePass)
        self.tutText = DirectFrame(parent = self.battleFrame, relief = None, pos = (0.14999999999999999, 0, -0.1133), scale = 0.14299999999999999, image = getDefaultDialogGeom(), image_scale = 5.125, image_pos = (0, 0, -0.65000000000000002), image_color = ToontownGlobals.GlobalDialogColor, text = Localizer.InventoryClickToAttack, textMayChange = 0)
        self.tutText.hide()
