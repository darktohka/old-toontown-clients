...
class SuitPage(ShtikerPage.ShtikerPage):
    ...
    def addQuotaLabel(self, panel):
        ...
        quotaLabel = DirectLabel(parent = panel, pos = (0.0, 0.0, -0.215), relief = None, state = DISABLED, text = count + ' of ' + quota, text_scale = 0.065000000000000002, text_fg = (0, 0, 0, 1), text_font = ToontownGlobals.getSuitFont())
