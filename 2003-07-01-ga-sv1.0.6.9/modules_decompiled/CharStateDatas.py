...
class CharNeutralState(StateData.StateData):
    ...
    def enter(self, startTrack = None, playRate = None):
        ...
        self._CharNeutralState__neutralTrack.play()

    
    def exit(self):
        StateData.StateData.exit(self)
        self._CharNeutralState__neutralTrack.stop()
        self._CharNeutralState__neutralTrack.setFinalT()
...
class CharWalkState(StateData.StateData):
    ...
    def enter(self, startTrack = None, playRate = None):
        ...
        self._CharWalkState__walkTrack.play(ts)
    ...
    def exit(self):
        ...
        self._CharWalkState__walkTrack.stop()
        self._CharWalkState__walkTrack.setFinalT()
