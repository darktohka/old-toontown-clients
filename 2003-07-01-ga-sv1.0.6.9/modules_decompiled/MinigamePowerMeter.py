...
class MinigamePowerMeter(DirectFrame):
    ...
    def __init__(self, size, label = None):
        ...
        self.tooSlow = DirectLabel(parent = self, relief = None, text = Localizer.MinigamePowerMeterTooSlow, scale = 0.070000000000000007, pos = (-0.14999999999999999, 0, 0.050000000000000003), color = (0.10000000000000001, 0.29999999999999999, 0.59999999999999998))
        self.tooFast = DirectLabel(parent = self, relief = None, text = Localizer.MinigamePowerMeterTooFast, scale = 0.070000000000000007, pos = (0.14999999999999999, 0, 0.050000000000000003), color = (0.10000000000000001, 0.29999999999999999, 0.59999999999999998))
        self.tooSlow.hide()
        self.tooFast.hide()
        self.largeGauge = []
        self.gaugeSize = size
