    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._ParametricCurveCollection__overloaded_write_ptrConstParametricCurveCollection_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ParametricCurveCollection__overloaded_write_ptrConstParametricCurveCollection_ptrOstream_int(_args[0], _args[1])
                else:
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    return self._ParametricCurveCollection__overloaded_adjustHpr_ptrParametricCurveCollection_float_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            return self._ParametricCurveCollection__overloaded_adjustHpr_ptrParametricCurveCollection_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                        else:
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], Mat4.Mat4):
                    return self._ParametricCurveCollection__overloaded_evaluate_ptrConstParametricCurveCollection_float_ptrLMatrix4f(_args[0], _args[1])
                else:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        return self._ParametricCurveCollection__overloaded_evaluate_ptrConstParametricCurveCollection_float_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2])
                    else:
                    ...
                    if isinstance(_args[2], types.IntType):
                        return self._ParametricCurveCollection__overloaded_evaluate_ptrConstParametricCurveCollection_float_ptrLMatrix4f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                    else:
    ...
    def adjustXyz(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return self._ParametricCurveCollection__overloaded_adjustXyz_ptrParametricCurveCollection_float_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            return self._ParametricCurveCollection__overloaded_adjustXyz_ptrParametricCurveCollection_float_float_float_float(_args[0], _args[1], _args[2], _args[3])
                        else:
                            raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def writeEgg(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Filename.Filename):
                return self._ParametricCurveCollection__overloaded_writeEgg_ptrParametricCurveCollection_ptrFilename(_args[0])
            else:
            ...
            if isinstance(_args[0], Filename.Filename):
                if isinstance(_args[1], types.IntType):
                    return self._ParametricCurveCollection__overloaded_writeEgg_ptrParametricCurveCollection_ptrFilename___enum__CoordinateSystem(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Filename.Filename> '
            ...
            if isinstance(_args[0], Ostream.Ostream):
                ...
                if isinstance(_args[1], Filename.Filename):
                    if isinstance(_args[2], types.IntType):
                        return self._ParametricCurveCollection__overloaded_writeEgg_ptrParametricCurveCollection_ptrOstream_ptrConstFilename___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.IntType> '
                else:
    ...
    def removeCurve(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self._ParametricCurveCollection__overloaded_removeCurve_ptrParametricCurveCollection_int(_args[0])
            elif isinstance(_args[0], ParametricCurve.ParametricCurve):
                return self._ParametricCurveCollection__overloaded_removeCurve_ptrParametricCurveCollection_ptrParametricCurve(_args[0])
            else:
    ...
    def addCurve(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], ParametricCurve.ParametricCurve):
                return self._ParametricCurveCollection__overloaded_addCurve_ptrParametricCurveCollection_ptrParametricCurve(_args[0])
            else:
            ...
            if isinstance(_args[0], ParametricCurve.ParametricCurve):
                if isinstance(_args[1], types.IntType):
                    return self._ParametricCurveCollection__overloaded_addCurve_ptrParametricCurveCollection_ptrParametricCurve_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <ParametricCurve.ParametricCurve> '
