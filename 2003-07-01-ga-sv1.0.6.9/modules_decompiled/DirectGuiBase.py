...
class DirectGuiWidget(DirectGuiBase, NodePath):
    ...
    def __init__(self, parent = aspect2d, **kw):
        optiondefs = (('pgFunc', PGItem, None), ('numStates', 1, None), ('invertedFrames', (), None), ('sortOrder', 0, None), ('state', NORMAL, self.setState), ('relief', FLAT, self.setRelief), ('borderWidth', (0.10000000000000001, 0.10000000000000001), self.setBorderWidth), ('frameSize', None, self.setFrameSize), ('frameColor', (0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 1), self.setFrameColor), ('pad', (0, 0), self.resetFrameSize), ('guiId', None, INITOPT), ('pos', None, INITOPT), ('scale', None, INITOPT), ('color', None, INITOPT), ('suppressMouse', 1, INITOPT), ('suppressKeys', 0, INITOPT), ('enableEdit', 1, INITOPT))
