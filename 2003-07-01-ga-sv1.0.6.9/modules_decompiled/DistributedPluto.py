...
class DistributedPluto(DistributedCCharBase.DistributedCCharBase):
    ...
    def __init__(self, cr):
        ...
        try:
            ...
            DistributedCCharBase.DistributedCCharBase.__init__(self, cr, 'Pluto', 'p')
    ...
    def stand(self):
        for shadow in self.dropShadows:
            shadow.setScale(0.90000000000000002, 1.3500000000000001, 0.90000000000000002)
    ...
    def sit(self):
        for shadow in self.dropShadows:
            shadow.setScale(0.90000000000000002)
