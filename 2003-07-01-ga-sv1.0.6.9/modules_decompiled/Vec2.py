...
class Vec2(VBase2.VBase2, FFIExternalObject.FFIExternalObject):
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._Vec2__overloaded_constructor()
        elif numArgs == 1:
            import VBase2
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._Vec2__overloaded_constructor_float(_args[0])
            elif isinstance(_args[0], VBase2.VBase2):
                return self._Vec2__overloaded_constructor_ptrConstLVecBase2f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase2.VBase2> '
        elif numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self._Vec2__overloaded_constructor_float_float(_args[0], _args[1])
                else:
    ...
    def __sub__(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._Vec2__overloaded___sub___ptrConstLVector2f()
        elif numArgs == 1:
            import VBase2
            if isinstance(_args[0], VBase2.VBase2):
                return self._Vec2__overloaded___sub___ptrConstLVector2f_ptrConstLVecBase2f(_args[0])
            elif isinstance(_args[0], Vec2):
                return self._Vec2__overloaded___sub___ptrConstLVector2f_ptrConstLVector2f(_args[0])
            else:
    ...
    def assign(self, *_args):
        ...
        if numArgs == 1:
            import VBase2
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._Vec2__overloaded_assign_ptrLVector2f_float(_args[0])
            elif isinstance(_args[0], VBase2.VBase2):
                return self._Vec2__overloaded_assign_ptrLVector2f_ptrConstLVecBase2f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> <VBase2.VBase2> '
        else:
    ...
    def __add__(self, *_args):
        ...
        if numArgs == 1:
            import VBase2
            if isinstance(_args[0], VBase2.VBase2):
                return self._Vec2__overloaded___add___ptrConstLVector2f_ptrConstLVecBase2f(_args[0])
            elif isinstance(_args[0], Vec2):
                return self._Vec2__overloaded___add___ptrConstLVector2f_ptrConstLVector2f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase2.VBase2> <Vec2> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
