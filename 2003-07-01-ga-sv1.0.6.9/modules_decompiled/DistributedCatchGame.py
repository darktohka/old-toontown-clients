...
from PythonUtil import Functor, bound, lineupPos, lerp
import FSM
import State
import Localizer
...
class DistributedCatchGame(DistributedMinigame):
    ...
    DropObjectPlurals = {
        'apple': Localizer.CatchGameApples,
        'orange': Localizer.CatchGameOranges,
        'pear': Localizer.CatchGamePears,
        'coconut': Localizer.CatchGameCoconuts,
        'watermelon': Localizer.CatchGameWatermelons,
        'pineapple': Localizer.CatchGamePineapples,
        'anvil': Localizer.CatchGameAnvils }
    ...
    def getTitle(self):
        return Localizer.CatchGameTitle

    
    def getInstructions(self):
        return Localizer.CatchGameInstructions % {
    ...
    def setEveryoneDone(self):
        ...
        if self.fruitsCaught >= self.numFruits:
            ...
            perfectTextSubnode = hidden.attachNewNode(self._DistributedCatchGame__genText(Localizer.CatchGamePerfect))
