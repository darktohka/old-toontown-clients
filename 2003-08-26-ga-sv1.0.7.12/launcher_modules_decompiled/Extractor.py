...
class Extractor(FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpandaexpress and libpandaexpress._inP2KOdv_o6:
            libpandaexpress._inP2KOdv_o6(self.this)
    ...
    def setExtractDir(self, extractDir):
        returnValue = libpandaexpress._inP2KOdawYp(self.this, extractDir.this)
        return returnValue
    ...
    def requestSubfile(self, subfileName):
        returnValue = libpandaexpress._inP2KOd12R_(self.this, subfileName.this)
        return returnValue
    ...
    def step(self):
        returnValue = libpandaexpress._inP2KOdDcut(self.this)
        return returnValue

    
    def getProgress(self):
        returnValue = libpandaexpress._inP2KOdgtp3(self.this)
        return returnValue
