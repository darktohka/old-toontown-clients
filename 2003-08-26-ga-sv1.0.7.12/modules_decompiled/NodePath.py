...
class NodePath(FFIExternalObject.FFIExternalObject):
    ...
    def _NodePath__overloaded_setVelocity_ptrNodePath_ptrConstLVector3f(self, velocity):
        returnValue = libpanda._inPkJyoRtX_(self.this, velocity.this)
        return returnValue

    
    def _NodePath__overloaded_setVelocity_ptrNodePath_ptrConstNodePath_ptrConstLVector3f(self, other, velocity):
        returnValue = libpanda._inPkJyoTZ5y(self.this, other.this, velocity.this)
        return returnValue

    
    def clearVelocity(self):
        returnValue = libpanda._inPkJyof692(self.this)
        return returnValue

    
    def hasVelocity(self):
        returnValue = libpanda._inPkJyoIl_5(self.this)
        return returnValue

    
    def _NodePath__overloaded_getVelocity_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyotlxR(self.this)
        import Vec3
        returnObject = Vec3.Vec3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_getVelocity_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoknTG(self.this, other.this)
        import Vec3
        returnObject = Vec3.Vec3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def getNetVelocity(self):
        returnValue = libpanda._inPkJyoTafU(self.this)
        import Vec3
        returnObject = Vec3.Vec3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def getVelocity(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getVelocity_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getVelocity_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setVelocity(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Vec3.Vec3):
                return self._NodePath__overloaded_setVelocity_ptrNodePath_ptrConstLVector3f(_args[0])
            else:
            ...
            if isinstance(_args[0], NodePath):
                import Vec3
                if isinstance(_args[1], Vec3.Vec3):
                    return self._NodePath__overloaded_setVelocity_ptrNodePath_ptrConstNodePath_ptrConstLVector3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <Vec3.Vec3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
