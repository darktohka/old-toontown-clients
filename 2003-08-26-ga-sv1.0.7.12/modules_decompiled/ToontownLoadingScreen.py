...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.gui.find('**/trolley').removeNode()
        self.gui.find('**/runner').removeNode()
        ...
        self.tip = DirectLabel(guiId = 'ToontownLoadingScreenWaitBar', parent = self.banner, relief = None, text = '', text_scale = 0.17999999999999999, textMayChange = 1, pos = (-1.2, 0.0, 0.10000000000000001), text_fg = (0.40000000000000002, 0.29999999999999999, 0.20000000000000001, 1), text_wordwrap = 13, text_align = TextNode.ALeft)
        self.title = DirectLabel(guiId = 'ToontownLoadingScreenWaitBar', parent = self.gui, relief = None, pos = (-1.0600000000000001, 0, -0.77000000000000002), text = '', textMayChange = 1, text_scale = 0.080000000000000002, text_fg = (0, 0, 0.5, 1), text_align = TextNode.ALeft)
    ...
    def getTip(self, tipCategory):
        return Localizer.TipTitle + '\n' + random.choice(Localizer.TipDict.get(tipCategory))
