...
class ActorNode(PhysicalNode.PhysicalNode, FFIExternalObject.FFIExternalObject):
    ...
    def _ActorNode__overloaded_constructor_ptrConstActorNode(self, copy):
        self.this = libpandaphysics._inP9fJJBS52(copy.this)
        self.userManagesMemory = 1

    
    def _ActorNode__overloaded_constructor_atomicstring(self, name):
        self.this = libpandaphysics._inP9fJJN4dn(name)
        self.userManagesMemory = 1
    ...
    def getClassType():
        returnValue = libpandaphysics._inP9fJJ3_Zr()
        import TypeHandle
    ...
    def getPhysicsObject(self):
        returnValue = libpandaphysics._inP9fJJCMRz(self.this)
    ...
    def getContactVector(self):
        returnValue = libpandaphysics._inP9fJJiR9_(self.this)
        import Vec3
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._ActorNode__overloaded_constructor()
        elif numArgs == 1:
            if isinstance(_args[0], types.StringType):
                return self._ActorNode__overloaded_constructor_atomicstring(_args[0])
            elif isinstance(_args[0], ActorNode):
                return self._ActorNode__overloaded_constructor_ptrConstActorNode(_args[0])
            else:
