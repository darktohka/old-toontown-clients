...
class HoodMgr(DirectObject.DirectObject):
    ...
    def getPlaygroundCenterFromId(self, hoodId):
        if hoodId == ToontownGlobals.DonaldsDock:
            return self.get_drop_point(self.DonaldsDock_drop_points)
        elif hoodId == ToontownGlobals.ToontownCentral:
            return self.get_drop_point(self.ToontownCentral_drop_points)
        elif hoodId == ToontownGlobals.TheBrrrgh:
            return self.get_drop_point(self.Brggh_drop_points)
        elif hoodId == ToontownGlobals.MinniesMelodyland:
            return self.get_drop_point(self.MelodyLand_drop_points)
        elif hoodId == ToontownGlobals.DaisyGardens:
            return self.get_drop_point(self.DaisyGardens_drop_points)
        elif hoodId == ToontownGlobals.DonaldsDreamland:
            return self.get_drop_point(self.Dreamland_drop_points)
        elif hoodId == ToontownGlobals.Tutorial:
            return self.get_drop_point(self.Tutorial_drop_points)
        elif hoodId == ToontownGlobals.ConstructionZone:
            return Default_drop_point
        elif hoodId == ToontownGlobals.FunnyFarm:
            return Default_drop_point
        elif hoodId == ToontownGlobals.GoofyStadium:
            return Default_drop_point
        elif hoodId == ToontownGlobals.BossbotHQ:
            return Default_drop_point
        elif hoodId == ToontownGlobals.SellbotHQ:
            return Default_drop_point
        elif hoodId == ToontownGlobals.CashbotHQ:
            return Default_drop_point
        elif hoodId == ToontownGlobals.LawbotHQ:
            return Default_drop_point
        else:
    ...
    def getIdFromName(self, hoodName):
        if hoodName == 'dd':
            return ToontownGlobals.DonaldsDock
        elif hoodName == 'tt':
            return ToontownGlobals.ToontownCentral
        elif hoodName == 'br':
            return ToontownGlobals.TheBrrrgh
        elif hoodName == 'mm':
            return ToontownGlobals.MinniesMelodyland
        elif hoodName == 'dg':
            return ToontownGlobals.DaisyGardens
        elif hoodName == 'cz':
            return ToontownGlobals.ConstructionZone
        elif hoodName == 'ff':
            return ToontownGlobals.FunnyFarm
        elif hoodName == 'gs':
            return ToontownGlobals.GoofyStadium
        elif hoodName == 'dl':
            return ToontownGlobals.DonaldsDreamland
        elif hoodName == 'bosshq':
            return ToontownGlobals.BossbotHQ
        elif hoodName == 'sellhq':
            return ToontownGlobals.SellbotHQ
        elif hoodName == 'cashhq':
