...
class LerpShearInterval(LerpNodePathInterval):
    ...
    def __init__(self, node, duration, shear, startShear = None, other = None, blendType = 'noBlend', bakeInStart = 1, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, node, other)
...
class LerpPosHprScaleShearInterval(LerpNodePathInterval):
    ...
    def __init__(self, node, duration, pos, hpr, scale, shear, startPos = None, startHpr = None, startScale = None, startShear = None, other = None, blendType = 'noBlend', bakeInStart = 1, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, node, other)
