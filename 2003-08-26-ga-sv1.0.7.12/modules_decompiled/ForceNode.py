...
class ForceNode(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def _ForceNode__overloaded_writeForces_ptrConstForceNode_ptrOstream_unsignedint(self, out, indent):
        returnValue = libpandaphysics._inP9fJJHWKp(self.this, out.this, indent)
        return returnValue
    ...
    def _ForceNode__overloaded_write_ptrConstForceNode_ptrOstream(self, out):
        returnValue = libpandaphysics._inP9fJJPb8p(self.this, out.this)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._ForceNode__overloaded_write_ptrConstForceNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ForceNode__overloaded_write_ptrConstForceNode_ptrOstream_unsignedint(_args[0], _args[1])
                else:
    ...
    def writeForces(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._ForceNode__overloaded_writeForces_ptrConstForceNode_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ForceNode__overloaded_writeForces_ptrConstForceNode_ptrOstream_unsignedint(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
