...
class QuestPoster(DirectFrame):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        self.funQuest = DirectLabel(parent = self.questFrame, relief = None, text = Localizer.QuestPosterFun, text_fg = (0.0, 0.439, 1.0, 1.0), text_shadow = (0, 0, 0, 1), pos = (-0.28249999999999997, 0, 0.20000000000000001), scale = 0.029999999999999999)
    ...
    def update(self, questDesc):
        ...
        if quest.getType() == Quests.DeliverGagQuest or quest.getType() == Quests.DeliverItemQuest:
            ...
            if not fComplete:
                ...
                if holder == Quests.Any:
                    ...
                    headlineString = Localizer.QuestPosterFishing
        ...
        if fComplete:
            ...
            headlineString = Localizer.QuestPosterComplete
            infoText = Localizer.QuestPageDestination % (toNpcBuildingName, toNpcStreetName, toNpcLocationName)
