...
Variants = ('tart', 'fruitpie', 'splat-tart', 'dust', 'kapow', 'double-windsor', 'splat-fruitpie-slice', 'splat-creampie-slice', 'splat-fruitpie', 'splat-creampie', 'splat-birthday-cake', 'splash-from-splat', 'clip-on-tie', 'lips', 'small-magnet', '5dollar', '10dollar', 'suit_explosion')
...
class PropPool:
    ...
    def makeVariant(self, name):
        if name == 'tart':
            ...
            tie = self.props[name]
            tie.getChild(0).setHpr(21.039999999999999, -19.649999999999999, -9.4600000000000009)
        elif name == 'small-magnet':
            self.props[name].setScale(0.5)
        elif name == 'shredder-paper':
            paper = self.props[name]
            paper.setPosHpr(2.2200000000000002, -0.94999999999999996, 1.1599999999999999, 0, -53.75, 123.69)
            paper.flattenMedium()
        elif name == 'lips':
