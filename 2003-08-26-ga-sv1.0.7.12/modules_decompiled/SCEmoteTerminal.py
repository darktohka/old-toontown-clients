...
from Localizer import EmoteList, EmoteWhispers
import Emote
...
class SCEmoteTerminal(SCTerminal):
    ...
    def _SCEmoteTerminal__emoteEnabled(self):
        ...
        return Emote.IsEnabled(self.emoteId)
    ...
    def enterVisible(self):
        ...
        if self._SCEmoteTerminal__ltHasAccess():
            ...
            if not self.isWhispering():
                self.accept(Emote.EmoteEnableStateChanged, self._SCEmoteTerminal__emoteEnableStateChanged)
