...
class DistributedBoat(DistributedObject.DistributedObject):
    ...
    def generate(self):
        self.boat = toonbase.tcr.playGame.hood.loader.boat
        toonbase.tcr.parentMgr.registerParent(ToontownGlobals.SPDonaldsBoat, self.boat)
        self.setupTracks()
    ...
    def disable(self):
        toonbase.tcr.parentMgr.unregisterParent(ToontownGlobals.SPDonaldsBoat)
