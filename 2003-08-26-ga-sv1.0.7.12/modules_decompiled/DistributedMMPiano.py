...
class DistributedMMPiano(DistributedObject.DistributedObject):
    ...
    def generate(self):
        self.piano = toonbase.tcr.playGame.hood.loader.piano
        toonbase.tcr.parentMgr.registerParent(ToontownGlobals.SPMinniesPiano, self.piano)
    ...
    def disable(self):
        del self.piano
        toonbase.tcr.parentMgr.unregisterParent(ToontownGlobals.SPMinniesPiano)
