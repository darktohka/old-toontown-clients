...
class SCMenu(SCObject, NodePath):
    ...
    def __init__(self, holder = None):
        ...
        self.bg = loader.loadModelCopy('phase_3/models/gui/ChatPanel')
    ...
    def memberGainedInputFocus(self, member):
        ...
        if self.activeMember is None and SCMenu.SpeedChatRolloverTolerance == 0 or member.posInParentMenu < self.activeMember.posInParentMenu:
            ...
            delay = SCMenu.SpeedChatRolloverTolerance
            if delay > 1.0 / globalClock.getFrameRate():
                taskMgr.doMethodLater(delay, doActiveMemberSwitch, self.ActiveMemberSwitchTaskName)
