...
def avatarCloseUpThreeQuarterRightFollowShot(avatar, duration):
    ...
    track.append(LerpHprInterval(node = camera, other = avatar, duration = duration * 0.20000000000000001, hpr = Point3(110, 3.6000000000000001, 0), blendType = 'easeInOut'))
...
def avatarCloseUpZoomShot(avatar, duration):
    ...
    track.append(LerpPosHprInterval(node = camera, other = avatar, duration = duration / 2, startPos = Point3(0, 10, avatar.getHeight()), startHpr = Point3(179, -10, 0), pos = Point3(0, 6, avatar.getHeight()), hpr = Point3(179, -10, 0), blendType = 'easeInOut'))
