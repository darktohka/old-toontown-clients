...
def __createFishingPoleMultiTrack(lure, dollar, dollarName):
    ...
    toonTrack = Sequence(Func(toon.headsUp, battle, targetPos), ActorInterval(toon, 'cast'), Func(toon.loop, 'neutral'))
...
def __createSuitDamageTrack(battle, suit, hp, lure, trapProp):
    ...
    if trapName == 'banana':
        ...
        damageTrack = Sequence(Wait(0.5), Func(suit.showLaffNumber, -hp, openEnded = 0), Func(suit.updateHealthBar, hp))
        ...
        damageTrack = Sequence(Wait(3.5), Func(suit.showLaffNumber, -hp, openEnded = 0), Func(suit.updateHealthBar, hp))
        ...
        damageTrack = Sequence(Wait(2.2999999999999998), Func(suit.showLaffNumber, -hp, openEnded = 0), Func(suit.updateHealthBar, hp))
