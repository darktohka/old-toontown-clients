...
class LightLensNode(Light.Light, LensNode.LensNode, FFIExternalObject.FFIExternalObject):
    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self._LightLensNode__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(_args[0])
            elif isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._LightLensNode__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(_args[0])
            else:
    ...
    def addChild(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
            ...
            if isinstance(_args[0], PandaNode.PandaNode):
                if isinstance(_args[1], types.IntType):
                    return self._LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(_args[0], _args[1])
                else:
    ...
    def unstashChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._LightLensNode__overloaded_unstashChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
    ...
    def listTags(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.StringType):
                    return self._LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(_args[0], _args[1])
                else:
    ...
    def setAttrib(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                return self._LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(_args[0])
            else:
            ...
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                if isinstance(_args[1], types.IntType):
                    return self._LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <RenderAttrib.RenderAttrib> '
    ...
    def stashChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._LightLensNode__overloaded_stashChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_stashChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> <PandaNode.PandaNode> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def removeChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._LightLensNode__overloaded_removeChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_removeChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> <PandaNode.PandaNode> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def addStashed(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <PandaNode.PandaNode> '
        elif numArgs == 2:
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                if isinstance(_args[1], types.IntType):
                    return self._LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <PandaNode.PandaNode> '
    ...
    def _LightLensNode__overloaded_setBound_ptrBoundedObject___enum__BoundingVolumeType(self, type):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_setBound_ptrBoundedObject_ptrConstBoundingVolume(self, volume):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
        upcastSelf = upcastSelf.upcastToBoundedObject()
    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            import BoundingVolume
            if isinstance(_args[0], types.IntType):
                return self._LightLensNode__overloaded_setBound_ptrBoundedObject___enum__BoundingVolumeType(_args[0])
            elif isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._LightLensNode__overloaded_setBound_ptrBoundedObject_ptrConstBoundingVolume(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> <BoundingVolume.BoundingVolume> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
