...
class PhysicsManager(FFIExternalObject.FFIExternalObject):
    ...
    def output(self, out):
        returnValue = libpandaphysics._inP9fJJlQi_(self.this, out.this)
        return returnValue
    ...
    def _PhysicsManager__overloaded_writePhysicals_ptrConstPhysicsManager_ptrOstream(self, out):
        returnValue = libpandaphysics._inP9fJJFCw4(self.this, out.this)
        return returnValue

    
    def _PhysicsManager__overloaded_writeLinearForces_ptrConstPhysicsManager_ptrOstream_unsignedint(self, out, indent):
        returnValue = libpandaphysics._inP9fJJIKvl(self.this, out.this, indent)
        return returnValue
    ...
    def _PhysicsManager__overloaded_write_ptrConstPhysicsManager_ptrOstream(self, out):
        returnValue = libpandaphysics._inP9fJJale_(self.this, out.this)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicsManager__overloaded_write_ptrConstPhysicsManager_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicsManager__overloaded_write_ptrConstPhysicsManager_ptrOstream_unsignedint(_args[0], _args[1])
                else:
    ...
    def writeLinearForces(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicsManager__overloaded_writeLinearForces_ptrConstPhysicsManager_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicsManager__overloaded_writeLinearForces_ptrConstPhysicsManager_ptrOstream_unsignedint(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def writeAngularForces(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicsManager__overloaded_writeAngularForces_ptrConstPhysicsManager_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicsManager__overloaded_writeAngularForces_ptrConstPhysicsManager_ptrOstream_unsignedint(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def writePhysicals(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicsManager__overloaded_writePhysicals_ptrConstPhysicsManager_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicsManager__overloaded_writePhysicals_ptrConstPhysicsManager_ptrOstream_unsignedint(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
