            ...
            if isinstance(_args[0], NodePath.NodePath):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        return self._ScaleLerpFunctor__overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2])
                    else:
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        ...
                        if isinstance(_args[3], NodePath.NodePath):
                            return self._ScaleLerpFunctor__overloaded_constructor_ptrNodePath_ptrLVecBase3f_ptrLVecBase3f_ptrNodePath(_args[0], _args[1], _args[2], _args[3])
                        else:
                            ...
                            if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                        return self._ScaleLerpFunctor__overloaded_constructor_ptrNodePath_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                    else:
                                ...
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                        ...
                                        if isinstance(_args[7], NodePath.NodePath):
                                            return self._ScaleLerpFunctor__overloaded_constructor_ptrNodePath_float_float_float_float_float_float_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7])
                                        else:
