...
class PhysicsObject(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def resetPosition(self, pos):
        returnValue = libpandaphysics._inP9fJJqXx9(self.this, pos.this)
        return returnValue
    ...
    def getImplicitVelocity(self):
        returnValue = libpandaphysics._inP9fJJp1Ut(self.this)
        import Vec3
        returnObject = Vec3.Vec3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def addImpulse(self, impulse):
        returnValue = libpandaphysics._inP9fJJxEW4(self.this, impulse.this)
        return returnValue
    ...
    def output(self, out):
        returnValue = libpandaphysics._inP9fJJnx3h(self.this, out.this)
        return returnValue
    ...
    def _PhysicsObject__overloaded_write_ptrConstPhysicsObject_ptrOstream(self, out):
        returnValue = libpandaphysics._inP9fJJbx5t(self.this, out.this)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicsObject__overloaded_write_ptrConstPhysicsObject_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicsObject__overloaded_write_ptrConstPhysicsObject_ptrOstream_unsignedint(_args[0], _args[1])
                else:
