...
from PythonUtil import PureVirtual, boolEqual
import ToontownGlobals

class SCElement(SCObject, PureVirtual, NodePath):
    ...
    def finalize(self, dbArgs = { }):
        ...
        btn.bind(ENTER, lambda loc: self.onMouseEnter())
        btn.bind(EXIT, lambda loc: self.onMouseLeave())
        btn.bind(B1PRESS, lambda loc: self.onMouseClick())
        self.button = btn
