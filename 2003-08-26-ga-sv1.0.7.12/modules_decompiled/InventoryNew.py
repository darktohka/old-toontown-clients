...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    def load(self):
        ...
        self.detailCreditLabel = DirectLabel(parent = self.detailFrame, text = Localizer.InventorySkillCreditNone, text_fg = (0.050000000000000003, 0.14000000000000001, 0.40000000000000002, 1), scale = 0.040000000000000001, pos = (-0.22, 0, -0.36499999999999999), text_font = getInterfaceFont(), text_align = TextNode.ALeft, relief = None)
