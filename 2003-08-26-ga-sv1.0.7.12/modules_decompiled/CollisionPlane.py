    ...
    def constructor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Plane.Plane):
                return self._CollisionPlane__overloaded_constructor_ptrConstPlanef(_args[0])
            elif isinstance(_args[0], CollisionPlane):
                return self._CollisionPlane__overloaded_constructor_ptrConstCollisionPlane(_args[0])
            else:
