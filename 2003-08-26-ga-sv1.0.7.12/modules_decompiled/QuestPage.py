...
class QuestPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        self.title = DirectLabel(parent = self, relief = None, text = Localizer.QuestPageToonTasks, text_scale = 0.12, textMayChange = 0, pos = (0, 0, 0.59999999999999998))
    ...
    def showQuestsOnscreen(self):
        if self.onscreen or toonbase.localToon.invPage.onscreen:
            return None
