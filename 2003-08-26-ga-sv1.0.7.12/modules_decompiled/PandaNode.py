...
class PandaNode(TypedWritable.TypedWritable, Namable.Namable, BoundedObject.BoundedObject, ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def setTag(self, key, value):
        returnValue = libpanda._inPkJyoTNEJ(self.this, key, value)
        return returnValue

    
    def getTag(self, key):
        returnValue = libpanda._inPkJyo6tVl(self.this, key)
        return returnValue

    
    def hasTag(self, key):
        returnValue = libpanda._inPkJyoue2r(self.this, key)
        return returnValue

    
    def clearTag(self, key):
        returnValue = libpanda._inPkJyoiRPE(self.this, key)
        return returnValue

    
    def copyTags(self, other):
        returnValue = libpanda._inPkJyoyMQi(self.this, other.this)
        return returnValue

    
    def _PandaNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(self, out, separator):
        returnValue = libpanda._inPkJyo2itg(self.this, out.this, separator)
        return returnValue

    
    def _PandaNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(self, out):
        returnValue = libpanda._inPkJyocRES(self.this, out.this)
        return returnValue

    
    def setDrawMask(self, mask):
        returnValue = libpanda._inPkJyoezL6(self.this, mask.this)
        return returnValue
    ...
    def setVelocity(self, velocity):
        returnValue = libpanda._inPkJyoDKry(self.this, velocity.this)
        return returnValue

    
    def clearVelocity(self):
        returnValue = libpanda._inPkJyoVb0l(self.this)
        return returnValue

    
    def hasVelocity(self):
        returnValue = libpanda._inPkJyoIl5F(self.this)
        return returnValue

    
    def getVelocity(self):
        returnValue = libpanda._inPkJyo0sZ_(self.this)
        import Vec3
    ...
    def isGeomNode(self):
        returnValue = libpanda._inPkJyoyAx3(self.this)
        return returnValue

    
    def asLight(self):
        returnValue = libpanda._inPkJyoaCbs(self.this)
        import Light
    ...
    def listTags(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._PandaNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.StringType):
                    return self._PandaNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(_args[0], _args[1])
                else:
