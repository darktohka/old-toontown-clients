            ...
            if isinstance(_args[0], NodePath.NodePath):
                ...
                if isinstance(_args[1], VBase4.VBase4):
                    ...
                    if isinstance(_args[2], VBase4.VBase4):
                        return self._ColorScaleLerpFunctor__overloaded_constructor_ptrNodePath_ptrLVecBase4f_ptrLVecBase4f(_args[0], _args[1], _args[2])
                    else:
                ...
                if isinstance(_args[1], VBase4.VBase4):
                    ...
                    if isinstance(_args[2], VBase4.VBase4):
                        ...
                        if isinstance(_args[3], NodePath.NodePath):
                            return self._ColorScaleLerpFunctor__overloaded_constructor_ptrNodePath_ptrLVecBase4f_ptrLVecBase4f_ptrNodePath(_args[0], _args[1], _args[2], _args[3])
                        else:
                                    ...
                                    if isinstance(_args[6], types.FloatType) or isinstance(_args[6], types.IntType):
                                        if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                            if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                return self._ColorScaleLerpFunctor__overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8])
                                            else:
                                        ...
                                        if isinstance(_args[7], types.FloatType) or isinstance(_args[7], types.IntType):
                                            if isinstance(_args[8], types.FloatType) or isinstance(_args[8], types.IntType):
                                                ...
                                                if isinstance(_args[9], NodePath.NodePath):
                                                    return self._ColorScaleLerpFunctor__overloaded_constructor_ptrNodePath_float_float_float_float_float_float_float_float_ptrNodePath(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6], _args[7], _args[8], _args[9])
                                                else:
