...
class ParticleSystem(Physical.Physical, FFIExternalObject.FFIExternalObject):
    ...
    def _ParticleSystem__overloaded_write_ptrConstParticleSystem_ptrOstream(self, out):
        returnValue = libpandaphysics._inPKBUAf_Tj(self.this, out.this)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._ParticleSystem__overloaded_write_ptrConstParticleSystem_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ParticleSystem__overloaded_write_ptrConstParticleSystem_ptrOstream_int(_args[0], _args[1])
                else:
    ...
    def writeFreeParticleFifo(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._ParticleSystem__overloaded_writeFreeParticleFifo_ptrConstParticleSystem_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ParticleSystem__overloaded_writeFreeParticleFifo_ptrConstParticleSystem_ptrOstream_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def writeSpawnTemplates(self, *_args):
        ...
        if numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._ParticleSystem__overloaded_writeSpawnTemplates_ptrConstParticleSystem_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._ParticleSystem__overloaded_writeSpawnTemplates_ptrConstParticleSystem_ptrOstream_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
