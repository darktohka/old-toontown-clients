...
class DistributedEstate(DistributedObject.DistributedObject):
    ...
    def _DistributedEstate__sunTask(self, task):
        sunMoonNode = toonbase.tcr.playGame.hood.loader.sunMoonNode
        sun = toonbase.tcr.playGame.hood.loader.sun
        h = 30
    ...
    def _DistributedEstate__birds(self, task):
        base.playSfx(whrandom.choice(toonbase.tcr.playGame.hood.loader.birdSound))
    ...
    def _DistributedEstate__crickets(self, task):
        sfx = whrandom.choice(toonbase.tcr.playGame.hood.loader.cricketSound)
