...
def checkName(name):
            ...
            if ord(char) >= 128:
                if not allowUtf8Name:
                    ...
                    if ord(char) >= 224:
                        ...
                        char = char + name[i + 1]
                    return Localizer.NCBadCharacter % char
                
            elif char not in okChars:
                if char in string.digits:
                    notify.info('name contains digits')
                    return Localizer.NCNoDigits
                else:
    ...
    def hasLetters(name):
        ...
        for word in words:
            ...
            if len(letters) == 0 and not hasUtf8:
                ...
                return Localizer.NCNeedLetters
    ...
    def checkCommas(name):
        ...
        def validComma(index, name = name):
            if index == 0 or i == len(name) - 1:
                return Localizer.NCCommaEdge
            
            if name[i - 1] in string.whitespace:
                return Localizer.NCCommaAfterWord
            
            if not (name[i + 1] in string.whitespace):
                return Localizer.NCCommaUsage
    ...
    def checkPeriods(name):
        ...
        for word in words:
            ...
            if word[-1] != '.':
                ...
                return Localizer.NCPeriodUsage
    ...
    def checkApostrophes(name):
        ...
        for word in words:
            ...
            if numApos > 2:
                ...
                return Localizer.NCApostrophes
    ...
    def tooManyWords(name):
        if len(wordList(name)) > 4:
            ...
            return Localizer.NCTooManyWords
