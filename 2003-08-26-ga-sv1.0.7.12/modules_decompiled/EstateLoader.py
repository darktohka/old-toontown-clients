...
class EstateLoader(SafeZoneLoader.SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.safeZoneStorageDNAFile = 'phase_5.5/dna/storage_estate.dna'
        self.id = MyEstate
    ...
    def loadCloudPlatforms(self):
        ...
        for i in range(self.numClouds):
            cloud = MovingPlatform.MovingPlatform(i, cloudModel)
