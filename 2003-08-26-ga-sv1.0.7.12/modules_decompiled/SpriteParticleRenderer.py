...
class SpriteParticleRenderer(BaseParticleRenderer.BaseParticleRenderer, FFIExternalObject.FFIExternalObject):
    ...
    def _SpriteParticleRenderer__overloaded_constructor_ptrConstSpriteParticleRenderer(self, copy):
        self.this = libpandaphysics._inPKBUAQL04(copy.this)
    ...
    def setLlUv(self, llUv):
        returnValue = libpandaphysics._inPKBUAh2Qj(self.this, llUv.this)
        return returnValue
    ...
    def setColor(self, color):
        returnValue = libpandaphysics._inPKBUARJ7q(self.this, color.this)
        return returnValue
    ...
    def setInitialXScale(self, initialXScale):
        returnValue = libpandaphysics._inPKBUAKv64(self.this, initialXScale)
        return returnValue
    ...
    def getLlUv(self):
        returnValue = libpandaphysics._inPKBUAkEn7(self.this)
        import Point2
    ...
    def getUrUv(self):
        returnValue = libpandaphysics._inPKBUAfR23(self.this)
        import Point2
        returnObject = Point2.Point2(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def getXScaleFlag(self):
        returnValue = libpandaphysics._inPKBUAKsYl(self.this)
        return returnValue
    ...
    def getAnimAngleFlag(self):
        returnValue = libpandaphysics._inPKBUAV3Kv(self.this)
        return returnValue

    
    def getInitialXScale(self):
        returnValue = libpandaphysics._inPKBUA_dBl(self.this)
        return returnValue
    ...
    def getNonanimatedTheta(self):
        returnValue = libpandaphysics._inPKBUArpFo(self.this)
        return returnValue
    ...
    def getAlphaDisable(self):
        returnValue = libpandaphysics._inPKBUAE0hv(self.this)
        return returnValue
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._SpriteParticleRenderer__overloaded_constructor()
        elif numArgs == 1:
            import Texture
            if isinstance(_args[0], Texture.Texture):
                return self._SpriteParticleRenderer__overloaded_constructor_ptrTexture(_args[0])
            elif isinstance(_args[0], SpriteParticleRenderer):
                return self._SpriteParticleRenderer__overloaded_constructor_ptrConstSpriteParticleRenderer(_args[0])
            else:
