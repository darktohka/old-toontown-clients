...
class NametagGroup(FFIExternalObject.FFIExternalObject):
    ...
    def setNameWordwrap(self, nameWordwrap):
        returnValue = libtoontown._inPPj7bLovf(self.this, nameWordwrap)
        return returnValue

    
    def getNameWordwrap(self):
        returnValue = libtoontown._inPPj7bLH6E(self.this)
        return returnValue
    ...
    def setQtColor(self, color):
        returnValue = libtoontown._inPPj7buJqj(self.this, color.this)
        return returnValue

    
    def getQtColor(self):
        returnValue = libtoontown._inPPj7bfwH0(self.this)
        import VBase4
    ...
    def setShadow(self, xoffset, yoffset):
        returnValue = libtoontown._inPPj7bm0NC(self.this, xoffset, yoffset)
        return returnValue

    
    def clearShadow(self):
        returnValue = libtoontown._inPPj7b6dMi(self.this)
        return returnValue

    
    def hasShadow(self):
        returnValue = libtoontown._inPPj7bBZuj(self.this)
        return returnValue

    
    def getShadow(self):
        returnValue = libtoontown._inPPj7bXuN5(self.this)
        import VBase2
