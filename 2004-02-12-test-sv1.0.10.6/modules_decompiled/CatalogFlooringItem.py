...
FlooringTypes = {
    ...
    1020: ('phase_5.5/maps/flooring_tile_neutral.jpg', CTFlatColorDark, 150),
...
class CatalogFlooringItem(CatalogSurfaceItem):
    ...
    def getTypeName(self):
        return Localizer.SurfaceNames[STFlooring]

    
    def getName(self):
        name = Localizer.FlooringNames.get(self.patternIndex)
        if name:
            return name
