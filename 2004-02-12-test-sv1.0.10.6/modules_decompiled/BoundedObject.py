    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self._BoundedObject__overloaded_setBound_ptrBoundedObject___enum__BoundingVolumeType(_args[0])
            elif isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._BoundedObject__overloaded_setBound_ptrBoundedObject_ptrConstBoundingVolume(_args[0])
            else:
