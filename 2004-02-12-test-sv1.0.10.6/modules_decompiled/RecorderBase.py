...
class RecorderBase(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def getClassType():
        returnValue = libpanda._inPc5FLFTOU()
        import TypeHandle
    ...
    def isRecording(self):
        returnValue = libpanda._inPc5FLK8hL(self.this)
        return returnValue

    
    def isPlaying(self):
        returnValue = libpanda._inPc5FLXULh(self.this)
        return returnValue

    
    def upcastToReferenceCount(self):
        returnValue = libpanda._inPc5FLZ6Qp(self.this)
        import ReferenceCount
