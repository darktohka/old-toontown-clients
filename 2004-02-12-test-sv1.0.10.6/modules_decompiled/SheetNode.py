...
class SheetNode(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def constructor(self, name):
        self.this = libpanda._inPHc9WGNcz(name)
    ...
    def destructor(self):
        if libpanda and libpanda._inPHc9Ws9L6:
            libpanda._inPHc9Ws9L6(self.this)
    ...
    def setSurface(self, surface):
        returnValue = libpanda._inPHc9W1cvy(self.this, surface.this)
        return returnValue
    ...
    def setNumUSubdiv(self, numUSubdiv):
        returnValue = libpanda._inPHc9WBTi0(self.this, numUSubdiv)
        return returnValue
    ...
    def getNumVSubdiv(self):
        returnValue = libpanda._inPHc9WnQ7_(self.this)
        return returnValue

    
    def resetBound(self, relTo):
        returnValue = libpanda._inPHc9WaQ8j(self.this, relTo.this)
        return returnValue
