...
class AnimChannelMatrixXfmTable(AnimChannelACMatrixSwitchType.AnimChannelACMatrixSwitchType, FFIExternalObject.FFIExternalObject):
    ...
    def setTable(self, tableId, table):
        returnValue = libpanda._inPn9gMa4Yg(self.this, tableId, table.this)
        return returnValue

    
    def hasTable(self, tableId):
        returnValue = libpanda._inPn9gMWcqj(self.this, tableId)
        return returnValue

    
    def getTable(self, tableId):
        returnValue = libpanda._inPn9gM191i(self.this, tableId)
        import CPTAFloat
    ...
    def clearTable(self, tableId):
        returnValue = libpanda._inPn9gMN_k0(self.this, tableId)
        return returnValue
