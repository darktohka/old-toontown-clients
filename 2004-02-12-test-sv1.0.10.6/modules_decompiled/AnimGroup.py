...
class AnimGroup(TypedWritableReferenceCount.TypedWritableReferenceCount, Namable.Namable, FFIExternalObject.FFIExternalObject):
    ...
    def getNumChildren(self):
        returnValue = libpanda._inPn9gMX3b6(self.this)
        return returnValue
    ...
    def findChild(self, name):
        returnValue = libpanda._inPn9gMtjDj(self.this, name)
        returnObject = AnimGroup(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def makeChildDynamic(self, name):
        returnValue = libpanda._inPn9gMe1Wm(self.this, name)
        returnObject = AnimGroup(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def output(self, out):
        returnValue = libpanda._inPn9gME_Rm(self.this, out.this)
        return returnValue
    ...
    def upcastToNamable(self):
        returnValue = libpanda._inPn9gMHlFu(self.this)
        import Namable
