...
class CatalogPoleItem(CatalogItem.CatalogItem):
    ...
    def getTypeName(self):
        return Localizer.PoleTypeName

    
    def getName(self):
        return Localizer.FishingRod % Localizer.FishingRodNameDict[self.rodId]
    ...
    def getPicture(self, avatar):
        ...
        pole.setPosHpr(1.47, 0, -1.6699999999999999, 0, 90, 35)
    ...
    def getAcceptItemErrorText(self, retcode):
        if retcode == ToontownGlobals.P_ItemAvailable:
            return Localizer.CatalogAcceptPole
        elif retcode == ToontownGlobals.P_ItemUnneeded:
            return Localizer.CatalogAcceptPoleUnneeded
