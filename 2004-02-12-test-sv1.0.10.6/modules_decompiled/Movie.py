...
class Movie(PandaObject.PandaObject):
    ...
    def playTutorialReward(self, ts, name, callback):
        ...
        self.questList = self.rewardPanel.getQuestIntervalList(toonbase.localToon, [
            0,
            1])
    ...
    def playTutorialReward_1(self):
        ...
        self.track.append(Func(self.rewardPanel.initGagFrame, toonbase.localToon, [
            0,
            0,
            0,
            0,
            ...
            0,
            0]))
        self.track += self.rewardPanel.getTrackIntervalList(toonbase.localToon, THROW_TRACK, 0, 1)
    ...
    def playTutorialReward_2(self, value):
        ...
        self.track += self.rewardPanel.getTrackIntervalList(toonbase.localToon, SQUIRT_TRACK, 0, 1)
        ...
        for ta in toonAttacks:
            ...
            if track != NO_ATTACK:
                ...
                if track == SOS:
                    ...
                    adict['target'] = target
                elif track == NPCSOS and track == NPC_COGS_MISS and track == NPC_TOONS_HIT or track == NPC_RESTOCK_GAGS:
                    adict['special'] = 1
                    toonHandles = []
                    for t in toons:
                        if t != -1:
