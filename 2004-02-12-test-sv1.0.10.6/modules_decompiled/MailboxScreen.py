...
class MailboxScreen(DirectObject.DirectObject):
    ...
    def load(self):
        ...
        self.exitButton = DirectButton(parent = self.frame, relief = None, image = (exitUp, exitDown, exitRollover, exitUp), pos = (-0.01, 1.0, -0.35999999999999999), scale = 0.048000000000000001, text = ('', Localizer.MailboxExitButton, Localizer.MailboxExitButton, ''), text_scale = 1.0, text_pos = (0, -0.080000000000000002), textMayChange = 0, command = self._MailboxScreen__handleExit)
        ...
        self.acceptButton = DirectButton(parent = self.frame, relief = None, image = (acceptUp, acceptDown, acceptRollover, acceptUp), image3_color = (0.80000000000000004, 0.80000000000000004, 0.80000000000000004, 0.59999999999999998), pos = (-0.01, 1.0, -0.16), scale = 0.048000000000000001, text = ('', Localizer.MailboxAcceptButton, Localizer.MailboxAcceptButton, ''), text_scale = 1.0, text_pos = (0, -0.089999999999999997), textMayChange = 0, command = self._MailboxScreen__handleAccept, state = DISABLED)
    ...
    def _MailboxScreen__handleExit(self):
        if self.numAtticAccepted == 0:
            ...
            self.acceptErrorDialog = ToontownDialog.ToontownDialog(style = ToontownDialog.Acknowledge, text = Localizer.CatalogAcceptInAttic, text_wordwrap = 15, command = self._MailboxScreen__acceptExit)
            self.acceptErrorDialog.show()
        else:
            self.acceptErrorDialog = ToontownDialog.ToontownDialog(style = ToontownDialog.Acknowledge, text = Localizer.CatalogAcceptInAtticP, text_wordwrap = 15, command = self._MailboxScreen__acceptExit)
            self.acceptErrorDialog.show()
