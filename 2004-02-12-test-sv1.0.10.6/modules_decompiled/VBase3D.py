...
class VBase3D(FFIExternalObject.FFIExternalObject):
    ...
    def addToCell(self, i, value):
        returnValue = libpanda._inPUZN3IMq8(self.this, i, value)
        return returnValue

    
    def addX(self, value):
        returnValue = libpanda._inPUZN33Qy4(self.this, value)
        return returnValue

    
    def addY(self, value):
        returnValue = libpanda._inPUZN330q9(self.this, value)
        return returnValue

    
    def addZ(self, value):
        returnValue = libpanda._inPUZN33YjC(self.this, value)
        return returnValue
    ...
    def getStandardizedHpr(self):
        returnValue = libpanda._inPUZN33K45(self.this)
        returnObject = VBase3D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
