...
class QuatD(VBase4D.VBase4D, FFIExternalObject.FFIExternalObject):
    ...
    def _QuatD__overloaded_almostEqual_ptrConstLQuaterniond_ptrConstLQuaterniond(self, other):
        returnValue = libpanda._inPUZN3vATv(self.this, other.this)
        return returnValue

    
    def _QuatD__overloaded_almostEqual_ptrConstLQuaterniond_ptrConstLQuaterniond_double(self, other, threshold):
        returnValue = libpanda._inPUZN3LRVo(self.this, other.this, threshold)
        return returnValue

    
    def isSameDirection(self, other):
        returnValue = libpanda._inPUZN3Zg5d(self.this, other.this)
        return returnValue

    
    def almostSameDirection(self, other, threshold):
        returnValue = libpanda._inPUZN3UNTJ(self.this, other.this, threshold)
        return returnValue
    ...
    def isAlmostIdentity(self, tolerance):
        returnValue = libpanda._inPUZN3Z4KV(self.this, tolerance)
        return returnValue
