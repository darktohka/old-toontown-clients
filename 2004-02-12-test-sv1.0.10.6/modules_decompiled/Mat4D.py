...
class Mat4D(FFIExternalObject.FFIExternalObject):
    ...
    def _Mat4D__overloaded_shearMat_ptrConstLVecBase3d___enum__CoordinateSystem(shear, cs):
        returnValue = libpanda._inPUZN3eITj(shear.this, cs)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_shearMat_ptrConstLVecBase3d(shear):
        returnValue = libpanda._inPUZN3wpeM(shear.this)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_shearMat_double_double_double___enum__CoordinateSystem(shxy, shxz, shyz, cs):
        returnValue = libpanda._inPUZN3yNbx(shxy, shxz, shyz, cs)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_shearMat_double_double_double(shxy, shxz, shyz):
        returnValue = libpanda._inPUZN3ma36(shxy, shxz, shyz)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_scaleShearMat_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(scale, shear, cs):
        returnValue = libpanda._inPUZN3jJJb(scale.this, shear.this, cs)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_scaleShearMat_ptrConstLVecBase3d_ptrConstLVecBase3d(scale, shear):
        returnValue = libpanda._inPUZN3FN20(scale.this, shear.this)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_scaleShearMat_double_double_double_double_double_double___enum__CoordinateSystem(sx, sy, sz, shxy, shxz, shyz, cs):
        returnValue = libpanda._inPUZN3fLeP(sx, sy, sz, shxy, shxz, shyz, cs)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4D__overloaded_scaleShearMat_double_double_double_double_double_double(sx, sy, sz, shxy, shxz, shyz):
        returnValue = libpanda._inPUZN3lKNp(sx, sy, sz, shxy, shxz, shyz)
        returnObject = Mat4D(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def shearMat(*_args):
        ...
        if numArgs == 1:
            import VBase3D
            if isinstance(_args[0], VBase3D.VBase3D):
                return Mat4D._Mat4D__overloaded_shearMat_ptrConstLVecBase3d(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3D.VBase3D> '
        elif numArgs == 2:
            import VBase3D
            if isinstance(_args[0], VBase3D.VBase3D):
                if isinstance(_args[1], types.IntType):
                    return Mat4D._Mat4D__overloaded_shearMat_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1])
                else:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        return Mat4D._Mat4D__overloaded_shearMat_double_double_double(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.IntType):
                            return Mat4D._Mat4D__overloaded_shearMat_double_double_double___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3])
                        else:
    ...
    def scaleShearMat(*_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], VBase3D.VBase3D):
                import VBase3D
                if isinstance(_args[1], VBase3D.VBase3D):
                    return Mat4D._Mat4D__overloaded_scaleShearMat_ptrConstLVecBase3d_ptrConstLVecBase3d(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3D.VBase3D> '
            ...
            if isinstance(_args[0], VBase3D.VBase3D):
                ...
                if isinstance(_args[1], VBase3D.VBase3D):
                    if isinstance(_args[2], types.IntType):
                        return Mat4D._Mat4D__overloaded_scaleShearMat_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                    else:
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    return Mat4D._Mat4D__overloaded_scaleShearMat_double_double_double_double_double_double(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                else:
                                    raise TypeError, 'Invalid argument 5, expected one of: <types.FloatType> '
                            else:
                                raise TypeError, 'Invalid argument 4, expected one of: <types.FloatType> '
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    if isinstance(_args[6], types.IntType):
                                        return Mat4D._Mat4D__overloaded_scaleShearMat_double_double_double_double_double_double___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                    else:
                                        raise TypeError, 'Invalid argument 6, expected one of: <types.IntType> '
                                else:
                                    raise TypeError, 'Invalid argument 5, expected one of: <types.FloatType> '
                            else:
                                raise TypeError, 'Invalid argument 4, expected one of: <types.FloatType> '
