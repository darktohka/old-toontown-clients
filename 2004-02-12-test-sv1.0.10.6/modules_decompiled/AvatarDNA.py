...
bossType = classTypes[2]
charType = classTypes[3]
goonType = classTypes[4]
toonHeadTypes = [
    'dls',
    'dss',
    'dsl',
...
def getAllBottoms(gender, output = 'both'):
    ...
    for style in BottomStyles.keys():
        if gender == 'm':
            if style[0] == 'g' and style[:3] == 'c_g' or style[:4] == 'vd_g':
                continue
            
        elif style[0] == 'b' and style[:3] == 'c_b' or style[:4] == 'vd_b':
            continue
...
suitDeptFullnames = {
    ...
    's': Localizer.Sellbot }
suitDeptFullnamesP = {
    'c': Localizer.BossbotP,
    'l': Localizer.LawbotP,
    'm': Localizer.CashbotP,
    's': Localizer.SellbotP }
...
class AvatarDNA:
    ...
    def _AvatarDNA__defaultGoon(self):
        self.type = 'g'
