...
class TransformState(TypedWritableReferenceCount.TypedWritableReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def makeShear(scale):
        returnValue = libpanda._inPkJyo7OFW(scale.this)
        returnObject = TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def makePosHprScaleShear(pos, hpr, scale, shear):
        returnValue = libpanda._inPkJyoEwpz(pos.this, hpr.this, scale.this, shear.this)
        returnObject = TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def makePosQuatScaleShear(pos, quat, scale, shear):
        returnValue = libpanda._inPkJyoDFJS(pos.this, quat.this, scale.this, shear.this)
        returnObject = TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def hasShear(self):
        returnValue = libpanda._inPkJyoQZ2I(self.this)
        return returnValue

    
    def hasNonzeroShear(self):
        returnValue = libpanda._inPkJyoUk2V(self.this)
        return returnValue
    ...
    def getShear(self):
        returnValue = libpanda._inPkJyo4_27(self.this)
        import VBase3
        returnObject = VBase3.VBase3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def setShear(self, shear):
        returnValue = libpanda._inPkJyoHVYt(self.this, shear.this)
        returnObject = TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
