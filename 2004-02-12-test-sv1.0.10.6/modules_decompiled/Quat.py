...
class Quat(VBase4.VBase4, FFIExternalObject.FFIExternalObject):
    ...
    def _Quat__overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf(self, other):
        returnValue = libpanda._inPUZN3rHMU(self.this, other.this)
        return returnValue

    
    def _Quat__overloaded_almostEqual_ptrConstLQuaternionf_ptrConstLQuaternionf_float(self, other, threshold):
        returnValue = libpanda._inPUZN3lDKH(self.this, other.this, threshold)
        return returnValue

    
    def isSameDirection(self, other):
        returnValue = libpanda._inPUZN3t2zi(self.this, other.this)
        return returnValue

    
    def almostSameDirection(self, other, threshold):
        returnValue = libpanda._inPUZN3jEa5(self.this, other.this, threshold)
        return returnValue
    ...
    def isAlmostIdentity(self, tolerance):
        returnValue = libpanda._inPUZN34P4N(self.this, tolerance)
        return returnValue
