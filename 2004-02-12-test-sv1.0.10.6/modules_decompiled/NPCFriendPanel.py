...
class NPCFriendCard(DirectFrame):
    ...
    def update(self, NPCID, count = 0, fCallable = 0):
        ...
        if NPCID != oldNPCID:
            ...
            self.front.show()
            self.back.hide()
            self.NPCName['text'] = Localizer.NPCToonNames[NPCID]
