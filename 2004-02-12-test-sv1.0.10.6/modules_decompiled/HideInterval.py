    ...
    def constructor(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], NodePath.NodePath):
                return self._HideInterval__overloaded_constructor_ptrConstNodePath(_args[0])
            else:
            ...
            if isinstance(_args[0], NodePath.NodePath):
                if isinstance(_args[1], types.StringType):
                    return self._HideInterval__overloaded_constructor_ptrConstNodePath_atomicstring(_args[0], _args[1])
                else:
