...
class VBase3(FFIExternalObject.FFIExternalObject):
    ...
    def addToCell(self, i, value):
        returnValue = libpanda._inPUZN3GyX0(self.this, i, value)
        return returnValue

    
    def addX(self, value):
        returnValue = libpanda._inPUZN31m2F(self.this, value)
        return returnValue

    
    def addY(self, value):
        returnValue = libpanda._inPUZN31CvK(self.this, value)
        return returnValue

    
    def addZ(self, value):
        returnValue = libpanda._inPUZN31unP(self.this, value)
        return returnValue
    ...
    def getStandardizedHpr(self):
        returnValue = libpanda._inPUZN3V_5p(self.this)
        returnObject = VBase3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
