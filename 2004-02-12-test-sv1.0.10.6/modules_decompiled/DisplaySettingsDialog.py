...
class DisplaySettingsDialog(DirectFrame, StateData.StateData):
    ...
    def __init__(self):
        DirectFrame.__init__(self, pos = (0, 0, 0.29999999999999999), relief = None, image = getDefaultDialogGeom(), image_scale = (1.6000000000000001, 1, 1.2), image_pos = (0, 0, -0.050000000000000003), image_color = ToontownGlobals.GlobalDialogColor, text = Localizer.DisplaySettingsTitle, text_scale = 0.12, text_pos = (0, 0.40000000000000002), borderWidth = (0.01, 0.01), sortOrder = NO_FADE_SORT_INDEX)
    ...
    def load(self):
        ...
        c1f.setScale(0.90000000000000002)
        ...
        c2f.setScale(0.90000000000000002)
        self.introText = DirectLabel(parent = self, relief = None, scale = 0.059999999999999998, text = Localizer.DisplaySettingsIntro, text_wordwrap = 25, text_align = TextNode.ALeft, pos = (-0.72499999999999998, 0, 0.29999999999999999))
        self.introTextSimple = DirectLabel(parent = self, relief = None, scale = 0.059999999999999998, text = Localizer.DisplaySettingsIntroSimple, text_wordwrap = 25, text_align = TextNode.ALeft, pos = (-0.72499999999999998, 0, 0.29999999999999999))
        self.apiLabel = DirectLabel(parent = self, relief = None, scale = 0.059999999999999998, text = Localizer.DisplaySettingsApi, text_align = TextNode.ARight, pos = (-0.080000000000000002, 0, 0))
        self.apiMenu = DirectOptionMenu(parent = self, relief = RAISED, scale = 0.059999999999999998, items = [
            'x'], pos = (0, 0, 0))
        self.screenSizeLabel = DirectLabel(parent = self, relief = None, scale = 0.059999999999999998, text = Localizer.DisplaySettingsResolution, text_align = TextNode.ARight, pos = (-0.080000000000000002, 0, -0.10000000000000001))
        ...
        self.windowedButton = DirectCheckButton(parent = self, relief = None, text = Localizer.DisplaySettingsWindowed, text_align = TextNode.ALeft, text_scale = 0.59999999999999998, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = (0.10000000000000001, 0, -0.22), command = self._DisplaySettingsDialog__doWindowed)
        self.fullscreenButton = DirectCheckButton(parent = self, relief = None, text = Localizer.DisplaySettingsFullscreen, text_align = TextNode.ALeft, text_scale = 0.59999999999999998, scale = 0.10000000000000001, boxImage = innerCircle, boxImageScale = 2.5, boxImageColor = VBase4(0, 0.25, 0.5, 1), boxRelief = None, pos = (0.10000000000000001, 0, -0.31), command = self._DisplaySettingsDialog__doFullscreen)
        self.apply = DirectButton(parent = self, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (0.59999999999999998, 1, 1), text = Localizer.DisplaySettingsApply, text_scale = 0.059999999999999998, text_pos = (0, -0.02), pos = (0.52000000000000002, 0, -0.53000000000000003), command = self._DisplaySettingsDialog__apply)
        self.cancel = DirectButton(parent = self, relief = None, text = Localizer.DisplaySettingsCancel, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (0.59999999999999998, 1, 1), text_scale = 0.059999999999999998, text_pos = (0, -0.02), pos = (0.20000000000000001, 0, -0.53000000000000003), command = self._DisplaySettingsDialog__cancel)
    ...
    def _DisplaySettingsDialog__apply(self):
        ...
        self.applyDialog = ToontownDialog.ToontownDialog(dialogName = 'DisplaySettingsApply', style = ToontownDialog.TwoChoice, text = Localizer.DisplaySettingsApplyWarning % self.ApplyTimeoutSeconds, text_wordwrap = 15, fadeScreen = 1, command = self._DisplaySettingsDialog__applyDone)
    ...
    def _DisplaySettingsDialog__applyDone(self, command):
        ...
        self.reparentTo(self.getParent(), 0)
        self.timeoutDialog = ToontownDialog.ToontownDialog(dialogName = 'DisplaySettingsTimeout', style = ToontownDialog.TwoChoice, text = Localizer.DisplaySettingsAccept % self.ApplyTimeoutSeconds, text_wordwrap = 15, fadeScreen = 1, command = self._DisplaySettingsDialog__timeoutDone)
    ...
    def _DisplaySettingsDialog__revertBack(self, reason):
        ...
        self.revertDialog = ToontownDialog.ToontownDialog(dialogName = 'DisplaySettingsRevert', style = ToontownDialog.Acknowledge, text = revertText, text_wordwrap = 15, fadeScreen = 1, command = self._DisplaySettingsDialog__revertDone)
