...
VISIT_QUEST_ID = 1000
NEWBIE_HP = 25
SELLBOT_HQ_NEWBIE_HP = 75
from ToontownGlobals import FT_FullSuit, FT_Leg, FT_Arm, FT_Torso
...
class LocationBasedQuest(Quest):
    ...
    def getLocationName(self):
        ...
        if loc == Anywhere:
            ...
            locName = Localizer.QuestPosterLocationIn + ToontownGlobals.hoodNameMap[loc][1] + Localizer.QuestsLocationArticle
        elif loc in ToontownGlobals.StreetBranchZones:
            locName = Localizer.QuestPosterLocationOn + ToontownGlobals.StreetNames[loc][1] + Localizer.QuestsLocationArticle
...
class CogQuest(LocationBasedQuest):
    ...
    def getObjectiveStrings(self):
        ...
        text = Localizer.QuestsCogQuestDefeatDesc % {
            'numCogs': numCogs,
            'cogName': cogName }
        return (text,)
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if numCogs == 1:
            ...
            text = Localizer.QuestsCogQuestSCStringS
        elif cogType == Any:
            cogName = Localizer.Cogs
        else:
            cogName = SuitBattleGlobals.SuitAttributes[cogType]['pluralname']
        text = Localizer.QuestsCogQuestSCStringP
...
class CogNewbieQuest(CogQuest):
    ...
    def getString(self):
        return Localizer.QuestsCogNewbieQuestObjective % self.getObjectiveStrings()[0]
...
class CogTrackQuest(CogQuest):
    ...
    def getObjectiveStrings(self):
        ...
        if numCogs == 1:
            ...
            text = Localizer.QuestsCogTrackDefeatDesc % {
                'numCogs': numCogs,
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if numCogs == 1:
            ...
            text = Localizer.QuestsCogTrackQuestSCStringS
        else:
            cogText = self.trackNamesP[track]
            text = Localizer.QuestsCogTrackQuestSCStringP
...
class CogLevelQuest(CogQuest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        return Localizer.QuestsCogLevelQuestSCString % {
            'objective': objective,
            'location': location }
...
class BuildingQuest(CogQuest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        objective = text % {
            ...
            'type': type }
        location = self.getLocationName()
        return Localizer.QuestsBuildingQuestSCString % {
            'objective': objective,
            'location': location }
...
class FactoryQuest(LocationBasedQuest):
    factoryTypeNames = {
        FT_FullSuit: Localizer.Cog,
        FT_Leg: Localizer.FactoryTypeLeg,
        FT_Arm: Localizer.FactoryTypeArm,
        FT_Torso: Localizer.FactoryTypeTorso }
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            return Localizer.QuestsFactoryQuestProgressString % {
                'progress': questDesc[4],
    ...
    def getObjectiveStrings(self):
        ...
        if count == 1:
            text = Localizer.QuestsFactoryQuestDesc
        else:
            text = Localizer.QuestsFactoryQuestDescC
        return (text % {
            'count': count,
            'type': type },)
    ...
    def getString(self):
        return Localizer.QuestsFactoryQuestString % self.getObjectiveStrings()[0]
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if count == 1:
            ...
            text = Localizer.QuestsFactoryQuestDescI
        objective = text % {
            'type': type }
        location = self.getLocationName()
        return Localizer.QuestsFactoryQuestSCString % {
            'objective': objective,
            'location': location }

    
    def getHeadlineString(self):
        return Localizer.QuestsFactoryQuestHeadline
...
class FactoryNewbieQuest(FactoryQuest):
    ...
    def doesFactoryCount(self, avId, location, avList):
        if not FactoryQuest.doesFactoryCount(self, avId, location, avList):
            return None
...
class DeliverGagQuest(Quest):
    ...
    def getObjectiveStrings(self):
        ...
        if num == 1:
            ...
            text = Localizer.QuestsItemNameAndNum % {
                'num': num,
                'name': gagName }
        return (text,)
    ...
    def getDefaultQuestDialog(self):
        return Localizer.QuestsDeliverGagQuestStringLong % self.getObjectiveStrings()[0] + '\x7' + Localizer.QuestsDeliverGagQuestInstructions
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        num = self.getNumGags()
        if num == 1:
            text = Localizer.QuestsDeliverGagQuestToSCStringS
            gagName = ToontownBattleGlobals.AvPropStringsSingular[track][item]
        else:
            text = Localizer.QuestsDeliverGagQuestToSCStringP
            gagName = ToontownBattleGlobals.AvPropStringsPlural[track][item]
        return [
            text % {
                'gagName': gagName },
            Localizer.QuestsDeliverGagQuestSCString] + getVisitSCStrings(toNpcId)
...
class DeliverItemQuest(Quest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        itemName = iDict[0]
        return [
            Localizer.QuestsDeliverItemQuestSCString % {
                'article': article,
...
class RecoverItemQuest(LocationBasedQuest):
    ...
    def getObjectiveStrings(self):
        ...
        if num == 1:
            ...
            itemName = Localizer.QuestsItemNameAndNum % {
                'num': num,
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        if progress >= self.getNumItems():
            ...
            if toNpcId == ToonHQ:
                strings = [
                    Localizer.QuestsRecoverItemQuestReturnToHQSCString % itemName,
                    Localizer.QuestsRecoverItemQuestGoToHQSCString]
            elif toNpcId:
                (npcName, hoodName, buildingArticle, buildingName, toStreet, streetName) = getNpcInfo(toNpcId)
                strings = [
                    Localizer.QuestsRecoverItemQuestReturnToSCString % {
                        'item': itemName,
                        'npcName': npcName }]
                if streetName == 'Playground':
                    strings.append(Localizer.QuestsRecoverItemQuestGoToPlaygroundSCString % hoodName)
                else:
                    strings.append(Localizer.QuestsRecoverItemQuestGoToStreetSCString % {
                        'to': toStreet,
                        'street': streetName,
                        'hood': hoodName })
                strings.extend([
                    Localizer.QuestsRecoverItemQuestVisitBuildingSCString % (buildingArticle, buildingName),
                    Localizer.QuestsRecoverItemQuestWhereIsBuildingSCString % (buildingArticle, buildingName)])
        ...
        if num == 1:
            ...
            itemName = Localizer.QuestsItemNameAndNum % {
                'num': num,
                'name': ItemDict[item][1] }
        return Localizer.QuestsRecoverItemQuestRecoverFromSCString % {
            'item': itemName,
            'holder': holderName,
            'loc': locName }
...
class TrackChoiceQuest(Quest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        trackBName = ToontownBattleGlobals.Tracks[trackB].capitalize()
        return [
            Localizer.QuestsTrackChoiceQuestSCString % {
                'trackA': trackAName,
                'trackB': trackBName },
            Localizer.QuestsTrackChoiceQuestMaybeSCString % trackAName,
            Localizer.QuestsTrackChoiceQuestMaybeSCString % trackBName] + getVisitSCStrings(toNpcId)
...
class FriendQuest(Quest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        return Localizer.QuestsFriendQuestSCString
...
class FriendNewbieQuest(FriendQuest):
    ...
    def getString(self):
        return Localizer.QuestsFriendNewbieQuestObjective % self.getNumFriends()
...
class TrolleyQuest(Quest):
    ...
    def getSCStrings(self, toNpcId, progress):
        ...
        return Localizer.QuestsTrolleyQuestSCString
...
class MinigameNewbieQuest(Quest):
    ...
    def getString(self):
        return Localizer.QuestsMinigameNewbieQuestObjective % self.getNumMinigames()
...
QuestDict = {
    ...
    5060: (BR_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 5, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5061: (BR_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 5, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5062: (BR_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 5, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5063: (BR_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 5, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5064: (BR_TIER, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5065: (BR_TIER, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5066: (BR_TIER, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5067: (BR_TIER, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    ...
    5290: (BR_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 12, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5291: (BR_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 12, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5292: (BR_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 12, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5293: (BR_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 12, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5294: (BR_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5295: (BR_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5296: (BR_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5297: (BR_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    ...
    5360: (BR_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 20, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5361: (BR_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 20, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5362: (BR_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 20, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5363: (BR_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 20, Any, NEWBIE_HP), Any, ToonHQ, 606, NA, DefaultDialog),
    5364: (BR_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5365: (BR_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5366: (BR_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    5367: (BR_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 1, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    ...
    6160: (DL_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 25, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    6161: (DL_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 25, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    6162: (DL_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 25, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    6163: (DL_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 25, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    6164: (DL_TIER, 1, (BuildingNewbieQuest, Anywhere, 2, Any, 1, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    6165: (DL_TIER, 1, (BuildingNewbieQuest, Anywhere, 2, Any, 1, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    6166: (DL_TIER, 1, (BuildingNewbieQuest, Anywhere, 2, Any, 1, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    6167: (DL_TIER, 1, (BuildingNewbieQuest, Anywhere, 2, Any, 1, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    ...
    7160: (DL_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 35, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    7161: (DL_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 35, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    7162: (DL_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 35, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    7163: (DL_TIER + 1, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 35, Any, NEWBIE_HP), Any, ToonHQ, 607, NA, DefaultDialog),
    7164: (DL_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 2, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    7165: (DL_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 2, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    7166: (DL_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 2, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    7167: (DL_TIER + 1, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 2, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    ...
    8160: (DL_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 40, Any, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    8161: (DL_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 40, Any, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    8162: (DL_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 40, Any, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    8163: (DL_TIER + 2, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 40, Any, NEWBIE_HP), Any, ToonHQ, 608, NA, DefaultDialog),
    8164: (DL_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    8165: (DL_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    8166: (DL_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    8167: (DL_TIER + 2, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    ...
    9160: (DL_TIER + 3, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 45, Any, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9161: (DL_TIER + 3, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 45, Any, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9162: (DL_TIER + 3, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 45, Any, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9163: (DL_TIER + 3, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 45, Any, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9164: (DL_TIER + 3, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9165: (DL_TIER + 3, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9166: (DL_TIER + 3, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    9167: (DL_TIER + 3, 1, (BuildingNewbieQuest, Anywhere, 1, Any, 3, NEWBIE_HP), Any, ToonHQ, 609, NA, DefaultDialog),
    ...
    10001: (ELDER_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 50, Any, NEWBIE_HP), Any, ToonHQ, Any, NA, DefaultDialog),
    10002: (ELDER_TIER, 1, (BuildingNewbieQuest, Anywhere, 4, Any, 1, NEWBIE_HP), Any, ToonHQ, Any, NA, DefaultDialog),
    10100: (ELDER_TIER, 1, (CogQuest, Anywhere, 80, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10101: (ELDER_TIER, 1, (CogQuest, Anywhere, 100, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10102: (ELDER_TIER, 1, (CogQuest, Anywhere, 120, Any), Any, ToonHQ, Any, NA, DefaultDialog),
    10103: (ELDER_TIER, 1, (CogQuest, Anywhere, 200, Any), Any, ToonHQ, 613, NA, DefaultDialog),
    10104: (ELDER_TIER, 1, (CogQuest, Anywhere, 250, Any), Any, ToonHQ, 615, NA, DefaultDialog),
    10105: (ELDER_TIER, 1, (CogQuest, Anywhere, 300, Any), Any, ToonHQ, 616, NA, DefaultDialog),
    10106: (ELDER_TIER, 1, (CogQuest, Anywhere, 400, Any), Any, ToonHQ, 618, NA, DefaultDialog),
    10110: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 40, Any, 2), Any, ToonHQ, Any, NA, DefaultDialog),
    10111: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 30, Any, 3), Any, ToonHQ, Any, NA, DefaultDialog),
    10112: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 25, Any, 4), Any, ToonHQ, Any, NA, DefaultDialog),
    10113: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 20, Any, 5), Any, ToonHQ, Any, NA, DefaultDialog),
    10114: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 20, 'm', 5), Any, ToonHQ, Any, NA, DefaultDialog),
    10115: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 20, 's', 5), Any, ToonHQ, Any, NA, DefaultDialog),
    10116: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 20, 'c', 5), Any, ToonHQ, Any, NA, DefaultDialog),
    10117: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 20, 'l', 5), Any, ToonHQ, Any, NA, DefaultDialog),
    10118: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 50, Any, 1), Any, ToonHQ, 620, NA, DefaultDialog),
    10200: (ELDER_TIER, 1, (CogQuest, Anywhere, 100, Any), Any, ToonHQ, NA, 10201, DefaultDialog),
    10201: (ELDER_TIER, 0, (DeliverItemQuest, 1000), Any, ToonTailor, 1000, NA, DefaultDialog),
    10202: (ELDER_TIER, 1, (BuildingQuest, Anywhere, 25, Any, 1), Any, ToonHQ, NA, 10203, DefaultDialog),
    10203: (ELDER_TIER, 0, (DeliverItemQuest, 1000), Any, ToonTailor, 1000, NA, DefaultDialog),
    10204: (ELDER_TIER, 1, (CogNewbieQuest, ToontownGlobals.ToontownCentral, 60, Any, NEWBIE_HP), Any, ToonHQ, NA, 10205, DefaultDialog),
    10205: (ELDER_TIER, 0, (DeliverItemQuest, 1000), Any, ToonTailor, 1000, NA, DefaultDialog),
    10206: (ELDER_TIER, 1, (BuildingNewbieQuest, Anywhere, 4, Any, 1, NEWBIE_HP), Any, ToonHQ, NA, 10207, DefaultDialog),
    10207: (ELDER_TIER, 0, (DeliverItemQuest, 1000), Any, ToonTailor, 1000, NA, DefaultDialog) }
...
if config.GetBool('want-hq-tasks'):
    QuestDict[390] = (TT_TIER + 1, 1, (FactoryQuest, ToontownGlobals.SellbotHQ, 1), Any, Same, NA, (399,), DefaultDialog)
    QuestDict[399] = (TT_TIER + 1, 0, (VisitQuest,), Same, ToonHQ, 400, NA, DefaultDialog)
...
def getVisitSCStrings(npcId):
    if npcId == ToonHQ:
        strings = [
            Localizer.QuestsRecoverItemQuestSeeHQSCString,
            Localizer.QuestsRecoverItemQuestGoToHQSCString]
    elif npcId == ToonTailor:
        strings = [
            Localizer.QuestsTailorQuestSCString]
    elif npcId:
        (npcName, hoodName, buildingArticle, buildingName, toStreet, streetName) = getNpcInfo(npcId)
        strings = [
            Localizer.QuestsVisitQuestSeeSCString % npcName]
        if streetName == 'Playground':
            strings.append(Localizer.QuestsRecoverItemQuestGoToPlaygroundSCString % hoodName)
        else:
            strings.append(Localizer.QuestsRecoverItemQuestGoToStreetSCString % {
...
def getFinishToonTaskSCStrings(npcId):
    return [
        Localizer.QuestsGenericFinishSCString] + getVisitSCStrings(npcId)
...
def getNpcInfo(npcId):
    ...
    return (npcName, hoodName, buildingArticle, buildingName, toStreet, streetName)
...
def getNpcLocationDialog(fromNpcId, toNpcId):
    ...
    (toNpcName, toHoodName, toBuildingArticle, toBuildingName, toStreetTo, toStreetName) = getNpcInfo(toNpcId)
