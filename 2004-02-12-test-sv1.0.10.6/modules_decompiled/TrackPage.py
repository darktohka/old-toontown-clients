...
class TrackPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        self.title = DirectLabel(parent = self, relief = None, text = Localizer.TrackPageTitle, text_scale = 0.10000000000000001, pos = (0, 0, 0.65000000000000002))
        self.subtitle = DirectLabel(parent = self, relief = None, text = Localizer.TrackPageSubtitle, text_scale = 0.050000000000000003, text_fg = (0.5, 0.10000000000000001, 0.10000000000000001, 1), pos = (0, 0, 0.56000000000000005))
        ...
        self.endFrame.frame['text'] = Localizer.TrackPageDone
    ...
    def clearPage(self):
        ...
        self.startFrame.frame['text'] = ''
        self.trackText['text'] = Localizer.TrackPageClear
        return None

    
    def updatePage(self):
        (trackId, trackProgress) = toonbase.localToon.getTrackProgress()
        if trackId == -1:
            self.clearPage()
        else:
            trackName = ToontownBattleGlobals.Tracks[trackId].capitalize()
            self.trackText['text'] = Localizer.TrackPageTraining % (trackName, trackName)
            trackProgressArray = toonbase.localToon.getTrackProgressAsArray()
            ...
            self.startFrame.frame['text'] = Localizer.TrackPageFilmTitle % trackName
        return None
