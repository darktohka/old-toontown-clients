...
class Playground(Place.Place):
    ...
    def enterTeleportIn(self, requestStatus):
        if len(toonbase.localToon.quests) == 1 and toonbase.localToon.quests[0][0] == NPCForceAcknowledge.TROLLEY_QUEST and self.loader.hood.id == ToontownGlobals.ToontownCentral:
            requestStatus['nextState'] = 'popup'
            imageModel = loader.loadModel('phase_4/models/gui/tfa_images')
            if toonbase.localToon.quests[0][4] < 1:
                (x, y, z, h, p, r) = toonbase.tcr.hoodMgr.getDropPoint(toonbase.tcr.hoodMgr.ToontownCentralInitialDropPoints)
                ...
                (x, y, z, h, p, r) = toonbase.tcr.hoodMgr.getDropPoint(toonbase.tcr.hoodMgr.ToontownCentralHQDropPoints)
