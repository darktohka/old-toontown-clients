...
class VBase4(FFIExternalObject.FFIExternalObject):
    ...
    def addToCell(self, i, value):
        returnValue = libpanda._inPUZN3zyHW(self.this, i, value)
        return returnValue

    
    def addX(self, value):
        returnValue = libpanda._inPUZN3Zmmn(self.this, value)
        return returnValue

    
    def addY(self, value):
        returnValue = libpanda._inPUZN3ZCfs(self.this, value)
        return returnValue

    
    def addZ(self, value):
        returnValue = libpanda._inPUZN3ZuXx(self.this, value)
        return returnValue

    
    def addW(self, value):
        returnValue = libpanda._inPUZN3Zaui(self.this, value)
        return returnValue
