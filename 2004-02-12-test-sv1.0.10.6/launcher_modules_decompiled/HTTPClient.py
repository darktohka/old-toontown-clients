...
class HTTPClient(FFIExternalObject.FFIExternalObject):
    ...
    def setTryAllDirect(self, tryAllDirect):
        returnValue = libpandaexpress._inP2KOdrHMi(self.this, tryAllDirect)
        return returnValue
    ...
    def setClientCertificateFilename(self, filename):
        returnValue = libpandaexpress._inP2KOdTVI3(self.this, filename.this)
        return returnValue

    
    def setClientCertificatePem(self, pem):
        returnValue = libpandaexpress._inP2KOdXLUz(self.this, pem)
        return returnValue
    ...
    def loadClientCertificate(self):
        returnValue = libpandaexpress._inP2KOdZTL6(self.this)
        return returnValue
