...
def dis(x = None):
    ...
    if hasattr(x, '__dict__'):
        ...
        for (name, x1) in items:
            if type(x1) in (types.MethodType, types.FunctionType, types.CodeType):
...
def disassemble(co, lasti = -1):
    ...
    while i < n:
        ...
        if i in labels:
            ...
            print '  ',
        print `i`.rjust(4), opname[op].ljust(20)i = i + 1if op >= HAVE_ARGUMENT:
            ...
            print `oparg`.rjust(5)if op in hasconst:
