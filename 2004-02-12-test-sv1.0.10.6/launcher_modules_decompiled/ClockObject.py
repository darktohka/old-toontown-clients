...
class ClockObject(FFIExternalObject.FFIExternalObject):
    ...
    def getNetFrameRate(self):
        returnValue = libpandaexpress._inPJoxtjXAn(self.this)
        return returnValue
    ...
    def getDegradeFactor(self):
        returnValue = libpandaexpress._inPJoxtYmhR(self.this)
        return returnValue

    
    def setDegradeFactor(self, degradeFactor):
        returnValue = libpandaexpress._inPJoxtTHAP(self.this, degradeFactor)
        return returnValue

    
    def setAverageFrameRateInterval(self, time):
        returnValue = libpandaexpress._inPJoxth4_P(self.this, time)
        return returnValue

    
    def getAverageFrameRateInterval(self):
        returnValue = libpandaexpress._inPJoxt0N1j(self.this)
        return returnValue

    
    def getAverageFrameRate(self):
        returnValue = libpandaexpress._inPJoxtCu1t(self.this)
        return returnValue
