...
def doEffect(textId, speakingToon, nearbyToons):
    ...
    if menuIndex == RESISTANCE_TOONUP:
        ...
        bean = loader.loadModelCopy('phase_4/models/props/jellybean4.bam')
    ...
    i = Parallel(ParticleInterval(effect, speakingToon, worldRelative = 0, duration = 3), Sequence(Wait(0.20000000000000001), recolorToons), autoFinish = 1)
    i.start()
