...
class PhotoAlbumPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.renamePanel = DirectFrame(parent = self, relief = None, pos = (0.45000000000000001, 0, -0.45000000000000001), image = getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = 'Caption Photo', text_scale = 0.059999999999999998, text_pos = (0.0, 0.13), sortOrder = NO_FADE_SORT_INDEX)
        ...
        self.deletePanel = DirectFrame(parent = self, relief = None, pos = (0, 0, 0), image = getDefaultDialogGeom(), image_color = ToontownGlobals.GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = 'Delete Photo?', text_scale = 0.059999999999999998, text_pos = (0.0, 0.13), sortOrder = NO_FADE_SORT_INDEX)
