...
class NPCMoviePlayer(DirectObject):
    ...
    def parseThrowSquirtPreview(self, line):
        ...
        def updateGagLevel(t, curGagLevel = curGagLevel):
            newGagLevel = int(round(PythonUtil.lerp(minGagLevel, maxGagLevel, t)))
        ...
        return Sequence(Func(grabCurTrackAccess), LerpFunctionInterval(updateGagLevel, 0, 1, 0.29999999999999999), WaitInterval(3.5), LerpFunctionInterval(updateGagLevel, 1, 0, 0.29999999999999999), Func(restoreTrackAccess), Func(messenger.send, 'doneThrowSquirtPreview'))
