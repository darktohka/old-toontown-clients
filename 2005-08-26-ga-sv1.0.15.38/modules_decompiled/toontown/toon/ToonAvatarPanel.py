...
class ToonAvatarPanel(AvatarPanel.AvatarPanel):
    ...
    def __init__(self, avatar):
        ...
        petGui = loader.loadModelOnce('phase_3.5/models/gui/PetControlPannel')
        self.petButton = DirectButton(parent = self.frame, image = (petGui.find('**/PetControlToonButtonUp1'), petGui.find('**/PetControlToonButtonDown1'), petGui.find('**/PetControlToonButtonRollover1')), geom = petGui.find('**/PetBattleIcon'), geom3_color = disabledImageColor, relief = None, pos = (0.22, -0.20000000000000001, -0.47499999999999998), text = ('', TTLocalizer.AvatarPanelPet, TTLocalizer.AvatarPanelPet, ''), text_fg = text2Color, text_shadow = (0, 0, 0, 1), text_scale = 0.32500000000000001, text_pos = (-1.0, 0.94999999999999996), command = self._ToonAvatarPanel__handleToPet)
        ...
        self.detailButton = DirectButton(parent = self.frame, image = (gui.find('**/ChtBx_BackBtn_UP'), gui.find('**/ChtBx_BackBtn_DN'), gui.find('**/ChtBx_BackBtn_Rllvr'), gui.find('**/ChtBx_BackBtn_UP')), relief = None, text = ('', TTLocalizer.AvatarPanelDetail, TTLocalizer.AvatarPanelDetail, ''), text_fg = text2Color, text_shadow = (0, 0, 0, 1), text_scale = 0.050000000000000003, text_pos = (0.085000000000000006, 0.055), text_align = TextNode.ACenter, pos = (-0.133773, 0, -0.38713199999999998), command = self._ToonAvatarPanel__handleDetails)
        gui.removeNode()
        petGui.removeNode()
        if wantsLaffMeter:
