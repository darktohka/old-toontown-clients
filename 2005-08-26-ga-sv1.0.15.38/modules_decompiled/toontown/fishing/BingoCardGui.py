...
class BingoCardGui(DirectFrame):
    ...
    def loadNextGameTimer(self):
        self.nextGame = DirectLabel(parent = self, relief = None, text = '', text_font = ToontownGlobals.getSignFont(), text_scale = 1.71 * BG.CardImageScale[2], text_fg = (1.0, 1.0, 1.0, 1), pos = (BG.GridXOffset, 0, 4 * BG.CardImageScale[2]))
    ...
    def load(self):
        ...
        self.gameType.hide()
        self.jpText = DirectLabel(parent = self, pos = (BG.GridXOffset, 0, 0.22), relief = None, state = NORMAL, text = '', text_scale = 0.040000000000000001, text_pos = (0, 0, 0), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1), text_font = ToontownGlobals.getInterfaceFont(), text_wordwrap = 10.5)
        self.gameOver = DirectLabel(parent = self, pos = (BG.GridXOffset, 0, 0), relief = None, state = NORMAL, text = '', text_scale = textScale, text_fg = (1, 1, 1, 1), text_font = ToontownGlobals.getSignFont())
