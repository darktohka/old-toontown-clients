...
class DistributedPhone(DistributedFurnitureItem.DistributedFurnitureItem):
    ...
    def setMovie(self, mode, avId, timestamp):
        ...
        if mode == PhoneGlobals.PHONE_MOVIE_CLEAR:
            ...
            if isLocalToon:
                self.phoneDialog = TTDialog.TTDialog(dialogName = 'PhoneEmpty', style = TTDialog.Acknowledge, text = TTLocalizer.DistributedPhoneEmpty, text_wordwrap = 15, fadeScreen = 1, command = self._DistributedPhone__clearDialog)
