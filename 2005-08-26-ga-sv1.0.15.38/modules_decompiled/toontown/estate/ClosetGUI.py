...
class ClosetGUI(ClothesGUI.ClothesGUI):
    ...
    def load(self):
        ...
        self.cancelButton = DirectButton(relief = None, image = (self.gui.find('**/CrtAtoon_Btn2_UP'), self.gui.find('**/CrtAtoon_Btn2_DOWN'), self.gui.find('**/CrtAtoon_Btn2_RLLVR')), pos = (0.14999999999999999, 0, -0.84999999999999998), command = self._ClosetGUI__handleCancel, text = ('', TTLocalizer.MakeAToonCancel, TTLocalizer.MakeAToonCancel), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_pos = (0, -0.029999999999999999), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
        ...
        if self.isOwner:
            ...
            self.topTrashButton = DirectButton(parent = self.trashPanel, image = trashImage, relief = None, pos = (-0.089999999999999997, 0, 0.20000000000000001), command = self._ClosetGUI__handleDelete, extraArgs = [
                ClosetGlobals.SHIRT], scale = (0.5, 0.5, 0.5), text = TTLocalizer.ClosetDeleteShirt, text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.12, text_pos = (0.29999999999999999, 0), text_fg = (0.80000000000000004, 0.20000000000000001, 0.20000000000000001, 1), text_shadow = (0, 0, 0, 1), textMayChange = 0)
            self.bottomTrashButton = DirectButton(parent = self.trashPanel, image = trashImage, relief = None, textMayChange = 1, pos = (-0.089999999999999997, 0, -0.20000000000000001), command = self._ClosetGUI__handleDelete, extraArgs = [
                ClosetGlobals.SHORTS], scale = (0.5, 0.5, 0.5), text = TTLocalizer.ClosetDeleteShorts, text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.12, text_pos = (0.29999999999999999, 0), text_fg = (0.80000000000000004, 0.20000000000000001, 0.20000000000000001, 1), text_shadow = (0, 0, 0, 1))
            self.button = DirectButton(relief = None, image = (self.gui.find('**/CrtAtoon_Btn1_UP'), self.gui.find('**/CrtAtoon_Btn1_DOWN'), self.gui.find('**/CrtAtoon_Btn1_RLLVR')), pos = (-0.14999999999999999, 0, -0.84999999999999998), command = self._ClosetGUI__handleButton, text = ('', TTLocalizer.MakeAToonDone, TTLocalizer.MakeAToonDone), text_font = ToontownGlobals.getInterfaceFont(), text_scale = 0.080000000000000002, text_pos = (0, -0.029999999999999999), text_fg = (1, 1, 1, 1), text_shadow = (0, 0, 0, 1))
