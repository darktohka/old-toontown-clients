...
class Nametag2d(Nametag.Nametag, MarginPopup.MarginPopup, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libotp and libotp._inPPj7blY5G:
            libotp._inPPj7blY5G(self.this)
        

    
    def getClassType():
        returnValue = libotp._inPPj7bk0dl()
        import TypeHandle
    ...
    def upcastToMarginPopup(self):
        returnValue = libotp._inPPj7b7slQ(self.this)
        import MarginPopup
    ...
    def _Nametag2d__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(self, out, separator):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToMarginPopup()
    ...
    def _Nametag2d__overloaded_listTags_ptrConstPandaNode_ptrOstream(self, out):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToMarginPopup()
    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._Nametag2d__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(*_args)
            
            import BoundingVolume
            if isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._Nametag2d__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(*_args)
    ...
    def addChild(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._Nametag2d__overloaded_addChild_ptrPandaNode_ptrPandaNode(*_args)
        elif numArgs == 2:
            return self._Nametag2d__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(*_args)
        else:
    ...
    def unstashChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._Nametag2d__overloaded_unstashChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._Nametag2d__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def listTags(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._Nametag2d__overloaded_listTags_ptrConstPandaNode_ptrOstream(*_args)
        elif numArgs == 2:
            return self._Nametag2d__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
    ...
    def setAttrib(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._Nametag2d__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(*_args)
        elif numArgs == 2:
            return self._Nametag2d__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
    ...
    def stashChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._Nametag2d__overloaded_stashChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._Nametag2d__overloaded_stashChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def removeChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._Nametag2d__overloaded_removeChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._Nametag2d__overloaded_removeChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def addStashed(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._Nametag2d__overloaded_addStashed_ptrPandaNode_ptrPandaNode(*_args)
        elif numArgs == 2:
            return self._Nametag2d__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
