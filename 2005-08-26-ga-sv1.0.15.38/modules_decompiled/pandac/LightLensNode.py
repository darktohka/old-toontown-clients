...
class LightLensNode(Light.Light, LensNode.LensNode, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPnJyoBC2d:
            libpanda._inPnJyoBC2d(self.this)
        

    
    def getClassType():
        returnValue = libpanda._inPnJyokoD_()
        import TypeHandle
    ...
    def output(self, out):
        returnValue = libpanda._inPnJyo1lQT(self.this, out.this)
        return returnValue

    
    def _LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream_int(self, out, indentLevel):
        returnValue = libpanda._inPnJyoJusW(self.this, out.this, indentLevel)
        return returnValue

    
    def _LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream(self, out):
        returnValue = libpanda._inPnJyoa_Tf(self.this, out.this)
        return returnValue

    
    def upcastToLensNode(self):
        returnValue = libpanda._inPnJyoP0SH(self.this)
        import LensNode
    ...
    def copyLens(self, lens):
        ...
        returnValue = libpanda._inPnJyo1vNW(upcastSelf.this, lens.this)
        return returnValue
    ...
    def setLens(self, lens):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
        returnValue = libpanda._inPnJyo_2fA(upcastSelf.this, lens.this)
        return returnValue
    ...
    def getLens(self):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
        returnValue = libpanda._inPnJyod5Ow(upcastSelf.this)
        import Lens
    ...
    def isInView(self, pos):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
        returnValue = libpanda._inPnJyoUo66(upcastSelf.this, pos.this)
        return returnValue
    ...
    def _LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(self, childNode, sort):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_removeChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_removeChild_ptrPandaNode_int(self, n):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_stashChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_stashChild_ptrPandaNode_int(self, childIndex):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_unstashChild_ptrPandaNode_int(self, stashedIndex):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(self, childNode, sort):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(self, attrib, override):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(self, attrib):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(self, out, separator):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(self, out):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(self, type):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def _LightLensNode__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(self, volume):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToLensNode()
    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._LightLensNode__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(*_args)
            
            import BoundingVolume
            if isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._LightLensNode__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(*_args)
    ...
    def addChild(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode(*_args)
        elif numArgs == 2:
            return self._LightLensNode__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(*_args)
        else:
    ...
    def unstashChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._LightLensNode__overloaded_unstashChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def listTags(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(*_args)
        elif numArgs == 2:
            return self._LightLensNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
    ...
    def setAttrib(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(*_args)
        elif numArgs == 2:
            return self._LightLensNode__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
    ...
    def stashChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._LightLensNode__overloaded_stashChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_stashChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def removeChild(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType) or isinstance(_args[0], types.LongType):
                return self._LightLensNode__overloaded_removeChild_ptrPandaNode_int(*_args)
            
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._LightLensNode__overloaded_removeChild_ptrPandaNode_ptrPandaNode(*_args)
    ...
    def addStashed(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode(*_args)
        elif numArgs == 2:
            return self._LightLensNode__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
    ...
    def write(self, *_args):
        numArgs = len(_args)
        if numArgs == 1:
            return self._LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream(*_args)
        elif numArgs == 2:
            return self._LightLensNode__overloaded_write_ptrConstLightLensNode_ptrOstream_int(*_args)
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 2 '
