...
class Light(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPnJyo9QsN:
            libpanda._inPnJyo9QsN(self.this)
        

    
    def getClassType():
        returnValue = libpanda._inPnJyopidT()
        import TypeHandle
    ...
    def asNode(self):
        returnValue = libpanda._inPnJyoOU8w(self.this)
        import PandaNode
    ...
    def getColor(self):
        returnValue = libpanda._inPnJyolF_a(self.this)
        import VBase4
    ...
    def setColor(self, color):
        returnValue = libpanda._inPnJyo7_hL(self.this, color.this)
        return returnValue

    
    def upcastToReferenceCount(self):
        returnValue = libpanda._inPnJyoqIAk(self.this)
        import ReferenceCount
