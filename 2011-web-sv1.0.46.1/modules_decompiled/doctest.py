...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\doctest.py
...
class DocTest:
    ...
    def __repr__(self):
        ...
        return '<DocTest %s from %s:%s (%s)>' % (self.name, self.filename, self.lineno, examples)
