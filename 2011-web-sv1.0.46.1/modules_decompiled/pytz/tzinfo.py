...
# Embedded file name: C:\cygwin\home\toonpub\player_1_0_46_qa\wintools\sdk\python\Python-2.4.1\lib\site-packages\pytz\tzinfo.py
...
def memorized_ttinfo(*args):
    try:
        ...
        ttinfo = (
         memorized_timedelta(args[0]), memorized_timedelta(args[1]), args[2])
...
class DstTzInfo(BaseTzInfo):
    ...
    def __reduce__(self):
        return (
         pytz._p, (self.zone, _to_seconds(self._utcoffset), _to_seconds(self._dst), self._tzname))
