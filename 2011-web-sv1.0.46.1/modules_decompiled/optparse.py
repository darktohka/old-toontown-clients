...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\optparse.py
__version__ = '1.5a2'
__all__ = [
 'Option', 'SUPPRESS_HELP', 'SUPPRESS_USAGE', 'Values', 'OptionContainer', 'OptionGroup', 'OptionParser', 'HelpFormatter', 'IndentedHelpFormatter', 'TitledHelpFormatter', 'OptParseError', 'OptionError', 'OptionConflictError', 'OptionValueError', 'BadOptionError']
...
_builtin_cvt = {'int': (int, _('integer')), 'long': (long, _('long integer')), 'float': (float, _('floating-point')), 'complex': (complex, _('complex'))}
...
class Option:
    ...
    ACTIONS = ('store', 'store_const', 'store_true', 'store_false', 'append', 'count',
