...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\profile.py
...
class Profile:
    ...
    dispatch = {'call': trace_dispatch_call, 'exception': trace_dispatch_exception, 'return': trace_dispatch_return, 'c_call': trace_dispatch_c_call, 'c_exception': trace_dispatch_exception, 'c_return': trace_dispatch_return}
