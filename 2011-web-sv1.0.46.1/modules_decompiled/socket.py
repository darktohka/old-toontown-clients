...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\socket.py
import _socket
from _socket import *
_have_ssl = False
try:
...
class _socketobject(object):
    ...
    __slots__ = [
     '_sock', 'send', 'recv', 'sendto', 'recvfrom', '__weakref__']
...
class _fileobject(object):
    ...
    name = '<socket>'
    __slots__ = [
     'mode', 'bufsize', 'softspace', '_sock', '_rbufsize', '_wbufsize', '_rbuf', '_wbuf']
