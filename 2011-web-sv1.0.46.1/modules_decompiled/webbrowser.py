...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\webbrowser.py
import os, sys
__all__ = [
...
if os.environ.get('TERM') or os.environ.get('DISPLAY'):
    ...
    if os.environ.get('DISPLAY'):
        _tryorder = [
         'galeon', 'skipstone', 'mozilla-firefox', 'mozilla-firebird', 'mozilla', 'netscape', 'kfm', 'grail'] + _tryorder
