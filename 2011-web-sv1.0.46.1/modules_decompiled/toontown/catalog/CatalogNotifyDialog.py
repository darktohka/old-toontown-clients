...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\catalog\CatalogNotifyDialog.py
...
class CatalogNotifyDialog:
    ...
    def __init__(self, message):
        ...
        self.frame = DirectFrame(relief=None, sortOrder=DGG.BACKGROUND_SORT_INDEX - 2, image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.2,
                                                                                                                                                                                     1.0,
