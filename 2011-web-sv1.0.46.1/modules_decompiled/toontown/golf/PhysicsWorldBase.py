...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\golf\PhysicsWorldBase.py
...
class PhysicsWorldBase:
    ...
    def getCommonObjectData(self):
        ...
        for key in self.commonObjectDict:
            ...
            data = (
             objectPair[0], objectPair[1], pos3[0], pos3[1], pos3[2], quat4[0], quat4[1], quat4[2], quat4[3], anV3[0], anV3[1], anV3[2], lnV3[0], lnV3[1], lnV3[2])
    ...
    def createCommonObject(self, type, commonId, pos, hpr, sizeX=0, sizeY=0, moveDistance=0):
        ...
        if type == 0:
            ...
            self.commonObjectDict[commonId] = (
             commonId, type, box, motor, timeData, forceData, eventData, model, radius)
        return [
