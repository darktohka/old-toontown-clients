...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\golf\DistributedGolfCourse.py
...
class DistributedGolfCourse(DistributedObject.DistributedObject, FSM, DelayDeletable):
    ...
    defaultTransitions = {'Off': ['Join'], 'Join': ['WaitStartHole', 'Cleanup'], 'WaitStartHole': ['PlayHole', 'Cleanup', 'WaitReward'], 'PlayHole': ['WaitFinishCourse', 'WaitStartHole', 'WaitReward', 'Cleanup'], 'WaitReward': ['WaitFinishCourse', 'Cleanup'], 'WaitFinishCourse': ['Cleanup'], 'Cleanup': ['Off']}
    id = 0
