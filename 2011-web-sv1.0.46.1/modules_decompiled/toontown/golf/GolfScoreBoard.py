...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\golf\GolfScoreBoard.py
...
class GolfScoreBoard:
    ...
    def setup(self):
        ...
        self.maximizeB = DirectButton(parent=aspect2d, pos=(1.2, 0, -0.85), relief=None, state=DGG.NORMAL, image=(guiModel.find('**/score_card_icon'), guiModel.find('**/score_card_icon_rollover'), guiModel.find('**/score_card_icon_rollover')), image_scale=(0.2,
                                                                                                                                                                                                                                                                 1,
        ...
        self.highlightCur = DirectLabel(parent=self.scoreboard, relief=None, pos=(-0.003, 0, 0.038), image=highlight, image_scale=(1.82,
                                                                                                                                   1,
                                                                                                                                   0.135))
        self.titleBar = DirectLabel(parent=self.scoreboard, relief=None, pos=(-0.003, 0, 0.166), color=(0.7,
                                                                                                        0.7,
                                                                                                        0.7,
