...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\fishing\FishSellGUI.py
...
class FishSellGUI(DirectFrame):
    ...
    def __init__(self, doneEvent):
        ...
        self.rewardDoubledJellybeanLabel = DirectLabel(text='', text_fg=(1.0, 0.125,
                                                                         0.125, 1.0), relief=None, pos=(0.45, 0, -0.48), scale=0.07)
        buttons.removeNode()
    ...
    def __updateFishValue(self):
        doubledJellybean = ''
        if base.cr.newsManager.isHolidayRunning(ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY):
        ...
        self['text'] = TTLocalizer.FishTankValue % {'name': base.localAvatar.getName(), 'num': num, 'value': value}
        self.setText()