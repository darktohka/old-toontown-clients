...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\fishing\DistributedPondBingoManager.py
...
class DistributedPondBingoManager(DistributedObject.DistributedObject, FSM.FSM):
    ...
    cardTypeDict = {BingoGlobals.NORMAL_CARD: NormalBingo.NormalBingo, BingoGlobals.FOURCORNER_CARD: FourCornerBingo.FourCornerBingo, BingoGlobals.DIAGONAL_CARD: DiagonalBingo.DiagonalBingo, BingoGlobals.THREEWAY_CARD: ThreewayBingo.ThreewayBingo, BingoGlobals.BLOCKOUT_CARD: BlockoutBingo.BlockoutBingo}
