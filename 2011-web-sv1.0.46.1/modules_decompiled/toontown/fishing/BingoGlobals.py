...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\fishing\BingoGlobals.py
...
BLOCKOUT_CARD = 4
Style1 = (
 (249, 193, 41, 255), (106, 241, 233, 255), (64, 215, 206, 255))
...
CardTypeDict = {NORMAL_CARD: (Style1, 10, 140, TTLocalizer.FishBingoTypeNormal, TTLocalizer.FishBingoHelpNormal), FOURCORNER_CARD: (Style2, 20, 120, TTLocalizer.FishBingoTypeCorners, TTLocalizer.FishBingoHelpCorners), DIAGONAL_CARD: (Style3, 40, 180, TTLocalizer.FishBingoTypeDiagonal, TTLocalizer.FishBingoHelpDiagonals), THREEWAY_CARD: (Style4, 80, 180, TTLocalizer.FishBingoTypeThreeway, TTLocalizer.FishBingoHelpThreeway), BLOCKOUT_CARD: (Style5, 1000, 90, TTLocalizer.FishBingoTypeBlockout, TTLocalizer.FishBingoHelpBlockout)}
...
GridXOffset = -0.052
FishButtonDict = {-1: ('mickeyButton', ), 0: ('BaloonFishButton', ), 2: ('CatfishButton', ), 4: ('ClownfishButton', ), 6: ('FrozenfishButton', ), 8: ('starfishButton', ), 10: ('holyMackrelButton', ), 12: ('DogfishButton', ), 14: ('amoreEelButton', ), 16: ('nursesharkButton', ), 18: ('kingcrabButton', ), 20: ('moonfishButton', ), 22: ('pPlane21', ), 24: ('poolsharkButton', ), 26: ('BearacudaButton', ), 28: ('troutButton', ), 30: ('pianotunaButton', ), 32: ('PBJfishButton', ), 34: ('DevilrayButton', )}
TutorialIntro = 1
TutorialMark = 2
TutorialCard = 3
TutorialBingo = 4