...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\fishing\BingoCardGui.py
...
class BingoCardGui(DirectFrame):
    ...
    def load(self):
        ...
        self.gameType = DirectButton(parent=self, pos=(BG.GridXOffset, 0, -8 * BG.CardImageScale[2] - 0.01), relief=None, image=arrowModel.find('**/chatArrow'), image_scale=-0.05, image_pos=(-0.2, 0, 0.025), text='', text_scale=0.045, text_fg=(1,
                                                                                                                                                                                                                                                    1,
                                                                                                                                                                                                                                                    1,
