...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\quest\QuestRewardCounter.py
...
class QuestRewardCounter:
    ...
    def setFromAvatar(self, av):
        ...
        self.maxHp += flowerHp
        HQdepts = (
         ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.SellbotHQ), ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.LawbotHQ), ToontownGlobals.cogHQZoneId2deptIndex(ToontownGlobals.CashbotHQ))
