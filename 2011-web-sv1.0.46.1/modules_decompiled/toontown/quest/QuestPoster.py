...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\quest\QuestPoster.py
...
class QuestPoster(DirectFrame):
    ...
    def __init__(self, parent=aspect2d, **kw):
        ...
        optiondefs = (
         ('relief', None, None), ('reverse', 0, None), ('image', questCard, None), ('image_scale', (0.8, 1.0, 0.58), None), ('state', DGG.NORMAL, None))
        self.defineoptions(kw, optiondefs)
        DirectFrame.__init__(self, relief=None)
        self.initialiseoptions(QuestPoster)
        self.__deleteCallback = None
        ...
        self.rPictureFrame = DirectFrame(parent=self.questFrame, relief=None, image=bookModel.find('**/questPictureFrame'), image_scale=IMAGE_SCALE_SMALL, text='', text_pos=(0, -0.11), text_fg=self.normalTextColor, text_scale=TEXT_SCALE, text_align=TextNode.ACenter, text_wordwrap=11.0, textMayChange=1, pos=(0.18,
                                                                                                                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                                                                                                                     0.13))
        ...
        self.auxText.hide()
        self.questProgress = DirectWaitBar(parent=self.questFrame, relief=DGG.SUNKEN, frameSize=(-0.95, 0.95, -0.1, 0.12), borderWidth=(0.025,
                                                                                                                                        0.025), scale=0.2, frameColor=(0.945,
                                                                                                                                                                       ...
                                                                                                                                                                       1.0), barColor=(0.5,
                                                                                                                                                                                       ...
                                                                                                                                                                                       1), text='0/0', text_scale=0.19, text_fg=(0.05,
                                                                                                                                                                                                                                 0.14,
                                                                                                                                                                                                                                 0.4,
                                                                                                                                                                                                                                 1), text_align=TextNode.ACenter, text_pos=(0, -0.04), pos=(0, 0, -0.195))
    ...
    def showChoicePoster(self, questId, fromNpcId, toNpcId, rewardId, callback):
        ...
        if not hasattr(self, 'chooseButton'):
            ...
            self.chooseButton = DirectButton(parent=self.questFrame, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=(0.7,
                                                                                                                                                                                                            1,
                                                                                                                                                                                                            1), text=TTLocalizer.QuestPageChoose, text_scale=0.06, text_pos=(0, -0.02), pos=(0.285,
                                                                                                                                                                                                                                                                                             0,
                                                                                                                                                                                                                                                                                             0.245), scale=0.65)
    ...
    def update(self, questDesc):
        ...
        if reward:
            if questId not in Quests.NoRewardTierZeroQuests:
            ...
            if quest.getType() == Quests.DeliverGagQuest or quest.getType() == Quests.DeliverItemQuest:
                ...
                if lIconGeom:
                    if track != Quests.Any:
                        ...
                        lIconGeomScale = 0.13
                    infoText = fComplete or quest.getLocationName()
                    if infoText == '':
                        infoText = TTLocalizer.QuestPosterAnywhere
                ...
                if rIconGeom:
                    if track != Quests.Any:
                        ...
                        rIconGeomScale = 0.13
                    headlineString = fComplete or TTLocalizer.QuestsNewbieQuestHeadline
            ...
            if fComplete or numQuestItems <= 1:
                self.questProgress.hide()
                infoZ = quest.getType() == Quests.TrackChoiceQuest or -0.075
        else:
    ...
    def showDeleteButton(self, questDesc):
        ...
        self.deleteButton = DirectButton(parent=self.questFrame, image=(trashcanGui.find('**/TrashCan_CLSD'), trashcanGui.find('**/TrashCan_OPEN'), trashcanGui.find('**/TrashCan_RLVR')), text=('', TTLocalizer.QuestPosterDeleteBtn, TTLocalizer.QuestPosterDeleteBtn), text_fg=(1,
                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                   1), text_shadow=(0,
                                                                                                                                                                                                                                                                                                    0,
                                                                                                                                                                                                                                                                                                    0,
                                                                                                                                                                                                                                                                                                    1), text_scale=0.18, text_pos=(0, -0.12), relief=None, pos=(0.3,
                                                                                                                                                                                                                                                                                                                                                                0,
    ...
    def setDeleteCallback(self, callback):
        self.__deleteCallback = callback
    ...
    def confirmedDeleteButton(self):
        ...
        if self.confirmDeleteButton.doneStatus == 'ok':
            if self.__deleteCallback:
                self.__deleteCallback(questDesc)
        else:
