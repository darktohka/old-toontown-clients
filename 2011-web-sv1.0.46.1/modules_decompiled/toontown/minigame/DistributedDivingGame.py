...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedDivingGame.py
...
class DistributedDivingGame(DistributedMinigame):
    ...
    def setGameReady(self):
        ...
        if DistributedMinigame.setGameReady(self):
            return
        self.dead = 0
        self.difficultyPatterns = {ToontownGlobals.ToontownCentral: [1, 1.5, 65, 3], ToontownGlobals.DonaldsDock: [1, 1.3, 65, 1], ToontownGlobals.DaisyGardens: [2, 1.2, 65, 1], ToontownGlobals.MinniesMelodyland: [2, 1.0, 65, 1], ToontownGlobals.TheBrrrgh: [3, 1.0, 65, 1], ToontownGlobals.DonaldsDreamland: [3, 1.0, 65, 1]}
