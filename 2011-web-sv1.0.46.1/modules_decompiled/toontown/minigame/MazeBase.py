...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\MazeBase.py
...
class MazeBase:
    ...
    def createRandomSpotsList(self, numSpots, randomNumGen):
        ...
        quadrants = [
         (
          0, 0, halfWidth - 1, halfHeight - 1), (halfWidth, 0, width - 1, halfHeight - 1), (0, halfHeight, halfWidth - 1, height - 1), (halfWidth, halfHeight, width - 1, height - 1)]
        spotsTaken = []
