...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedMinigameAI.py
    ...
    def enterFrameworkCleanup(self):
        ...
        for avId in self.avIdList:
            if self.normalExit:
                ...
                score = randReward
            if ToontownGlobals.JELLYBEAN_TROLLEY_HOLIDAY in simbase.air.holidayManager.currentHolidays:
