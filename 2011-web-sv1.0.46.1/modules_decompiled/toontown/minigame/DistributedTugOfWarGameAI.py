...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedTugOfWarGameAI.py
from DistributedMinigameAI import *
from direct.fsm import ClassicFSM, State
from direct.fsm import State
import random
from direct.task.Task import Task
import copy, TugOfWarGameGlobals, math
...
class DistributedTugOfWarGameAI(DistributedMinigameAI):
    ...
    def __init__(self, air, minigameId):
        ...
        self.suitId = 666
        self.suitForces = [
         (6, 4), (2, 5), (2, 6.5), (3, 8.0), (5, 6), (8, 8), (9, 8.5), (4, 9)]
