...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\Trajectory.py
...
class Trajectory:
    ...
    def __str__(self):
        return 'startTime: %s, startPos: %s, startVel: %s, zAcc: %s' % (self.__startTime, repr(self.__startPos), repr(self.__startVel), self.__zAcc)
    ...
    def calcEnterAndLeaveCylinderXY(self, cylBottomCenter, cylRadius):
        ...
        t2 = t2 / mag
        return (
         t1 + self.__startTime, t2 + self.__startTime)
