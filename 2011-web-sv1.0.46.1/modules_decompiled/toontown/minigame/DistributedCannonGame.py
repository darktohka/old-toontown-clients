...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedCannonGame.py
...
class DistributedCannonGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.rewardPanel = DirectLabel(parent=hidden, relief=None, pos=(1.16, 0.0,
                                                                        0.45), scale=0.65, text='', text_scale=0.2, text_fg=(0.95,
                                                                                                                             0.95,
                                                                                                                             0,
                                                                                                                             1), text_pos=(0,
    ...
    def __calcFlightResults(self, avId, launchTime):
        ...
        towerList = [
         towerPos + Point3(0, 0, BUCKET_HEIGHT), TOWER_RADIUS, TOWER_HEIGHT - BUCKET_HEIGHT]
        ...
        return {'startPos': startPos, 'startHpr': startHpr, 'startVel': startVel, 'trajectory': trajectory, 'timeOfImpact': timeOfImpact, 'hitWhat': hitWhat}
