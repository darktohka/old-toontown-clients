...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\VoteResultsTrolleyPanel.py
...
class VoteResultsTrolleyPanel(DirectFrame):
    ...
    def __init__(self, numPlayers, avIdList, votes, directions, namesList, disconnectedList, directionToGo, directionReason, directionTotals, *args, **kwargs):
        opts = {'relief': None, 'geom': DGG.getDefaultDialogGeom(), 'geom_color': ToontownGlobals.GlobalDialogColor[:3] + (0.8, ), 'geom_scale': (1.75, 1, 0.25), 'pos': (0, 0, 0.825)}
        opts.update(kwargs)
            ...
            if av:
                ...
                if self.votes[index] > 0:
                    newLabel = DirectLabel(parent=aspect2d, relief=None, pos=labelPos, text='test', text_fg=(1,
                                                                                                             1,
                                                                                                             1,
                                                                                                             1), text_scale=0.1, text_align=TextNode.ACenter, text_font=ToontownGlobals.getSignFont(), text_pos=(0, -0.01, 0))
                else:
                    newLabel = DirectLabel(parent=aspect2d, geom=DGG.getDefaultDialogGeom(), geom_scale=(0.2,
                                                                                                         ...
                                                                                                         0.2), relief=None, pos=labelPos, text='test', text_fg=(0.5,
                                                                                                                                                                0.5,
                                                                                                                                                                0.5,
                                                                                                                                                                1), text_scale=0.1, text_align=TextNode.ACenter, text_font=ToontownGlobals.getSignFont(), text_pos=(0, -0.035, 0))
