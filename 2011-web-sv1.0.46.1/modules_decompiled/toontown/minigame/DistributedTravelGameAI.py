...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedTravelGameAI.py
...
class DistributedTravelGameAI(DistributedMinigameAI):
    ...
    def checkForEndGame(self):
        ...
        self.sendUpdate('setServerChoices', [self.votesArray, self.directionArray, self.directionToGo, self.directionReason])
