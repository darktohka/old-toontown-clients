...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedTargetGame.py
...
class DistributedTargetGame(DistributedMinigame):
    ...
    UMBRELLA_TEXTURE_LIST = [
     'phase_4/maps/mg_slingshot_umbrella_blue.jpg', 'phase_4/maps/mg_slingshot_umbrella_purple.jpg', 'phase_4/maps/mg_slingshot_umbrella_red.jpg', 'phase_4/maps/mg_slingshot_umbrella_yellow.jpg']
    RT_UNKNOWN = 0
    RT_SUCCESS = 1
    RT_GROUPSUCCESS = 2
    RT_FAILURE = 3
    ...
    def load(self):
        ...
        self.avLabels = [
         av1Label, av2Label, av3Label, av4Label]
