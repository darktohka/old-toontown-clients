...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\CogThiefGameToonSD.py
...
class CogThiefGameToonSD(StateData.StateData):
    ...
    ThrowRunAnim = 'throw'
    animList = [
     FallBackAnim, FallFwdAnim, NeutralAnim, RunAnim, ThrowNeutralAnim, ThrowRunAnim]
