...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\ArrowKeys.py
...
class ArrowKeys(DirectObject):
    ...
    def destroy(self):
        ...
        events = [
         self.UP_KEY, self.DOWN_KEY, self.LEFT_KEY, self.RIGHT_KEY, self.JUMP_KEY]
        for event in events:
            self.ignore(event)
