...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\PurchaseBase.py
        ...
        self.pointDisplay = DirectLabel(parent=self.frame, relief=None, pos=(-1.15,
                                                                             ...
                                                                             0.16), text=str(self.toon.getMoney()), text_scale=0.2, text_fg=(0.95,
                                                                                                                                             ...
                                                                                                                                             1), text_shadow=(0,
                                                                                                                                                              0,
                                                                                                                                                              0,
                                                                                                                                                              1), text_pos=(0, -0.1, 0), image=self.jarImage, text_font=ToontownGlobals.getSignFont())
        self.statusLabel = DirectLabel(parent=self.frame, relief=None, pos=(-0.25, 0, 0.625), text=TTLocalizer.GagShopYouHave % self.toon.getMoney(), text_scale=TTLocalizer.PBstatusLabel, text_fg=(0.05,
                                                                                                                                                                                                     0.14,
                                                                                                                                                                                                     0.4,
                                                                                                                                                                                                     1))
