...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedPatternGame.py
...
class DistributedPatternGame(DistributedMinigame):
    ...
    ButtonSoundNames = (
     phase4snd + 'm_match_trumpet.mp3', phase4snd + 'm_match_guitar.mp3', phase4snd + 'm_match_drums.mp3', phase4snd + 'm_match_piano.mp3')
    ...
    minnieAnimNames = [
     'up', 'left', 'down', 'right']
    toonAnimNames = ['up', 'left', 'down', 'right', 'slip-forward', 'slip-backward', 'victory']
    ...
    def __doneGettingInput(self, pattern):
        ...
        self.proceedTrack = Sequence(Wait(self.getDanceStepDuration()), Func(self.sendUpdate, 'reportPlayerPattern', [
         pattern, self.currentTotalTime]), Func(self.gameFSM.request, 'waitForPlayerPatterns'))
