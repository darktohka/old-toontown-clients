...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedTugOfWarGame.py
...
class DistributedTugOfWarGame(DistributedMinigame):
    ...
    toonAnimNames = [
     'neutral', 'tug-o-war', 'slip-forward', 'slip-backward', 'victory', 'sad-neutral']
