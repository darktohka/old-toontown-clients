...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\TwoDEnemy.py
    ...
    def doDeathTrack(self):
        ...
        if self.isMovingLeftRight:
            ...
            gears2MTrack = Track((0.0, explosionTrack), (
             ...
             2.9, ParticleInterval(bigGearExplosion, self.deathSuit, worldRelative=0, duration=1.0, cleanup=True)), name='gears2MTrack')
