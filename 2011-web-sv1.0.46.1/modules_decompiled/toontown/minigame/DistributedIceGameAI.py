...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedIceGameAI.py
...
class DistributedIceGameAI(DistributedMinigameAI.DistributedMinigameAI):
    ...
    def __init__(self, air, minigameId):
        try:
            ...
            self.finalEndingPositions = [
             Point3(IceGameGlobals.StartingPositions[0]), Point3(IceGameGlobals.StartingPositions[1]), Point3(IceGameGlobals.StartingPositions[2]), Point3(IceGameGlobals.StartingPositions[3])]
    ...
    def enterProcessEndingPositions(self):
        averagePos = [
         Point3(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0), Point3(0, 0, 0)]
        divisor = 0
