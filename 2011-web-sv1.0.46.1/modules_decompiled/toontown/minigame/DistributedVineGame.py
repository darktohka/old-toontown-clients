...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedVineGame.py
...
class DistributedVineGame(DistributedMinigame):
    ...
    def onstage(self):
        ...
        self.toonCollNodes = [legsCollNodepath, headCollNodepath, lHandCollNodepath, rHandCollNodepath, torsoCollNodepath]
    ...
    def updateToonInfo(self, avId, vineIndex=None, vineT=None, posX=None, posZ=None, facingRight=None, climbDir=None, velX=None, velZ=None, fallingInfo=None):
        ...
        if newFallingInfo < self.FallingNot or newFallingInfo > self.FallingBat:
            ...
            newFallingInfo = 0
        newInfo = [
         newVineIndex, newVineT, newPosX, newPosZ, newFacingRight, newClimbDir, newVelX, newVelZ, newFallingInfo]
    ...
    def d_setFallingFromVine(self, avId, vineIndex, facingRight, posX, posZ, velX, velZ, fallingInfo):
        self.sendUpdate('setFallingFromVine', [avId, vineIndex, facingRight, posX, posZ, velX, velZ, fallingInfo])
    ...
    def d_setFallingFromMidair(self, avId, facingRight, posX, posZ, velX, velZ, fallingInfo):
        self.sendUpdate('setFallingFromMidair', [avId, facingRight, posX, posZ, velX, velZ, fallingInfo])
