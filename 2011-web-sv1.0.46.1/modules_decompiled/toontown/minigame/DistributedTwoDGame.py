...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedTwoDGame.py
...
class DistributedTwoDGame(DistributedMinigame):
    ...
    def enterPlay(self, timestamp):
        ...
        handlers = [
         None, None, None, None, self.shootKeyHandler]
    ...
    def enterShowScores(self):
        ...
        scorePanelLocs = (
         (
          (
           cX, bY),), ((lX, bY), (rX, bY)), ((cX, bY), (lX, bY), (rX, bY)), ((lX, tY), (rX, tY), (lX, bY), (rX, bY)))
