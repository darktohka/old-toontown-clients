...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\minigame\DistributedCatchGame.py
...
class DistributedCatchGame(DistributedMinigame):
    ...
    DropObjectPlurals = {'apple': TTLocalizer.CatchGameApples, 'orange': TTLocalizer.CatchGameOranges, 'pear': TTLocalizer.CatchGamePears, 'coconut': TTLocalizer.CatchGameCoconuts, 'watermelon': TTLocalizer.CatchGameWatermelons, 'pineapple': TTLocalizer.CatchGamePineapples, 'anvil': TTLocalizer.CatchGameAnvils}
    ...
    def load(self):
        ...
        groundModels = [
         'phase_4/models/minigames/treehouse_2players', 'phase_4/models/minigames/treehouse_2players', 'phase_4/models/minigames/treehouse_3players', 'phase_4/models/minigames/treehouse_4players']
        ...
        for objType in DropObjectTypes:
            ...
            modelScales = {'apple': 0.7, 'orange': 0.7, 'pear': 0.5, 'coconut': 0.7, 'watermelon': 0.6, 'pineapple': 0.45}
    ...
    def defineConstants(self):
        ...
        fruits = {ToontownGlobals.ToontownCentral: 'apple', ToontownGlobals.DonaldsDock: 'orange', ToontownGlobals.DaisyGardens: 'pear', ToontownGlobals.MinniesMelodyland: 'coconut', ToontownGlobals.TheBrrrgh: 'watermelon', ToontownGlobals.DonaldsDreamland: 'pineapple'}
        ...
        self.cameraPosTable = [
         [
          0, -29.36, 28.17]] * 2 + [[0, -32.87, 30.43], [0, -35.59, 32.1]]
        self.cameraHpr = [
         0, -35, 0]
    ...
    def scheduleDrops(self):
        self.droppedObjNames = [
         self.fruitName] * self.numFruits + ['anvil'] * self.numAnvils
    ...
    def startSuitWalkTask(self):
        ...
        while delay < CatchGameGlobals.GameDuration:
            ...
            m = [
             2.5, 2.5, 2.3, 2.1][(self.getNumPlayers() - 1)]
    ...
    def getIntroMovie(self):
        ...
        initialCamPosHpr = (
         -0.21, -19.56, 13.94, 0.0, 26.57, 0.0)
        ...
        def getThrowIval(toon, hand, object, leftToon, isAnvil=0):
            ...
            objIval = Track((grabFrame * framePeriod,
             Sequence(Func(object.reparentTo, hand), Func(object.setPosHpr, 0.05, -0.13, 0.62, 0, 0, 336.8), LerpScaleInterval(object, objScaleDur, 1.0, startScale=0.1, blendType='easeInOut'))), (
        ...
        tZ = 19.5
        props = [
         'css', 'md', 'm', 'f', 9, 0, 9, 9, 13, 5, 11, 5, 8, 7]
        leftToon = getIntroToon(props, treeNode, [-2.3, tY, tZ])
        props = [
         'mss', 'ls', 'l', 'm', 6, 0, 6, 6, 3, 5, 3, 5, 5, 0]
