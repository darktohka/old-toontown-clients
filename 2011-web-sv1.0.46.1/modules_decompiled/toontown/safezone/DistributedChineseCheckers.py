...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\DistributedChineseCheckers.py
...
class DistributedChineseCheckers(DistributedNode.DistributedNode):
    ...
    def __init__(self, cr):
        ...
        self.clockNode.hide()
        self.playerColors = [
         Vec4(0, 0.9, 0, 1), Vec4(0.9, 0.9, 0, 1), Vec4(0.45, 0, 0.45, 1), Vec4(0.2, 0.4, 0.8, 1), Vec4(1, 0.45, 1, 1), Vec4(0.8, 0, 0, 1)]
