...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\GZSafeZoneLoader.py
...
class GZSafeZoneLoader(SafeZoneLoader):
    ...
    def handleLeftGolf(self):
        req = {'loader': 'safeZoneLoader', 'where': 'playground', 'how': 'teleportIn', 'zoneId': 17000, 'hoodId': 17000, 'shardId': None}
