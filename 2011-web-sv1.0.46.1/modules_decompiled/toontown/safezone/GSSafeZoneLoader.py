...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\GSSafeZoneLoader.py
...
class GSSafeZoneLoader(SafeZoneLoader):
    ...
    def handleLeftRace(self):
        req = {'loader': 'safeZoneLoader', 'where': 'playground', 'how': 'teleportIn', 'zoneId': 8000, 'hoodId': 8000, 'shardId': None}
