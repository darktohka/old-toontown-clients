...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\DistributedPicnicTable.py
...
class DistributedPicnicTable(DistributedNode.DistributedNode):
    ...
    def enableChoiceButtons(self):
        ...
        self.tutorialButton = DirectButton(relief=None, text=TTLocalizer.PicnicTableTutorial, text_fg=(1,
                                                                                                       ...
                                                                                                       0.65,
                                                                                                       1), text_pos=(-0.05,
                                                                                                                     -0.13), text_scale=0.55, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1,
                                                                                                                                                                                                                        0,
                                                                                                                                                                                                                        0,
                                                                                                                                                                                                                        1), image_scale=(20,
                                                                                                                                                                                                                                         1,
    ...
    def joinButtonPushed(self):
        ...
        self.sendUpdate('requestJoin', [
         self.requestSeat, toon.getX(), toon.getY(), toon.getZ(), toon.getH(), toon.getP(), toon.getR()])
        self.requestSeat = None
    ...
    def enableStopObserveButton(self):
        self.stopObserveButton = DirectButton(relief=None, text='Stop Observing', text_fg=(1,
                                                                                           ...
                                                                                           0.65,
                                                                                           1), text_pos=(0,
                                                                                                         -0.23), text_scale=0.45, image=(self.upButton, self.downButton, self.rolloverButton), image_color=(1,
                                                                                                                                                                                                            0,
                                                                                                                                                                                                            0,
                                                                                                                                                                                                            1), image_scale=(20,
                                                                                                                                                                                                                             1,
