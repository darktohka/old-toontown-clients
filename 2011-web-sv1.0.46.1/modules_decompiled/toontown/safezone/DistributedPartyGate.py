...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\DistributedPartyGate.py
...
class DistributedPartyGate(DistributedObject.DistributedObject):
    ...
    def setParty(self, partyInfoTuple):
        ...
        if base.localAvatar.defaultShard == shardId:
            shardId = None
        base.cr.playGame.getPlace().requestLeave({'loader': 'safeZoneLoader', 'where': 'party', 'how': 'teleportIn', 'hoodId': ToontownGlobals.PartyHood, 'zoneId': zoneId, 'shardId': shardId, 'avId': -1})
        return
