...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\DistributedFishingSpot.py
...
class DistributedFishingSpot(DistributedObject.DistributedObject):
    ...
    def __loadStuff(self):
        ...
        if self.splashSounds == None:
            self.splashSounds = (
             base.loadSfx('phase_4/audio/sfx/TT_splash1.mp3'), base.loadSfx('phase_4/audio/sfx/TT_splash2.mp3'))
        return
    ...
    def __makeGui(self):
        ...
        self.exitButton = DirectButton(parent=self.castGui, relief=None, text=('', TTLocalizer.FishingExit, TTLocalizer.FishingExit), text_align=TextNode.ACenter, text_scale=0.1, text_fg=Vec4(1, 1, 1, 1), text_shadow=Vec4(0, 0, 0, 1), text_pos=(0.0, -0.12), pos=(1.75,
                                                                                                                                                                                                                                                                       0,
        ...
        self.castButton = DirectButton(parent=self.castGui, relief=None, text=TTLocalizer.FishingCast, text_align=TextNode.ACenter, text_scale=(3, 3 * 0.75, 3 * 0.75), text_fg=Vec4(1, 1, 1, 1), text_shadow=Vec4(0, 0, 0, 1), text_pos=(0,
                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                       1), image1_color=(0,
                                                                                                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                                                                                                         1), image2_color=(1,
                                                                                                                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                                                                                                                           1), image3_color=(0.8,
                                                                                                                                                                                                                                                                                                                                                             0.5,
                                                                                                                                                                                                                                                                                                                                                             0.5,
                                                                                                                                                                                                                                                                                                                                                             1), pos=(0, -0.05, -0.666), scale=(0.036,
                                                                                                                                                                                                                                                                                                                                                                                                1,
                                                                                                                                                                                                                                                                                                                                                                                                0.048))
        ...
        self.itemGuiCloseButton = DirectButton(parent=self.itemFrame, pos=(0.44, 0, -0.24), relief=None, image=(buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr')), image_scale=(0.7,
                                                                                                                                                                                                                                 1,
