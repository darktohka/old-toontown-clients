...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\GZPlayground.py
...
class GZPlayground(Playground.Playground):
    ...
    def handleGolfKartDone(self, doneStatus):
        ...
        if mode == 'reject':
            ...
            self.doneStatus = {'loader': 'golfcourse', 'where': 'golfcourse', 'hoodId': self.loader.hood.id, 'zoneId': doneStatus['zoneId'], 'shardId': None, 'courseId': doneStatus['courseId']}
            messenger.send(self.doneEvent)
        else:
