...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\safezone\OZSafeZoneLoader.py
...
class OZSafeZoneLoader(SafeZoneLoader):
    ...
    def setGeyserAnim(self, task=None):
        ...
        for av in avList:
            ...
            if distance < 7.0:
                ...
                returnPoints = [
                 (7, 7), (8, 0), (-8, 3), (-7, 7), (3, -7), (0, 8), (-10, 0), (8, -3), (5, 8), (-8, 5), (-1, 7)]
    ...
    def handleLeftGolf(self):
        req = {'loader': 'safeZoneLoader', 'where': 'playground', 'how': 'teleportIn', 'zoneId': 6000, 'hoodId': 6000, 'shardId': None}
