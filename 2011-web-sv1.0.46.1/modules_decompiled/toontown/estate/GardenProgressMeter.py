...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\GardenProgressMeter.py
...
class GardenProgressMeter(DirectObject.DirectObject):
    ...
    def load(self):
        ...
        self.frame = DirectFrame(scale=1.1, relief=None, image=DGG.getDefaultDialogGeom(), image_scale=(1.75,
                                                                                                        1,
                                                                                                        0.75), image_color=ToontownGlobals.GlobalDialogColor, frameSize=(-0.5, 0.5, -0.45, -0.05))
        ...
        self.quitButton = DirectButton(parent=self.frame, relief=None, image=(gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos=(0.5, 1.0, -0.32), scale=0.9, text='Exit', text_font=ToontownGlobals.getSignFont(), text0_fg=(1,
                                                                                                                                                                                                                                                                       1,
                                                                                                                                                                                                                                                                       1,
                                                                                                                                                                                                                                                                       1), text1_fg=(1,
                                                                                                                                                                                                                                                                                     1,
