...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\DistributedFurnitureManager.py
...
class DistributedFurnitureManager(DistributedObject.DistributedObject):
    ...
    def moveItemFromAttic(self, index, posHpr, callback):
        ...
        self.sendUpdate('moveItemFromAtticMessage', [
         index, posHpr[0], posHpr[1], posHpr[2], posHpr[3], posHpr[4], posHpr[5], context])
