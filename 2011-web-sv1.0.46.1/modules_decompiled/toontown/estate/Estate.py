...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\Estate.py
    ...
    def __init__(self, loader, avId, zoneId, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Estate', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'final', 'sit', 'stickerBook', 'options', 'quest', 'fishing', 'mailbox', 'stopped', 'DFA', 'trialerFA', 'doorOut', 'push', 'pet']),
         ...
         State.State('stickerBook', self.enterStickerBook, self.exitStickerBook, [
          'walk', 'sit', 'quest', 'fishing', 'mailbox', 'stopped', 'doorOut', 'push', 'pet', 'DFA', 'trialerFA']),
