...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\DistributedCannon.py
...
class DistributedCannon(DistributedObject.DistributedObject):
    ...
    def __makeGui(self):
        ...
        self.upButton = DirectButton(parent=self.aimPad, image=((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief=None, pos=(0.0115741,
                                                                                                                                                                                           0,
                                                                                                                                                                                           0.221717))
        self.downButton = DirectButton(parent=self.aimPad, image=((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief=None, pos=(0.0136112, 0, -0.210101), image_hpr=(0,
                                                                                                                                                                                                                                  0,
                                                                                                                                                                                                                                  180))
        self.leftButton = DirectButton(parent=self.aimPad, image=((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief=None, pos=(-0.199352, 0, -0.000505269), image_hpr=(0,
                                                                                                                                                                                                                                     0,
                                                                                                                                                                                                                                     -90))
        self.rightButton = DirectButton(parent=self.aimPad, image=((guiModel, '**/Cannon_Arrow_UP'), (guiModel, '**/Cannon_Arrow_DN'), (guiModel, '**/Cannon_Arrow_RLVR')), relief=None, pos=(0.219167, 0, -0.00101024), image_hpr=(0,
                                                                                                                                                                                                                                    0,
                                                                                                                                                                                                                                    90))
    ...
    def __calcFlightResults(self, avId, launchTime):
        ...
        return {'startPos': startPos, 'startHpr': startHpr, 'startVel': startVel, 'trajectory': trajectory, 'timeOfImpact': 3 * timeOfImpact, 'hitWhat': hitWhat}
    ...
    def incrementPinballInfo(self, score, multiplier):
        if base.localAvatar.doId == self.avId:
            ...
            self.notify.debug('score =%d multiplier=%d  curscore=%d curMult=%d' % (score, multiplier, self.curPinballScore, self.curPinballMultiplier))
    ...
    def createBlock(self, collisionName=None):
        ...
        faces = [
         (0, 2, 1), (0, 3, 2), (7, 4, 5), (6, 7, 5), (2, 3, 7), (2, 7, 6), (4, 0, 1), (5, 4, 1), (0, 4, 3), (3, 4, 7), (1, 2, 6), (1, 6, 5)]
        quads = [
         (3, 2, 1, 0), (4, 5, 6, 7), (3, 7, 6, 2), (0, 1, 5, 4), (0, 4, 7, 3), (1, 2, 6, 5)]
