...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\BeanRecipeGui.py
...
class BeanRecipeGui(DirectFrame):
    ...
    def __init__(self, parent, recipe, **kw):
        ...
        optiondefs = [
         (
          'relief', DGG.RIDGE, None), ('state', 'normal', None), ('pos', (0, 0, 0), None), ('frameSize', (left, right, bottom, top), None), ('borderWidth', (borderWidth, borderWidth), self.setBorderWidth)]
