...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\estate\DistributedHouseInterior.py
...
WallpaperPieceNames = (
 WallNames, MouldingNames, FloorNames, WainscotingNames, BorderNames)
...
class DistributedHouseInterior(DistributedObject.DistributedObject):
    ...
    def testWallpaperCombo(self, wallpaperType, wallpaperColorIndex, borderIndex, borderColorIndex, mouldingType, mouldingColorIndex, flooringType, flooringColorIndex, wainscotingType, wainscotingColorIndex):
        ...
        self.wallpaper = CatalogItemList.CatalogItemList([wallpaperItem, mouldingItem, flooringItem, wainscotingItem, wallpaperItem, mouldingItem, flooringItem, wainscotingItem], store=CatalogItem.Customization)
        if self.interior:
            self.__colorWalls()