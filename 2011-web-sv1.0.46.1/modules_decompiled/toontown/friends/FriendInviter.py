...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\friends\FriendInviter.py
...
class FriendInviter(DirectFrame):
    ...
    def __init__(self, avId, avName, avDisableName):
        ...
        DirectFrame.__init__(self, pos=(0.3, 0.1, 0.65), image_color=GlobalDialogColor, image_scale=(1.0,
                                                                                                     1.0,
