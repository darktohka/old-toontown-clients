...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\pets\PetGoal.py
...
class DoTrick(InteractWithAvatar):
    ...
    def __str__(self):
        return '%s-%s-%s: %s' % (self.__class__.__name__, self.avatar.doId, self.trickId, self.getPriority())