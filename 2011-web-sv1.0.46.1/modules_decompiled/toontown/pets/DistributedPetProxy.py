...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\pets\DistributedPetProxy.py
...
class DistributedPetProxy(DistributedObject.DistributedObject):
    ...
    def announceGenerate(self):
        ...
        self.style = [
         self.head, self.ears, self.nose, self.tail, self.bodyTexture, self.color, self.colorScale, self.eyeColor, self.gender]
