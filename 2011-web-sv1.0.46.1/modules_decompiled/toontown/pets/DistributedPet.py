...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\pets\DistributedPet.py
...
if __dev__:
    import pdb
BeanColors = (VBase4(1.0, 0.2, 0.2, 1.0), VBase4(0.2, 1.0, 0.2, 1.0), VBase4(0.2, 0.2, 1.0, 1.0), VBase4(0.0, 1.0, 1.0, 1.0), VBase4(1.0, 1.0, 0.0, 1.0), VBase4(1.0, 0.6, 1.0, 1.0), VBase4(0.6, 0.0, 0.6, 1.0))
...
class DistributedPet(DistributedSmoothNode.DistributedSmoothNode, Pet.Pet, PetBase.PetBase, DelayDeletable):
    ...
    def announceGenerate(self):
        ...
        self.setDNA([self.head, self.ears, self.nose, self.tail, self.bodyTexture, self.color, self.colorScale, self.eyeColor, self.gender])
