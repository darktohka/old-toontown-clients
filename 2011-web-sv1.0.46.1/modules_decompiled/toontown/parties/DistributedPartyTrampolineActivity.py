...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\DistributedPartyTrampolineActivity.py
...
class DistributedPartyTrampolineActivity(DistributedPartyActivity):
    ...
    def __init__(self, cr, doJellyBeans=True, doTricks=False, texture=None):
        ...
        self.jellyBeanColors = [VBase4(1.0, 0.5, 0.5, 1.0), VBase4(0.5, 1.0, 0.5, 1.0), VBase4(0.5, 1.0, 1.0, 1.0), VBase4(1.0, 1.0, 0.4, 1.0), VBase4(0.4, 0.4, 1.0, 1.0), VBase4(1.0, 0.5, 1.0, 1.0)]
    ...
    def loadGUI(self):
        ...
        self.quitEarlyButton = DirectButton(parent=self.screenPlaneElements, relief=None, text=TTLocalizer.PartyTrampolineQuitEarlyButton, text_fg=(1,
                                                                                                                                                    1,
                                                                                                                                                    0.65,
                                                                                                                                                    1), text_pos=(0, -0.23), text_scale=0.7, image=(quitEarlyUp, quitEarlyDown, quitEarlyRollover), image_color=(1,
                                                                                                                                                                                                                                                                 0,
                                                                                                                                                                                                                                                                 0,
                                                                                                                                                                                                                                                                 1), image_scale=(20,
                                                                                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                                                                                  11), pos=(1.15,
                                                                                                                                                                                                                                                                                            0,
                                                                                                                                                                                                                                                                                            0.6), scale=0.09, command=self.leaveTrampoline)
