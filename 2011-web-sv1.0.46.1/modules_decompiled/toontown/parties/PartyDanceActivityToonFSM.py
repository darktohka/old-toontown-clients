...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\PartyDanceActivityToonFSM.py
...
class PartyDanceActivityToonFSM(FSM):
    ...
    def __init__(self, avId, activity, h):
        ...
        self.lastAnim = None
        self.defaultTransitions = {'Init': ['Run', 'DanceMove', 'Cleanup'], 'DanceMove': ['Run', 'DanceMove', 'Cleanup'], 'Run': ['Run', 'DanceMove', 'Cleanup'], 'Cleanup': []}
