...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\TeamActivityGui.py
...
class TeamActivityGui:
    ...
    def load(self):
        ...
        self.exitButton = DirectButton(relief=None, text=TTLocalizer.PartyTeamActivityExitButton, text_fg=(1,
                                                                                                           1,
                                                                                                           0.65,
                                                                                                           1), text_pos=(0, -0.15), text_scale=0.5, image=(upButton, downButton, rolloverButton), image_color=(1,
                                                                                                                                                                                                               0,
                                                                                                                                                                                                               0,
                                                                                                                                                                                                               1), image_scale=(14.5,
                                                                                                                                                                                                                                1,
