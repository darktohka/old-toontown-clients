...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\PartyCogActivityGui.py
...
class PartyCogActivityGui(DirectObject):
    ...
    def _initPiePowerMeter(self):
        h = PartyGlobals.CogActivityPowerMeterHeight / 2.0
        w = PartyGlobals.CogActivityPowerMeterWidth / 2.0
        self._piePowerMeter = DirectWaitBar(frameSize=(-h, h, -w, w), relief=DGG.GROOVE, frameColor=(0.9,
                                                                                                     0.9,
                                                                                                     0.9,
                                                                                                     1.0), borderWidth=(0.01,
