...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\Party.py
...
class Party(Place.Place):
    ...
    def __init__(self, loader, avId, zoneId, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Party', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'final', 'sit', 'stickerBook', 'options', 'quest', 'fishing', 'stopped', 'DFA', 'trialerFA', 'push', 'activity']),
         ...
         State.State('stickerBook', self.enterStickerBook, self.exitStickerBook, [
          'walk', 'sit', 'quest', 'fishing', 'stopped', 'activity', 'push', 'DFA', 'trialerFA']),
    ...
    def handlePartyPlanningDone(self):
        ...
        self.fsm.request('teleportOut', [{'avId': -1, 'zoneId': hoodId, 'shardId': None, 'how': 'teleportIn', 'hoodId': hoodId, 'loader': 'safeZoneLoader', 'where': 'playground'}])
        return
