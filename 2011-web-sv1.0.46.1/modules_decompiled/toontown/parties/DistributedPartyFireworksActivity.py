...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\DistributedPartyFireworksActivity.py
...
class DistributedPartyFireworksActivity(DistributedPartyActivity, FireworkShowMixin):
    ...
    def startActive(self, showStartTimestamp):
        ...
        if timeSinceStart > self.rocketActor.getDuration('launch'):
            ...
            taskMgr.doMethodLater(FireworksPostLaunchDelay, self.startShow, self.taskName('delayedStartShow'), extraArgs=[self.eventId, self.showStyle, showStartTimestamp, self.root])
