...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\DistributedPartyCannonActivity.py
import math
...
class DistributedPartyCannonActivity(DistributedPartyActivity):
    ...
    def __calcFlightResults(self, cannon, toonId, launchTime):
        ...
        return {'startPos': startPos, 'startHpr': startHpr, 'startVel': startVel, 'trajectory': trajectory}
    ...
    def __handleFlyingToonCollision(self, collisionEntry):
        ...
        if vel.dot(hitNormal) > 0:
            if not hitNode == 'collision_roof' and not hitNode == 'collision_fence':
