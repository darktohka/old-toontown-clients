...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\DistributedPartyTeamActivity.py
...
class DistributedPartyTeamActivity(DistributedPartyActivity):
    ...
    def setToonsPlaying(self, leftTeamToonIds, rightTeamToonIds):
        newToonIds = [
         leftTeamToonIds, rightTeamToonIds]
    ...
    def getToonsPlayingChanges(self, oldToonIds, newToonIds):
        ...
        return (
         list(exitedToons), list(joinedToons), shifters, switchers)
