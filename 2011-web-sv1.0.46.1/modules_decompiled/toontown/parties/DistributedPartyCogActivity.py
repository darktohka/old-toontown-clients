...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\parties\DistributedPartyCogActivity.py
...
class DistributedPartyCogActivity(DistributedPartyTeamActivity):
    ...
    def d_broadcastSendPieHitsCog(self, timestamp, hitCogNum, pos, direction, part):
        self.sendUpdate('pieHitsCog', [
         base.localAvatar.doId, timestamp, hitCogNum, pos[0], pos[1], pos[2], direction, part])
