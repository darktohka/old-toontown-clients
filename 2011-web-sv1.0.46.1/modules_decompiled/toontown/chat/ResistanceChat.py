...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\chat\ResistanceChat.py
...
resistanceDict = {RESISTANCE_TOONUP: {'menuName': TTL.ResistanceToonupMenu, 'itemText': TTL.ResistanceToonupItem, 'chatText': TTL.ResistanceToonupChat, 'values': [10, 20, 40, 80, -1], 'items': [0, 1, 2, 3, 4]}, RESISTANCE_MONEY: {'menuName': TTL.ResistanceMoneyMenu, 'itemText': TTL.ResistanceMoneyItem, 'chatText': TTL.ResistanceMoneyChat, 'values': [100, 200, 350, 600], 'items': [0, 1, 2, 3]}, RESISTANCE_RESTOCK: {'menuName': TTL.ResistanceRestockMenu, 'itemText': TTL.ResistanceRestockItem, 'chatText': TTL.ResistanceRestockChat, 'values': [TTBG.HEAL_TRACK, TTBG.TRAP_TRACK, TTBG.LURE_TRACK, TTBG.SOUND_TRACK, TTBG.THROW_TRACK, TTBG.SQUIRT_TRACK, TTBG.DROP_TRACK, -1], 'extra': [TTL.MovieNPCSOSHeal, TTL.MovieNPCSOSTrap, TTL.MovieNPCSOSLure, TTL.MovieNPCSOSSound, TTL.MovieNPCSOSThrow, TTL.MovieNPCSOSSquirt, TTL.MovieNPCSOSDrop, TTL.MovieNPCSOSAll], 'items': [0, 1, 2, 3, 4, 5, 6, 7]}}
...
def doEffect(textId, speakingToon, nearbyToons):
    ...
    if menuIndex == RESISTANCE_TOONUP:
        ...
        colors = {'particles-1': (1, 1, 0, 1), 'particles-2': (1, 0, 0, 1), 'particles-3': (0, 1, 0, 1), 'particles-4': (0, 0, 1, 1), 'particles-5': (1, 0, 1, 1)}
        ...
        iconDict = {'particles-1': icons[0], 'particles-2': icons[1], 'particles-3': icons[2], 'particles-4': icons[3], 'particles-5': icons[4], 'particles-6': icons[5]}
