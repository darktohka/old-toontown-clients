...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\effects\ScavengerHuntEffects.py
...
class ScavengerHuntEffect:
    ...
    def __init__(self, beanAmount):
        ...
        self.npRoot = DirectFrame(parent=aspect2d, relief=None, scale=0.75, pos=(0,
                                                                                 0,
                                                                                 0.6))
        if beanAmount > 0:
