...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\effects\Fireworks.py
...
colors = {WHITE: Vec4(1, 1, 1, 1), RED: Vec4(1, 0.2, 0.2, 1), BLUE: Vec4(0.2, 0.2, 1, 1), YELLOW: Vec4(1, 1, 0.2, 1), GREEN: Vec4(0.2, 1, 0.2, 1), PINK: Vec4(1, 0.5, 0.5, 1), PEACH: Vec4(0.9, 0.6, 0.4, 1), PURPLE: Vec4(1, 0.1, 1, 1), CYAN: Vec4(0.2, 1, 1, 1)}
textures = {SNOWFLAKE: 'phase_8/models/props/snowflake_treasure', MUSICNOTE: 'phase_6/models/props/music_treasure', FLOWER: 'phase_8/models/props/flower_treasure', ICECREAM: 'phase_4/models/props/icecream', STARFISH: 'phase_6/models/props/starfish_treasure', ZZZ: 'phase_8/models/props/zzz_treasure'}
fireworkId = 0
...
def shootPop(x, y, z, color1, color2, amp):
    sfxName = random.choice(('phase_4/audio/sfx/firework_distance_01.mp3', 'phase_4/audio/sfx/firework_distance_02.mp3',
...
def shootFireworkCircleGeneric(x, y, z, color1, color2, amp, poolSize):
    ...
    f.setPos(x, y, z)
    sfxName = random.choice(('phase_4/audio/sfx/firework_explosion_01.mp3', 'phase_4/audio/sfx/firework_explosion_02.mp3',
...
style2shootFunc = {CIRCLE: shootFireworkCircle, CIRCLELARGE: shootFireworkCircleLarge, CIRCLESMALL: shootFireworkCircleSmall, CIRCLESPRITE: shootFireworkCircleSprite, ROCKET: shootFireworkRocket, RING: shootFireworkRing, POP: shootPop}