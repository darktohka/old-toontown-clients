...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\battle\FireCogPanel.py
    ...
    def load(self):
        ...
        self.textFrame = DirectFrame(parent=self.frame, relief=None, image=gui.find('**/PckMn_Select_Tab'), image_color=Vec4(1, 1, 0, 1), image_scale=(1.0,
                                                                                                                                                       ...
                                                                                                                                                       2.0), text='', text_fg=Vec4(0, 0, 0, 1), text_pos=(0,
                                                                                                                                                                                                          0.02,
                                                                                                                                                                                                          0), text_scale=TTLocalizer.FCPtextFrame, pos=(-0.013, 0, 0.013))
        self.textFrame['text'] = TTLocalizer.FireCogTitle % localAvatar.getPinkSlips()
        self.avatarButtons = []
        for i in range(4):
            button = DirectButton(parent=self.frame, relief=None, text='', text_fg=Vec4(0, 0, 0, 1), text_scale=0.067, text_pos=(0, -0.015, 0), textMayChange=1, image_scale=(1.0,
                                                                                                                                                                              1.0,
