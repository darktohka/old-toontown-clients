...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\battle\Movie.py
from toontown.toonbase.ToontownBattleGlobals import *
from BattleBase import *
from direct.interval.IntervalGlobal import *
from direct.showbase import DirectObject
import MovieFire, MovieSOS, MovieNPCSOS, MoviePetSOS, MovieHeal, MovieTrap, MovieLure, MovieSound, MovieThrow, MovieSquirt, MovieDrop, MovieSuitAttacks, MovieToonVictory, PlayByPlayText, BattleParticles
...
class Movie(DirectObject.DirectObject):
    ...
    def restore(self):
        ...
        for suit in self.battle.activeSuits:
            if suit._Actor__animControlDict != None:
                ...
                hands = [
                 suit.getRightHand(), suit.getLeftHand()]
                for hand in hands:
                    props = hand.getChildren()
                    for prop in props:
                        MovieUtil.removeProp(prop)
    ...
    def playReward(self, ts, name, callback):
        ...
        (victory, camVictory) = MovieToonVictory.doToonVictory(self.battle.localToonActive(), self.battle.activeToons, self.toonRewardIds, self.toonRewardDicts, self.deathList, self.rewardPanel, 1, self.uberList, self.helpfulToonsList)
        if victory:
    ...
    def genAttackDicts(self, toons, suits, id0, tr0, le0, tg0, hp0, ac0, hpb0, kbb0, died0, revive0, id1, tr1, le1, tg1, hp1, ac1, hpb1, kbb1, died1, revive1, id2, tr2, le2, tg2, hp2, ac2, hpb2, kbb2, died2, revive2, id3, tr3, le3, tg3, hp3, ac3, hpb3, kbb3, died3, revive3, sid0, at0, stg0, dm0, sd0, sb0, st0, sid1, at1, stg1, dm1, sd1, sb1, st1, sid2, at2, stg2, dm2, sd2, sb2, st2, sid3, at3, stg3, dm3, sd3, sb3, st3):
        ...
        toonAttacks = (
         (
          id0, tr0, le0, tg0, hp0, ac0, hpb0, kbb0, died0, revive0), (id1, tr1, le1, tg1, hp1, ac1, hpb1, kbb1, died1, revive1), (id2, tr2, le2, tg2, hp2, ac2, hpb2, kbb2, died2, revive2), (id3, tr3, le3, tg3, hp3, ac3, hpb3, kbb3, died3, revive3))
        ...
        if base.config.GetBool('want-suit-anims', 1):
            ...
            for a in self.suitAttackDicts:
                ...
                if a['group'] == ATK_TGT_SINGLE:
                    if targetField['died']:
                        if targetField['toon'].doId == base.localAvatar.doId:
                            isLocalToonSad = True
                elif isLocalToonSad:
                    break
