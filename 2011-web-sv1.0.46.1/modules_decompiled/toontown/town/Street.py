...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\town\Street.py
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Street', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'push', 'sit', 'stickerBook', 'WaitForBattle', 'battle', 'DFA', 'trialerFA', 'doorOut', 'elevator', 'tunnelIn', 'tunnelOut', 'teleportOut', 'quest', 'stopped', 'fishing', 'purchase', 'died']),
         ...
         State.State('stickerBook', self.enterStickerBook, self.exitStickerBook, [
          'walk', 'push', 'sit', 'battle', 'DFA', 'trialerFA', 'doorOut', 'elevator', 'tunnelIn', 'tunnelOut', 'WaitForBattle', 'teleportOut', 'quest', 'stopped', 'fishing', 'purchase']),
    ...
    def _teleportToFriend(self, requestStatus):
        ...
        if avId != -1:
            if not base.cr.doId2do.has_key(avId):
                ...
                requestStatus = {'how': 'teleportIn', 'hoodId': hoodId, 'zoneId': hoodId, 'shardId': None, 'loader': 'safeZoneLoader', 'where': 'playground', 'avId': avId}
