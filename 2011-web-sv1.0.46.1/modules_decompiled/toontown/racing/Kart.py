...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\Kart.py
...
class Kart(NodePath, ShadowCaster.ShadowCaster):
    ...
    def __init__(self):
        ...
        self.kartDNA = [
         -1] * getNumFields()
        self.kartAccessories = {KartDNA.ebType: None, KartDNA.spType: None, KartDNA.fwwType: (None, None), KartDNA.bwwType: (None, None)}
        self.texCount = 1
        return
    ...
    def generateKart(self, forGui=0):
        ...
        levelIn = [
         base.config.GetInt('lod1-in', 30), base.config.GetInt('lod2-in', 80), base.config.GetInt('lod2-in', 200)]
