...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\DistributedStartingBlock.py
...
class DistributedStartingBlock(DistributedObject.DistributedObject, FSM):
    ...
    defaultTransitions = {'Off': ['EnterMovie'], 'EnterMovie': ['Off', 'Waiting', 'ExitMovie'], 'Waiting': ['ExitMovie', 'Off'], 'ExitMovie': ['Off', 'ExitMovie']}
