...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\RaceHeadFrame.py
...
class RaceHeadFrame(DirectFrame):
    ...
    def __init__(self, av=None, color=Vec4(1, 1, 1, 1), *args, **kwargs):
        ...
        opts = {'relief': None, 'geom': self.panelGeom, 'geom_scale': (1, 1, 0.5), 'pos': (0, 0, 0)}
        opts.update(kwargs)
