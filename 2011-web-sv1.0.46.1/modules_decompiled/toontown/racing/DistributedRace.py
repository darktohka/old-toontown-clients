...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\DistributedRace.py
...
class DistributedRace(DistributedObject.DistributedObject):
    ...
    def goToSpeedway(self, avIds, reason=RaceGlobals.Exit_UserReq):
        ...
        if localAvatar.doId in avIds:
            ...
            out = {'loader': 'safeZoneLoader', 'where': 'playground', 'how': 'teleportIn', 'hoodId': localAvatar.lastHood, 'zoneId': localAvatar.lastHood, 'shardId': None, 'avId': -1, 'reason': reason}
    ...
    def getCountdownColor(self, countdownTimeInt):
        clockNodeColors = [
         Vec4(0, 1, 0, 1), Vec4(1, 1, 0, 1), Vec4(1, 0.5, 0, 1), Vec4(1, 0, 0, 1)]
    ...
    def setRaceZone(self, zoneId, trackId):
        ...
        self.doneBarrier('waitingForExit')
        self.sendUpdate('racerLeft', [localAvatar.doId])
        out = {'loader': 'racetrack', 'where': 'racetrack', 'hoodId': hoodId, 'zoneId': zoneId, 'trackId': trackId, 'shardId': None, 'reason': RaceGlobals.Exit_UserReq}
