...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\RaceEndPanels.py
...
class RaceResultsPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, raceEndPanel, *args, **kwargs):
        opts = {'relief': None, 'geom': DGG.getDefaultDialogGeom(), 'geom_color': ToontownGlobals.GlobalDialogColor[:3] + (0.8, ), 'geom_scale': (1.75, 1, 0.75)}
        opts.update(kwargs)
...
class RaceWinningsPanel(DirectFrame):
    ...
    def __init__(self, race, *args, **kwargs):
        ...
        self.circuitTotalLabel = DirectLabel(parent=tFrame, relief=None, pos=(TTLocalizer.REPtextPosX, 0.0, -0.2), text=TTLocalizer.KartRace_CircuitTotal + TTLocalizer.KartRace_Colon, text_fg=(0.0,
                                                                                                                                                                                                 ...
                                                                                                                                                                                                 0.0,
                                                                                                                                                                                                 1.0), text_scale=TTLocalizer.REPlargeLabel, text_align=TextNode.ALeft, text_font=DGG.getDefaultFont())
        self.doubleTicketsLabel = DirectLabel(parent=tFrame, relief=None, pos=(0.5, 0.0, -0.26), text=TTLocalizer.KartRace_DoubleTickets, text_fg=(1.0,
                                                                                                                                                   0.125,
                                                                                                                                                   0.125,
...
class RaceEndPanel(DirectFrame):
    ...
    def __init__(self, numRacers, race, *args, **kwargs):
        ...
        self.closeButton = DirectButton(parent=self, image=(gui.find('**/CloseBtn_UP'), gui.find('**/CloseBtn_DN'), gui.find('**/CloseBtn_Rllvr'), gui.find('**/CloseBtn_UP')), relief=None, scale=2.0, text=exitText, text_scale=TTLocalizer.REPsmallLabel, text_pos=(0, -0.1), text_fg=VBase4(1, 1, 1, 1), pos=(1.1, 0, -0.5), command=self.closeButtonPressed)
