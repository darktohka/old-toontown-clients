...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\racing\DistributedVehicle.py
...
class DistributedVehicle(DistributedSmoothNode.DistributedSmoothNode, Kart.Kart, FSM.FSM):
    ...
    def setupDriftParticles(self):
        ...
        driftEffects = (
         Drift(backLeft, backLeft), Drift(backRight, backRight))
        ...
        for piece in range(self.numPieChunks):
            self.piePieces.append(DirectLabel(relief=None, pos=(0.0, 0.0, 0.0), image=self.pieSplatter, image_scale=(0.5,
                                                                                                                     ...
                                                                                                                     0.5), text=' ', text_scale=0.18, text_fg=(1,
                                                                                                                                                               0,
                                                                                                                                                               1,
                                                                                                                                                               1), text_pos=(-0.0, 0.0, 0), text_font=ToontownGlobals.getSignFont(), textMayChange=1))
