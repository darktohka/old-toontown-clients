...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toontowngui\ToontownLoadingScreen.py
...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.gui, relief=None, pos=(-1.06, 0, -0.77), text='', textMayChange=1, text_scale=0.08, text_fg=(0,
                                                                                                                                                                              0,
                                                                                                                                                                              0.5,
