...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toontowngui\TeaserPanel.py
...
class TeaserPanel(DirectObject):
    ...
    def showPage(self, pageName):
        ...
        self.dialog = TTDialog.TTDialog(parent=aspect2dp, text=TTLocalizer.TeaserTop, text_scale=TTLocalizer.TPdialog, text_align=TextNode.ACenter, text_wordwrap=TTLocalizer.TPdialogWordwrap, topPad=-0.15, midPad=1.25, sidePad=0.25, pad=(0.25,
                                                                                                                                                                                                                                              0.25), command=self.__handleDone, fadeScreen=0.5, style=TTDialog.TwoChoice, buttonTextList=[TTLocalizer.TeaserSubscribe, TTLocalizer.TeaserContinue], button_text_scale=TTLocalizer.TPbuttonTextList, buttonPadSF=5.5, sortOrder=NO_FADE_SORT_INDEX, image=self.upsellBackground)
...
class FeatureBrowser(DirectScrolledList):
    ...
    def __init__(self, parent=aspect2dp, **kw):
        ...
        optiondefs = (
         (
          'parent', self.parent, None), ('relief', None, None), ('numItemsVisible', 1, None), ('items', [], None))
