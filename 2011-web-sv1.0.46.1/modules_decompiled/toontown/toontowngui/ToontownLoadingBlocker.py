...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toontowngui\ToontownLoadingBlocker.py
...
class ToontownLoadingBlocker(TTDialog.TTDialog):
    ...
    def __setupLoadingBar(self):
        self.bar = DirectWaitBar(parent=self, guiId='DownloadBlockerBar', pos=(0, 0, -0.3138), relief=DGG.SUNKEN, frameSize=(-0.6, 0.6, -0.1, 0.1), borderWidth=(0.02,
                                                                                                                                                                 0.02), scale=(0.8,
                                                                                                                                                                               0.8,
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            0.5), barColor=(0.2,
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            0.5), text='0%', text_scale=(0.08,
                                                                                                                                                                                                                                                                         0.128), text_fg=(1,
                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                          1,
                                                                                                                                                                                                                                                                                          1), text_align=TextNode.ACenter, text_pos=(0, -0.035))
    ...
    def __createLoadingText(self):
        self.loadingText = DirectLabel(parent=self, relief=None, guiId='BlockerLoadingText', pos=(0, 0, -0.2357), text='', text_fg=(1,
                                                                                                                                    1,
                                                                                                                                    1,
    ...
    def __createToonTip(self):
        self.toonTipText = DirectLabel(parent=self, relief=None, guiId='BlockerToonTip', pos=(0, 0, -0.4688), text='', text_fg=(1,
                                                                                                                                1,
                                                                                                                                1,
