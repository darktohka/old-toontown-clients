...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\cogdominium\CogdoFlyingGameGlobals.py
...
AI.SafezoneId2LegalEagleDamage = {2000: 2, 1000: 4, 5000: 8, 4000: 16, 3000: 24, 9000: 32}
...
Gameplay.ToonAcceleration = {'forward': 40.0, 'backward': 40.0, 'turning': 40.0, 'boostUp': 15.0, 'fall': 10.0, 'activeDropDown': 20.0, 'activeDropBack': 40.0, 'fan': 80.0}
Gameplay.ToonDeceleration = {'forward': 5.0, 'backward': 3.0, 'turning': 10.0, 'fan': 25.0}
Gameplay.ToonVelMax = {'forward': 15.0, 'backward': 6.0, 'turning': 10.0, 'boost': 5.5, 'fall': 10.0, 'fallNoFuel': 70.0, 'fan': 55.0}
...
Gameplay.SafezoneId2LaffPickupHealAmount = {2000: 1, 1000: 2, 5000: 4, 4000: 8, 3000: 12, 9000: 16}
...
Gameplay.BackpackState2TextureName = {Gameplay.BackpackStates.Normal: 'tt_t_ara_cfg_propellerPack', Gameplay.BackpackStates.Targeted: 'tt_t_ara_cfg_propellerPack_eagleTarget', Gameplay.BackpackStates.Attacked: 'tt_t_ara_cfg_propellerPack_eagleAttack', Gameplay.BackpackStates.Refuel: 'tt_t_ara_cfg_propellerPack_flash'}
Gameplay.MinionDnaName = 'bf'
Gameplay.MinionScale = 0.8
Gui = VariableContainer()
Gui.FuelNumBladesPos2D = (
 -0.005, -0.017)
Gui.FuelNumBladesScale = 0.07
Gui.FuelPos2D = (-1.19, -0.24)
Gui.NumBlades2FuelColor = {0: (0.9, 0.15, 0.15, 1.0), 1: (0.9, 0.15, 0.15, 1.0), 2: (0.9, 0.9, 0.15, 1.0), 3: (0.25, 0.65, 0.25, 1.0)}
...
Audio.Cutoff = 75.0
Audio.MusicFiles = {'normal': 'phase_4/audio/bgm/MG_cannon_game.mid', 'end': 'phase_4/audio/bgm/FF_safezone.mid', 'waiting': 'phase_4/audio/bgm/m_match_bg2.mid', 'invul': 'phase_4/audio/bgm/MG_CogThief.mid', 'timeRunningOut': 'phase_7/audio/bgm/encntr_suit_winning_indoor.mid'}
...
Level.PlatformType2SpawnOffset = {Level.PlatformTypes.Platform: 2.5, Level.PlatformTypes.StartPlatform: 5.0, Level.PlatformTypes.EndPlatform: 5.0}
...
Level.DifficultyOrder = {2000: (1, 1, 1, 2, 1), 1000: (1, 1, 2, 2, 1), 5000: (1, 2, 1, 2, 2), 4000: (1, 2, 1, 2, 3, 2), 3000: (1, 2, 2, 3, 2, 3), 9000: (2, 3, 2, 3, 2, 3, 2)}
...
Level.GatherableType2TextureName = {Level.GatherableTypes.LaffPowerup: 'tt_t_ara_cfg_legalEagleFeather_flash', Level.GatherableTypes.InvulPowerup: 'tt_t_ara_cfg_redTapePickup_flash', Level.GatherableTypes.Memo: 'tt_t_ara_csa_memo_flash', Level.GatherableTypes.Propeller: 'tt_t_ara_cfg_propellers_flash'}
