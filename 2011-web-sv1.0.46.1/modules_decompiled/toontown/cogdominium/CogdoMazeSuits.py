...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\cogdominium\CogdoMazeSuits.py
...
class CogdoMazeSuit(MazeSuit, FSM, CogdoMazeSplattable):
    ...
    def doDeathTrack(self):
        ...
        gears2MTrack = Track((0.0, explosionTrack), (
         ...
         5.4, ParticleInterval(bigGearExplosion, self.deathSuit, worldRelative=0, duration=1.0, cleanup=True)), name='gears2MTrack')
...
class CogdoMazeSlowMinionSuit(CogdoMazeSuit):
    ...
    def __init__(self, serialNum, maze, randomNumGen, difficulty, startTile=None):
        ...
        self.defaultTransitions = {'Off': ['Normal'], 'Normal': ['Attack', 'Off'], 'Attack': ['Normal']}
...
class CogdoMazeBossSuit(CogdoMazeSuit):
    ...
    def spin(self):
        ...
        spinIval = LerpHprInterval(part, time, (
         self.suit.getH() + degrees, 0, 0), blendType='easeOut')
        spinIval.start()
