...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\cogdominium\DistCogdoCraneMoneyBag.py
...
class DistCogdoCraneMoneyBag(DistCogdoCraneObject):
    ...
    grabPos = (
     0, 0, GameConsts.Settings.MoneyBagGrabHeight.get())
