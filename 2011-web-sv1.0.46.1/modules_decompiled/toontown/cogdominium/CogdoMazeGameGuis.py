...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\cogdominium\CogdoMazeGameGuis.py
...
class CogdoMazeBossCodeFrame(DirectFrame):
    ...
    def __init__(self, id, code, modelToCopy):
        ...
        self._label = DirectLabel(parent=self._bg, relief=None, scale=Globals.BossCodeFrameLabelScale, text=code, pos=(0, 0, -0.03), text_align=TextNode.ACenter, text_fg=Globals.BossCodeFrameLabelNormalColor, text_shadow=(0,
                                                                                                                                                                                                                              0,
                                                                                                                                                                                                                              0,
