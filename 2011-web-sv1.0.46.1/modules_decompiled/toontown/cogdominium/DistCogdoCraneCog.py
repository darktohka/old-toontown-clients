...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\cogdominium\DistCogdoCraneCog.py
...
class DistCogdoCraneCog(Suit, DistributedObject):
    ...
    def _startMoveIval(self, entranceId, startT):
        self._stopMoveIval()
        unitVecs = (PM.Vec3(1, 0, 0), PM.Vec3(0, 1, 0), PM.Vec3(-1, 0, 0), PM.Vec3(0, -1, 0))
        machineDistance = 4
        entranceDistance = 60
