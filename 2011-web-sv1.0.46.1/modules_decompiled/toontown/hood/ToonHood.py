...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\hood\ToonHood.py
...
class ToonHood(Hood.Hood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.fsm = ClassicFSM.ClassicFSM('Hood', [
         ...
         State.State('safeZoneLoader', self.enterSafeZoneLoader, self.exitSafeZoneLoader, [
          'quietZone', 'suitInterior', 'cogdoInterior', 'townLoader', 'minigame']),
         ...
         State.State('quietZone', self.enterQuietZone, self.exitQuietZone, [
          'safeZoneLoader', 'townLoader', 'suitInterior', 'cogdoInterior', 'minigame']),
    ...
    def handlePurchaseDone(self):
        ...
        if doneStatus['where'] == 'playground':
            self.fsm.request('quietZone', [{'loader': 'safeZoneLoader', 'where': 'playground', 'how': 'teleportIn', 'hoodId': self.hoodId, 'zoneId': self.hoodId, 'shardId': None, 'avId': -1}])
