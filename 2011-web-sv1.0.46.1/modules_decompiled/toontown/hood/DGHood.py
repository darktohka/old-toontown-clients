...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\hood\DGHood.py
...
class DGHood(ToonHood.ToonHood):
    ...
    def __init__(self, parentFSM, doneEvent, dnaStore, hoodId):
        ...
        self.holidayStorageDNADict = {WINTER_DECORATIONS: ['phase_8/dna/winter_storage_DG.dna'], HALLOWEEN_PROPS: ['phase_8/dna/halloween_props_storage_DG.dna']}
