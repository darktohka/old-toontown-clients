...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\CountryClubInterior.py
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('CountryClubInterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'push', 'sit', 'stickerBook', 'WaitForBattle', 'battle', 'died', 'teleportOut', 'squished', 'DFA', 'fallDown', 'stopped', 'elevator']),
