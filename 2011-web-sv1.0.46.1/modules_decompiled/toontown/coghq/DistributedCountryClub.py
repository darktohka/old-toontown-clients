...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedCountryClub.py
...
class DistributedCountryClub(DistributedObject.DistributedObject):
    ...
    def __init__(self, cr):
        ...
        self.titleText = OnscreenText.OnscreenText('', fg=self.titleColor, shadow=(0,
                                                                                   0,
                                                                                   0,
                                                                                   1), font=ToontownGlobals.getSignFont(), pos=(0, -0.5), scale=0.1, drawOrder=0, mayChange=1)
