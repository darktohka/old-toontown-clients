...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedFoodBelt.py
...
class DistributedFoodBelt(DistributedObject.DistributedObject, FSM.FSM, FoodBeltBase):
    ...
    ToonupModels = ['phase_6/models/golf/picnic_apple.bam', 'phase_6/models/golf/picnic_cupcake.bam', 'phase_6/models/golf/picnic_sandwich.bam', 'phase_6/models/golf/picnic_chocolate_cake.bam']
    ToonupScales = [
     5, 5, 5, 4]
