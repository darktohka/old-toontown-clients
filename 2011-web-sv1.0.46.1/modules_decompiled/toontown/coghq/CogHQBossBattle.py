...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\CogHQBossBattle.py
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('CogHQBossBattle', [
         ...
         State.State('finalBattle', self.enterFinalBattle, self.exitFinalBattle, [
          'walk', 'stickerBook', 'teleportOut', 'died', 'tunnelOut', 'DFA', 'battle', 'movie', 'ouch', 'crane', 'WaitForBattle', 'squished']),
