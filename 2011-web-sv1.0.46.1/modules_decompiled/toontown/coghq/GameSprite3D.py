...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\GameSprite3D.py
...
class GameSprite:
    ...
    colorList = (
     colorRed, colorBlue, colorGreen, colorWhite, colorBlack, colorPurple, colorYellow, colorOrange, colorAqua, colorSteel)
