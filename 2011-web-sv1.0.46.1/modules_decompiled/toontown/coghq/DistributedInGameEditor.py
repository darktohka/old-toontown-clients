...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedInGameEditor.py
...
class DistributedInGameEditor(DistributedObject.DistributedObject, Level.Level, InGameEditorElement):
    ...
    def insertEntity(self, entType, parentEntId=None, callback=None):
        ...
        old2new = [setEntCreateHandler, (self.editMgrEntity.entId, 'requestNewEntity', {'entType': entType, 'parentEntId': parentEntId, 'username': self.editUsername})]
        self.setUndoableAttribEdit(old2new, new2old)
        return
    ...
    def doRemoveEntity(self, entId):
        ...
        if entType in self.entTypeReg.getPermanentTypeNames():
            ...
            return
        removeAction = (
         self.editMgrEntity.entId, 'removeEntity', {'entId': entId})
        old2new = [
         removeAction]
        oldAttribs = []
        ...
        new2old = [setEntCreateHandler, (self.editMgrEntity.entId, 'requestNewEntity', {'entType': self.getEntityType(entId), 'parentEntId': parentEntId, 'username': self.editUsername})]
        self.setUndoableAttribEdit(old2new, new2old)
    ...
    def duplicateSelectedEntity(self):
        ...
        old2new = [setEntCreateHandler, (self.editMgrEntity.entId, 'requestNewEntity', {'entType': self.getEntityType(selectedEntId), 'parentEntId': parentEntId, 'username': self.editUsername})]
        self.setUndoableAttribEdit(old2new, new2old)
