...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedMoleField.py
...
class DistributedMoleField(DistributedNodePathEntity, MoleFieldBase.MoleFieldBase):
    ...
    def __showToonHitByBomb(self, avId, moleIndex, timestamp=0):
        ...
        endTile = [
         rng.randint(0, self.numSquaresX - 1), rng.randint(0, self.numSquaresY - 1)]
        endWorldCoords = (
