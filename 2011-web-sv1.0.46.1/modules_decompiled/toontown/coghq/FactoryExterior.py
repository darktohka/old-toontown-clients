...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\FactoryExterior.py
    ...
    def load(self):
        self.fsm = ClassicFSM.ClassicFSM('FactoryExterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'stickerBook', 'teleportOut', 'tunnelOut', 'DFA', 'doorOut', 'elevator', 'stopped', 'WaitForBattle', 'battle']),
