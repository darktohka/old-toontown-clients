...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedGolfGreenGame.py
...
class DistributedGolfGreenGame(BattleBlocker.BattleBlocker):
    ...
    def __init__(self, cr):
        ...
        self.tooLowFlag = 0
        self.toonPoints = (
         Point3(3.0, 13.0, 0.0), Point3(6.0, 13.0, 0.0), Point3(-3.0, 13.0, 0.0), Point3(-6.0, 13.0, 0.0))
        self.joinedToons = []
    ...
    def setup(self):
        ...
        for countX in range(0, self.gridDimX):
            ...
            for countZ in range(self.gridDimZ):
                ...
                newCell = [
                 None, countX * self.cellSizeX + self.minX + offset + margin, countZ * self.cellSizeZ + self.minZ, countX, countZ, None]
        ...
        self.boardData = [
         (
          (1, 0, 0), (4, 0, 1), (6, 0, 2), (1, 1, 0)), ((1, 0, 1), (4, 0, 1), (6, 0, 1), (1, 1, 1)), ((1, 0, 2), (4, 0, 2), (6, 0, 2), (1, 1, 2))]
        self.attackPatterns = [
         (0, 1, 2), (0, 0, 1, 1, 2, 2), (0, 1, 0, 2)]
        self.winCounter = 0
        self.matchList = []
    ...
    def load(self):
        ...
        self.frame2D = DirectFrame(scale=1.1, relief=DGG.FLAT, frameSize=(-0.1, 0.1, -0.1, -0.1), frameColor=(0.737,
                                                                                                              0.573,
                                                                                                              0.345,
                                                                                                              0.3))
        gui2 = loader.loadModel('phase_3/models/gui/quit_button')
        self.quitButton = DirectButton(parent=self.frame2D, relief=None, image=(gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos=(0.95, 1.3, -0.69), image_scale=(0.9,
                                                                                                                                                                                                            1.0,
                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                    1), text0_shadow=(0,
                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                      1), text1_fg=(1,
                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                    1), text2_fg=(1,
                                                                                                                                                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                                                                                                                                                  1,
                                                                                                                                                                                                                                                                                                                                                  1), text_scale=TTLocalizer.DGGGquitButton, text_pos=(0, -0.01), command=self.__leaveGame)
        ...
        self.instructions = DirectFrame(parent=self.frame2D, relief=None, image=DGG.getDefaultDialogGeom(), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.2,
                                                                                                                                                                        1.0,
                                                                                                                                                                        1.0), text=TTLocalizer.GolfGreenGameDirections, text_font=ToontownGlobals.getSignFont(), text_align=TextNode.ALeft, text_wordwrap=16, text_scale=0.06, text_pos=(-0.5, 0.3), pos=(0.0, 0, -0.0))
        ...
        self.howToButton = DirectButton(parent=self.frame2D, relief=None, image=(gui2.find('**/QuitBtn_UP'), gui2.find('**/QuitBtn_DN'), gui2.find('**/QuitBtn_RLVR')), pos=(0.95, 1.3, -0.82), image_scale=(0.9,
                                                                                                                                                                                                             1.0,
                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                      1), text0_shadow=(0,
                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                        1), text1_fg=(1,
                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                      1), text2_fg=(1,
                                                                                                                                                                                                                                                                                                                                                    1,
                                                                                                                                                                                                                                                                                                                                                    1,
                                                                                                                                                                                                                                                                                                                                                    1), text_scale=TTLocalizer.DGGGhowToButton, text_pos=(0, -0.01), command=self.instructions.show)
        self.howToButton.hide()
        self.timerLabel = DirectLabel(parent=self.frame2D, relief=None, image=gui2.find('**/QuitBtn_UP'), pos=(0.9, 1.3, -0.42), image_scale=(0.5,
                                                                                                                                              1.0,
                                                                                                                                              1.0), text='Timer', text_font=ToontownGlobals.getSignFont(), text0_fg=(1,
                                                                                                                                                                                                                     1,
                                                                                                                                                                                                                     1,
                                                                                                                                                                                                                     1), text_scale=0.045, text_pos=(0, -0.01))
        self.timerLabel.hide()
        self.headPanel = loader.loadModel('phase_6/models/golf/headPanel')
        self.scoreBoard = DirectFrame(scale=1.0, pos=(0.0, 0, 0.9), relief=DGG.FLAT, parent=aspect2d, frameSize=(-0.35, 0.35, -0.05, 0.05), frameColor=(0.737,
                                                                                                                                                        0.573,
                                                                                                                                                        0.345,
                                                                                                                                                        0.3))
        self.scoreLabel = DirectLabel(parent=self.scoreBoard, relief=None, pos=(0,
                                                                                ...
                                                                                0), scale=1.0, text='', text_font=ToontownGlobals.getSignFont(), text0_fg=(1,
                                                                                                                                                           ...
                                                                                                                                                           1), text0_shadow=(0.0,
                                                                                                                                                                             0.0,
                                                                                                                                                                             0.0,
                                                                                                                                                                             1), text_scale=TTLocalizer.DGGGscoreLabel, text_pos=(0, -0.02))
                                                                                                                         ...
                                                                                                                         1), pos=(0.0,
                                                                                                                                  ...
                                                                                                                                  0.67), scale=1.0, text='You gotsa bonus fool!', text_font=ToontownGlobals.getSignFont(), text0_fg=(1,
                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                     1), text0_shadow=(0.0,
                                                                                                                                                                                                                                                       0.0,
                                                                                                                                                                                                                                                       0.0,
                                                                                                                                                                                                                                                       1), text_scale=0.055, text_pos=(0, -0.1), textMayChange=1)
