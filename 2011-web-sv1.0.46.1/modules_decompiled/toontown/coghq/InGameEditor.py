...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\InGameEditor.py
...
class InGameEditor(AppShell):
    ...
    def addColorWidget(self, levelSpec, entSpec, entId, attribName, params):
        ...
        widg._floaters.component('valuatorGroup')['postCallback'] = lambda x, y, z, a: veCommand([x, y, z, a])
        self.attribWidgets.append(widg)
...
DEFAULT_MENU_ITEMS = [
 'Update Explorer', 'Separator', 'Select', 'Deselect', 'Separator', 'Delete', 'Separator', 'Fit', 'Flash', 'Isolate', 'Toggle Vis', 'Show All', 'Separator', 'Set Reparent Target', 'Reparent', 'WRT Reparent', 'Separator', 'Place', 'Set Name', 'Set Color', 'Explore', 'Separator']
