...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\coghq\DistributedCogKart.py
import math
...
class DistributedCogKart(DistributedElevatorExt.DistributedElevatorExt):
    ...
    JumpOutOffsets = ((6.5, -2, -0.025), (-6.5, -2, -0.025), (3.75, 5, -0.025), (-3.75, 5, -0.025))
    ...
    def setCountryClubInteriorZone(self, zoneId):
        if self.localToonOnBoard:
            ...
            doneStatus = {'loader': 'cogHQLoader', 'where': 'countryClubInterior', 'how': 'teleportIn', 'zoneId': zoneId, 'countryClubId': self.countryClubId, 'hoodId': hoodId}
