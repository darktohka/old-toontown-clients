...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\building\SuitInterior.py
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('SuitInterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'stickerBook', 'stopped', 'sit', 'died', 'teleportOut', 'Elevator', 'DFA', 'trialerFA']),
