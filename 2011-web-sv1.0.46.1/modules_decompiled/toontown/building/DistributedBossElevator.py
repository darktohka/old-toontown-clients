...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\building\DistributedBossElevator.py
...
class DistributedBossElevator(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setBossOfficeZone(self, zoneId):
        if self.localToonOnBoard:
            ...
            doneStatus = {'loader': 'cogHQLoader', 'where': 'cogHQBossBattle', 'how': 'movie', 'zoneId': zoneId, 'hoodId': hoodId}
