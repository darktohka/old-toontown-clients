...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\building\DistributedToonHallInterior.py
...
class DistributedToonHallInterior(DistributedToonInterior):
    ...
    def __init__(self, cr):
        ...
        self.sillyFSM = ClassicFSM.ClassicFSM('SillyOMeter', [
         State.State('Setup', self.enterSetup, self.exitSetup, [
          'Phase0', 'Phase1', 'Phase2', 'Phase3', 'Phase4', 'Phase5', 'Phase6', 'Phase7', 'Phase8', 'Phase9', 'Phase10', 'Phase11', 'Phase12', 'Phase13', 'Phase14', 'Phase15', 'Flat', 'Off']),
    ...
    def enterToon(self):
        self.toonhallView = (
         Point3(0, -5, 3), Point3(0, 12.0, 7.0), Point3(0.0, 10.0, 5.0), Point3(0.0, 10.0, 5.0), 1)
