...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\building\ToonInterior.py
    ...
    def __init__(self, loader, parentFSMState, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('ToonInterior', [
         ...
         State.State('walk', self.enterWalk, self.exitWalk, [
          'sit', 'stickerBook', 'doorOut', 'DFA', 'trialerFA', 'teleportOut', 'quest', 'purchase', 'phone', 'stopped', 'pet']),
         State.State('sit', self.enterSit, self.exitSit, [
          'walk']),
         State.State('stickerBook', self.enterStickerBook, self.exitStickerBook, [
          'walk', 'DFA', 'trialerFA', 'sit', 'doorOut', 'teleportOut', 'quest', 'purchase', 'phone', 'stopped', 'pet']),
