...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\shtiker\ShtikerBook.py
...
class ShtikerBook(DirectFrame, StateData.StateData):
    ...
    def __init__(self, doneEvent):
        ...
        self.setPos(0, 0, 0.1)
        self.pageOrder = [
         TTLocalizer.OptionsPageTitle, TTLocalizer.ShardPageTitle, TTLocalizer.MapPageTitle, TTLocalizer.InventoryPageTitle, TTLocalizer.QuestPageToonTasks, TTLocalizer.TrackPageShortTitle, TTLocalizer.SuitPageTitle, TTLocalizer.FishPageTitle, TTLocalizer.KartPageTitle, TTLocalizer.DisguisePageTitle, TTLocalizer.NPCFriendPageTitle, TTLocalizer.GardenPageTitle, TTLocalizer.GolfPageTitle, TTLocalizer.EventsPageName, TTLocalizer.NewsPageName]
        return
    ...
    def load(self):
        ...
        self.nextArrow = DirectButton(parent=self, relief=None, image=(bookModel.find('**/arrow_button'), bookModel.find('**/arrow_down'), bookModel.find('**/arrow_rollover')), scale=(0.1,
                                                                                                                                                                                        0.1,
                                                                                                                                                                                        0.1), pos=(0.838, 0, -0.661), command=self.__pageChange, extraArgs=[1])
    ...
    def addPageTab(self, page, pageIndex, pageName='Page'):
        ...
        pageTab = DirectButton(parent=self.pageTabFrame, relief=DGG.RAISED, frameSize=(-0.575, 0.575, -0.575, 0.575), borderWidth=(0.05,
                                                                                                                                   0.05), text=('', '', pageName, ''), text_align=TextNode.ALeft, text_pos=(1, -0.2), text_scale=TTLocalizer.SBpageTab, text_fg=(1,
                                                                                                                                                                                                                                                                 1,
                                                                                                                                                                                                                                                                 1,
                                                                                                                                                                                                                                                                 1), text_shadow=(0,
                                                                                                                                                                                                                                                                                  0,
