...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\shtiker\PurchaseManagerAI.py
        ...
        for avId in self.getInvolvedPlayerIds():
            if avId > 3 and self.air.doId2do.has_key(avId):
                ...
                if self.metagameRound == TravelGameGlobals.FinalMetagameRoundIndex:
                    ...
                    if self.air.holidayManager.isHolidayRunning(ToontownGlobals.JELLYBEAN_TROLLEY_HOLIDAY):
