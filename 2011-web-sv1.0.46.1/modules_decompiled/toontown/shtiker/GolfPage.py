...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\shtiker\GolfPage.py
...
class GolfPage(ShtikerPage):
    ...
    def load(self):
        ...
        self.recordsTab = DirectButton(parent=self, relief=None, text=TTLocalizer.GolfPageRecordsTab, text_scale=TTLocalizer.GPrecordsTab, text_align=TextNode.ALeft, image=gui.find('**/tabs/polySurface2'), image_pos=(0.12, 1, -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                     0,
        ...
        self.trophyTab = DirectButton(parent=self, relief=None, text=TTLocalizer.GolfPageTrophyTab, text_scale=TTLocalizer.GPtrophyTab, text_pos=TTLocalizer.GPtrophyTabTextPos, text_align=TextNode.ALeft, image=gui.find('**/tabs/polySurface3'), image_pos=(-0.28, 1, -0.91), image_hpr=(0,
                                                                                                                                                                                                                                                                                            0,
                                                                                                                                                                                                                                                                                            -90), image_scale=(0.033,
                                                                                                                                                                                                                                                                                                               0.033,
...
class GolfingRecordsUI(DirectFrame):
    ...
    def load(self):
        ...
        for courseId in GolfGlobals.CourseInfo:
            ...
            courseNameDisplay = DirectLabel(parent=frame, relief=None, pos=(-0.475, 0, 0.05), text=courseName, text_align=TextNode.ALeft, text_scale=0.075, text_fg=(0.85,
                                                                                                                                                                     0.64,
                                                                                                                                                                     0.13,
                                                                                                                                                                     1.0), text_shadow=(0,
                                                                                                                                                                                        0,
        ...
        for holeId in GolfGlobals.HoleInfo:
            ...
            frame = DirectFrame(parent=self.scrollList, relief=None)
            holeNameDisplay = DirectLabel(parent=frame, relief=None, pos=(-0.475, 0, 0.05), text=holeName, text_align=TextNode.ALeft, text_scale=0.075, text_fg=(0.95,
                                                                                                                                                                 0.95,
                                                                                                                                                                 0.0,
                                                                                                                                                                 1.0), text_shadow=(0,
                                                                                                                                                                                    0,
