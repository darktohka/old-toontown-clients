...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\shtiker\TrackPage.py
...
MAX_FRAMES = 18
Track2Anim = {ToontownBattleGlobals.HEAL_TRACK: 'juggle', ToontownBattleGlobals.TRAP_TRACK: 'toss', ToontownBattleGlobals.LURE_TRACK: 'hypnotize', ToontownBattleGlobals.SOUND_TRACK: 'sound', ToontownBattleGlobals.THROW_TRACK: 'throw', ToontownBattleGlobals.SQUIRT_TRACK: 'firehose', ToontownBattleGlobals.DROP_TRACK: 'pushbutton'}
...
class TrackFrame(DirectFrame):
    ...
    def __init__(self, index):
        ...
        self.index = index
        self.frame = DirectFrame(parent=self, relief=None, image=filmstrip, image_scale=1, text=str(self.index - 1), text_pos=(0.26, -0.22), text_fg=(1,
                                                                                                                                                      1,
                                                                                                                                                      1,
                                                                                                                                                      1), text_scale=0.1)
