...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\shtiker\PurchaseManager.py
    ...
    def announceGenerate(self):
        ...
        if self.hasLocalToon:
            ...
            base.cr.playGame.hood.fsm.request('purchase', [
             self.mpArray, self.moneyArray, self.playerIds, self.playerStates, remain, self.metagameRound, self.votesArray])
