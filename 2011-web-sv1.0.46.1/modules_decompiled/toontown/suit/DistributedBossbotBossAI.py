...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\DistributedBossbotBossAI.py
import random, math
...
class DistributedBossbotBossAI(DistributedBossCogAI.DistributedBossCogAI, FSM.FSM):
    ...
    def doNextAttack(self, task):
        ...
        if self.movingToTable:
            ...
            attackCode = random.choice([ToontownGlobals.BossCogGolfAreaAttack, ToontownGlobals.BossCogDirectedAttack, ToontownGlobals.BossCogDirectedAttack, ToontownGlobals.BossCogDirectedAttack, ToontownGlobals.BossCogDirectedAttack])
