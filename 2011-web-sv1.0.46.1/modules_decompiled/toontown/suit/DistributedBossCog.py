...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\DistributedBossCog.py
...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def zapLocalToon(self, attackCode, origin=None):
        ...
        self.sendUpdate('zapToon', [pos[0], pos[1], pos[2], hpr[0] % 360.0, hpr[1], hpr[2], bp2d[0], bp2d[1], attackCode, timestamp])
