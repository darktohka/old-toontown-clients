...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\Goon.py
...
AnimDict = {'pg': (('walk', '-walk'), ('collapse', '-collapse'), ('recovery', '-recovery')), 'sg': (('walk', '-walk'), ('collapse', '-collapse'), ('recovery', '-recovery'))}
