...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\DistributedLawbotBoss.py
...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def makeIntroductionMovie(self, delayDeletes):
        ...
        dialogTrack = Track((0, Func(self.setChatAbsolute, TTLocalizer.LawbotBossTempIntro0, CFSpeech)), (
    ...
    def makeVictoryMovie(self):
        ...
        bossTrack = Track((0.5,
         Sequence(Func(self.clearChat), Func(camera.reparentTo, render), Func(camera.setPos, -3, 45, 25), Func(camera.setHpr, 0, 10, 0))), (
    ...
    def makeDefeatMovie(self):
        bossTrack = Track((0.0,
         Sequence(Func(self.clearChat), Func(self.reverseHead), ActorInterval(self, 'Ff_speech'))), (
