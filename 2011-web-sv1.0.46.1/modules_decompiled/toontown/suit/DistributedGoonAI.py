...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\DistributedGoonAI.py
        ...
        if self.grid:
            if hasattr(self, 'entId'):
                ...
                if not self.crushed:
                    ...
                    self.grid.addObjectByPos(self.entId, pt) or self.notify.warning("updateGrid: couldn't put goon in grid")
