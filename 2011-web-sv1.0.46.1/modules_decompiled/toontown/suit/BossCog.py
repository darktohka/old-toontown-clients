...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\suit\BossCog.py
...
ModelDict = {'s': 'phase_9/models/char/sellbotBoss', 'm': 'phase_10/models/char/cashbotBoss', 'l': 'phase_11/models/char/lawbotBoss', 'c': 'phase_12/models/char/bossbotBoss'}
    ...
    def getAnim(self, anim):
        ...
        if anim == None:
            ...
            ival = Sequence(Track((0, ival), (
             ...
             0.9,
             Parallel(SoundInterval(self.rainGearsSfx, node=self), ParticleInterval(pe, self.frontAttack, worldRelative=0, duration=1.5, cleanup=True), duration=0)), (
