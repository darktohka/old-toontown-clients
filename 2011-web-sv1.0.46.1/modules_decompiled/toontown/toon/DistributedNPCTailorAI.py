...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toon\DistributedNPCTailorAI.py
...
class DistributedNPCTailorAI(DistributedNPCToonBaseAI):
    ...
    def setDNA(self, blob, finished, which):
        ...
        if self.air.doId2do.has_key(avId):
            av = self.air.doId2do[avId]
            if finished == 2:
                if which > 0 and (self.air.questManager.removeClothingTicket(av, self) == 1 or self.freeClothes):
