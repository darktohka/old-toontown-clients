...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toon\DistributedNPCPartyPerson.py
    ...
    def setMovie(self, mode, npcId, avId, extraArgs, timestamp):
        ...
        if mode == NPCToons.PARTY_MOVIE_TIMEOUT:
            ...
            if self.isInteractingWithLocalToon:
                ...
                requestStatus = {'loader': loaderId, 'where': whereId, 'how': 'teleportIn', 'hoodId': hoodId, 'zoneId': zoneId, 'shardId': None, 'avId': avId}
