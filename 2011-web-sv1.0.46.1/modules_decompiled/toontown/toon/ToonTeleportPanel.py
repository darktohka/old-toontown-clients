...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toon\ToonTeleportPanel.py
...
class ToonTeleportPanel(DirectFrame):
    ...
    def __init__(self, avId, avName, avDisableName):
        DirectFrame.__init__(self, pos=(0.3, 0.1, 0.65), image_color=ToontownGlobals.GlobalDialogColor, image_scale=(1.0,
                                                                                                                     1.0,
    ...
    def enterOtherShard(self, shardId, hoodId, zoneId):
        ...
        if pop and pop > localAvatar.shardPage.midPop:
            ...
            self['text'] = TTLocalizer.TeleportPanelOtherShard % {'avName': self.avName, 'shardName': shardName, 'myShardName': myShardName}
        self.bYes.show()
        self.bNo.show()
