...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toon\DistributedToon.py
...
class DistributedToon(DistributedPlayer.DistributedPlayer, Toon.Toon, DistributedSmoothNode.DistributedSmoothNode, DelayDeletable):
    ...
    def whisperSCToontaskTo(self, taskId, toNpcId, toonProgress, msgIndex, sendToId):
        ...
        self.sendUpdate('setWhisperSCToontaskFrom', [
         self.doId, taskId, toNpcId, toonProgress, msgIndex], sendToId)
    ...
    def getWateringCanModel(self):
        scalePosHprsTable = (
         (0.25, 0.1, 0, 0.2, -90, -125, -45), (0.2, 0.0, 0.25, 0.2, -90, -125, -45), (0.2, 0.2, 0.1, 0.2, -90, -125, -45), (0.2, 0.0, 0.25, 0.2, -90, -125, -45))
    ...
    def sendToGolfCourse(self, zoneId):
        ...
        golfRequest = {'loader': 'safeZoneLoader', 'where': 'golfcourse', 'how': 'teleportIn', 'hoodId': hoodId, 'zoneId': zoneId, 'shardId': None, 'avId': -1}
    ...
    def setGMIcon(self, prefix=None):
        ...
        if prefix == TTLocalizer.GM_1:
            icons = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toontroop_whistle')
            ...
            self.gmIcon = icons.find('**/*whistleIcon*')
            self.gmIcon.setScale(4)
        elif prefix == TTLocalizer.GM_3:
            icons = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toonResistance_fist')
            self.gmIcon = icons.find('**/*fistIcon*')
            self.gmIcon.setScale(4)
        elif prefix == TTLocalizer.GM_4:
            icons = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toontroop_getConnected')
            self.gmIcon = icons.find('**/*whistleIcon*')
            self.gmIcon.setScale(4)
        else:
            return
    ...
    def setGMPartyIcon(self):
        prefix = GMUtils.getGMType(self.getName())
        if prefix == TTLocalizer.GM_1:
            self.gmIcon = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toonResistance_fist')
        elif prefix == TTLocalizer.GM_2:
            self.gmIcon = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toontroop_whistle')
        elif prefix == TTLocalizer.GM_3:
            self.gmIcon = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toonResistance_fist')
        elif prefix == TTLocalizer.GM_4:
            self.gmIcon = loader.loadModel('phase_3.5/models/gui/tt_m_gui_gm_toontroop_getConnected')
        else:
            return
        self.gmIcon.reparentTo(self.nametag.getNameIcon())
