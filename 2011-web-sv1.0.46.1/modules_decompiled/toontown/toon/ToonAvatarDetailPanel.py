...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\toon\ToonAvatarDetailPanel.py
...
class ToonAvatarDetailPanel(DirectFrame):
    ...
    def __init__(self, avId, avName, playerId=None, parent=aspect2dp, **kw):
        ...
        optiondefs = (('pos', (0.525, 0.0, 0.525), None), ('scale', 0.5, None), ('relief', None, None), ('image', detailPanel, None), ('image_color', GlobalDialogColor, None), ('text', '', None), ('text_wordwrap', textWrap, None), ('text_scale', textScale, None), ('text_pos', (-0.125, 0.775), None))
    ...
    def __showData(self):
        ...
        if online:
            ...
            if self.playerInfo:
                ...
                self.gotoAvatarButton = DirectButton(parent=self, relief=None, image=(guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale=1.1, text=TTLocalizer.AvatarShowPlayer, text_scale=0.07, text_pos=(0.0, -0.02), textMayChange=0, pos=(0.44,
                                                                                                                                                                                                                                                                                                              0,
                                                                                                                                                                                                                                                                                                              0.41), command=self.__showAvatar)
                text = TTLocalizer.AvatarDetailPanelOnlinePlayer % {'district': shardName, 'location': hoodName, 'player': self.playerInfo.playerName}
            else:
