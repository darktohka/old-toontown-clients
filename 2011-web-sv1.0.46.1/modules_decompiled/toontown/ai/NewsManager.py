...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\toontown\src\ai\NewsManager.py
...
decorationHolidays = [
 ToontownGlobals.WINTER_DECORATIONS, ToontownGlobals.HALLOWEEN_PROPS, ToontownGlobals.HALLOWEEN_COSTUMES, ToontownGlobals.CRASHED_LEADERBOARD]
...
class NewsManager(DistributedObject.DistributedObject):
    ...
    def startHoliday(self, holidayId):
        if holidayId not in self.holidayIdList:
            ...
            elif holidayId == ToontownGlobals.JELLYBEAN_TROLLEY_HOLIDAY:
                if hasattr(base, 'localAvatar') and base.localAvatar and hasattr(base.localAvatar, 'chatMgr') and base.localAvatar.chatMgr:
                    base.localAvatar.chatMgr.chatInputSpeedChat.addJellybeanJamMenu(TTSCJellybeanJamMenu.JellybeanJamPhases.TROLLEY)
            elif holidayId == ToontownGlobals.JELLYBEAN_FISHING_HOLIDAY:
                if hasattr(base, 'localAvatar') and base.localAvatar and hasattr(base.localAvatar, 'chatMgr') and base.localAvatar.chatMgr:
