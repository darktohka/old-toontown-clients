...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\distributed\DoCollectionManager.py
...
class DoCollectionManager:
    ...
    def isValidLocationTuple(self, location):
        return location is not None and location != (4294967295, 4294967295) and location != (0,
                                                                                              0)
