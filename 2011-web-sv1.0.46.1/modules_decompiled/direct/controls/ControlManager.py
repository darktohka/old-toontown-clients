...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\controls\ControlManager.py
...
class ControlManager:
    ...
    def setWASDTurn(self, turn):
        ...
        if turn:
            self.WASDTurnTokens = (
             inputState.watchWithModifiers('turnLeft', 'a', inputSource=inputState.WASD), inputState.watchWithModifiers('turnRight', 'd', inputSource=inputState.WASD))
            ...
            self.WASDTurnTokens = (
             inputState.watchWithModifiers('slideLeft', 'a', inputSource=inputState.WASD), inputState.watchWithModifiers('slideRight', 'd', inputSource=inputState.WASD))
