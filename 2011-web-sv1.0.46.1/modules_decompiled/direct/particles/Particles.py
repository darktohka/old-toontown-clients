...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\particles\Particles.py
...
import SpriteParticleRendererExt, string, os
...
class Particles(ParticleSystem):
    ...
    def printParams(self, file=sys.stdout, targ='self'):
        ...
        if self.rendererType == 'PointParticleRenderer':
            ...
            cboLut = ('OZero', 'OOne', 'OIncomingColor', 'OOneMinusIncomingColor',
                      'OFbufferColor', 'OOneMinusFbufferColor', 'OIncomingAlpha',
                      'OOneMinusIncomingAlpha', 'OFbufferAlpha', 'OOneMinusFbufferAlpha',
                      'OConstantColor', 'OOneMinusConstantColor', 'OConstantAlpha',
                      'OOneMinusConstantAlpha', 'OIncomingColorSaturate')
    ...
    def getPoolSizeRanges(self):
        ...
        lifespanRange = [
         self.factory.getLifespanBase() - self.factory.getLifespanSpread(), self.factory.getLifespanBase(), self.factory.getLifespanBase() + self.factory.getLifespanSpread()]
        birthRateRange = [
         self.getBirthRate()] * 3
