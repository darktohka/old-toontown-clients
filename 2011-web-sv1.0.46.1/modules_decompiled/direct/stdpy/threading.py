...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\stdpy\threading.py
import direct
from pandac import PandaModules as pm
from direct.stdpy import thread as _thread
import sys as _sys, weakref
__all__ = [
 'Thread', 'Lock', 'RLock', 'Condition', 'Semaphore', 'BoundedSemaphore', 'Event', 'Timer', 'local', 'current_thread', 'currentThread', 'enumerate', 'active_count', 'activeCount', 'settrace', 'setprofile', 'stack_size']
