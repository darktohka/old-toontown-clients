...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\gui\DirectRadioButton.py
__all__ = [
 'DirectRadioButton']
...
class DirectRadioButton(DirectButton):
    ...
    def __init__(self, parent=None, **kw):
        self.colors = None
        optiondefs = (('indicatorValue', 0, self.setIndicatorValue), ('variable', [], None), ('value', [], None), ('others', [], None), ('boxBorder', 0, None), ('boxPlacement', 'left', None), ('boxGeom', None, None), ('boxGeomColor', None, None), ('boxGeomScale', 1.0, None), ('boxImage', loader.loadModel('models/gui/radio_button_gui'), None), ('boxImageScale', 1.0, None), ('boxImageColor', VBase4(1, 1, 1, 1), None), ('boxRelief', None, None))
