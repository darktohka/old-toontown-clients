...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\gui\DirectScrolledList.py
__all__ = [
...
class DirectScrolledListItem(DirectButton):
    ...
    def __init__(self, parent=None, **kw):
        ...
        optiondefs = (
         (
          'parent', self.parent, None), ('command', self.select, None))
