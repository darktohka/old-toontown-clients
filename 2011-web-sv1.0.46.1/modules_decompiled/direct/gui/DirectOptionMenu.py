...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\gui\DirectOptionMenu.py
__all__ = [
 'DirectOptionMenu']
import types
...
class DirectOptionMenu(DirectButton):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'items', [], self.setItems), ('initialitem', None, DGG.INITOPT), ('popupMarkerBorder', (0.1, 0.1), None), ('highlightColor', (0.5, 0.5, 0.5, 1), None), ('highlightScale', (1, 1), None), ('text_align', TextNode.ALeft, None), ('pressEffect', 0, DGG.INITOPT))
        ...
        self.cancelFrame = self.createcomponent('cancelframe', (), None, DirectFrame, (self,), frameSize=(-1,
                                                                                                          1,
                                                                                                          -1,
                                                                                                          1), relief=None, state='normal')
