...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\gui\DirectScrollBar.py
__all__ = [
 'DirectScrollBar']
...
class DirectScrollBar(DirectFrame):
    ...
    def __init__(self, parent=None, **kw):
        ...
        if self.decButton['frameSize'] == None and self.decButton.bounds == [0.0, 0.0, 0.0, 0.0]:
            f = self['frameSize']
        ...
        if self.incButton['frameSize'] == None and self.incButton.bounds == [0.0, 0.0, 0.0, 0.0]:
            f = self['frameSize']
            if self['orientation'] == DGG.HORIZONTAL:
