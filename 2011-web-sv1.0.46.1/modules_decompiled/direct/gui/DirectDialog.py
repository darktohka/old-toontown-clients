...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\gui\DirectDialog.py
__all__ = [
...
class DirectDialog(DirectFrame):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'dialogName', 'DirectDialog_' + repr(DirectDialog.PanelIndex), DGG.INITOPT), ('pos', (0, 0.1, 0), None), ('pad', (0.1, 0.1), None), ('text', '', None), ('text_align', TextNode.ALeft, None), ('text_scale', 0.06, None), ('image', DGG.getDefaultDialogGeom(), None), ('relief', None, None), ('buttonTextList', [], DGG.INITOPT), ('buttonGeomList', [], DGG.INITOPT), ('buttonImageList', [], DGG.INITOPT), ('buttonValueList', [], DGG.INITOPT), ('buttonHotKeyList', [], DGG.INITOPT), ('button_borderWidth', (0.01, 0.01), None), ('button_pad', (0.01, 0.01), None), ('button_relief', DGG.RAISED, None), ('button_text_scale', 0.06, None), ('buttonSize', None, DGG.INITOPT), ('topPad', 0.06, DGG.INITOPT), ('midPad', 0.12, DGG.INITOPT), ('sidePad', 0.0, DGG.INITOPT), ('buttonPadSF', 1.1, DGG.INITOPT), ('fadeScreen', 0, None), ('command', None, None), ('extraArgs', [], None), ('sortOrder', NO_FADE_SORT_INDEX, None))
...
class OkDialog(DirectDialog):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'buttonTextList', ['OK'], DGG.INITOPT), ('buttonValueList', [DGG.DIALOG_OK], DGG.INITOPT))
...
class OkCancelDialog(DirectDialog):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'buttonTextList', ['OK', 'Cancel'], DGG.INITOPT), ('buttonValueList', [DGG.DIALOG_OK, DGG.DIALOG_CANCEL], DGG.INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectDialog.__init__(self, parent)
...
class YesNoDialog(DirectDialog):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'buttonTextList', ['Yes', 'No'], DGG.INITOPT), ('buttonValueList', [DGG.DIALOG_YES, DGG.DIALOG_NO], DGG.INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectDialog.__init__(self, parent)
...
class YesNoCancelDialog(DirectDialog):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'buttonTextList', ['Yes', 'No', 'Cancel'], DGG.INITOPT), ('buttonValueList', [DGG.DIALOG_YES, DGG.DIALOG_NO, DGG.DIALOG_CANCEL], DGG.INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectDialog.__init__(self, parent)
...
class RetryCancelDialog(DirectDialog):
    ...
    def __init__(self, parent=None, **kw):
        optiondefs = (
         (
          'buttonTextList', ['Retry', 'Cancel'], DGG.INITOPT), ('buttonValueList', [DGG.DIALOG_RETRY, DGG.DIALOG_CANCEL], DGG.INITOPT))
        self.defineoptions(kw, optiondefs)
        DirectDialog.__init__(self, parent)
