...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\showbase\Transitions.py
__all__ = [
 'Transitions']
...
class Transitions:
    ...
    def loadFade(self):
        ...
        if self.fade == None:
            self.fade = DirectFrame(parent=hidden, guiId='fade', relief=None, image=self.fadeModel, image_scale=(4,
                                                                                                                 2,
                                                                                                                 2), state=DGG.NORMAL)
    ...
    def loadLetterbox(self):
        if not self.letterbox:
            ...
            self.letterboxTop = DirectFrame(parent=self.letterbox, guiId='letterboxTop', relief=DGG.FLAT, state=DGG.NORMAL, frameColor=(0,
                                                                                                                                        0,
                                                                                                                                        0,
                                                                                                                                        1), borderWidth=(0,
                                                                                                                                                         0), frameSize=(-1,
                                                                                                                                                                        ...
                                                                                                                                                                        0.2), pos=(0,
                                                                                                                                                                                   0,
                                                                                                                                                                                   0.8), image=barImage, image_scale=(2.25,
                                                                                                                                                                                                                      1,
                                                                                                                                                                                                                      0.5), image_pos=(0,
                                                                                                                                                                                                                                       0,
                                                                                                                                                                                                                                       0.1), image_color=(0.3,
                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                          0.3,
                                                                                                                                                                                                                                                          1), sortOrder=0)
            self.letterboxBottom = DirectFrame(parent=self.letterbox, guiId='letterboxBottom', relief=DGG.FLAT, state=DGG.NORMAL, frameColor=(0,
                                                                                                                                              0,
                                                                                                                                              0,
                                                                                                                                              1), borderWidth=(0,
                                                                                                                                                               0), frameSize=(-1,
                                                                                                                                                                              ...
                                                                                                                                                                              0.2), pos=(0,
                                                                                                                                                                                         0,
                                                                                                                                                                                         -1), image=barImage, image_scale=(2.25,
                                                                                                                                                                                                                           1,
                                                                                                                                                                                                                           0.5), image_pos=(0,
                                                                                                                                                                                                                                            0,
                                                                                                                                                                                                                                            0.1), image_color=(0.3,
