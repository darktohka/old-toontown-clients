...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\showbase\ShowBase.py
__all__ = [
 'ShowBase', 'WindowControls']
...
import EventManager, math, sys, os, Loader, time, gc
from direct.fsm import ClassicFSM
from direct.fsm import State
from direct.showbase import ExceptionVarDump
import DirectObject, SfxPlayer, OnScreenDebug, AppRunnerGlobal
...
class ShowBase(DirectObject.DirectObject):
    ...
    def __init__(self, fStartDirect=True, windowType=None):
        ...
        logStackDump = config.GetBool('log-stack-dump', 0) or config.GetBool('client-log-stack-dump', 0)
    ...
    def getAspectRatio(self, win=None):
        ...
        if win == None:
            win = self.win
        if win != None:
            if win.hasSize() and (win.getYSize() == 0 or win.getXSize() == 0):
                return 1
    ...
    def setupMouseCB(self, win):
        ...
        return (
         buttonThrowers, pointerWatcherNodes)
    ...
    def createBaseAudioManagers(self):
        ...
        self.musicManagerIsValid = self.musicManager != None and self.musicManager.isValid()
    ...
    def windowEvent(self, win):
        if win == self.win:
            ...
            if not properties.getOpen():
                ...
                if __dev__:
                    if config.GetBool('auto-garbage-logging', 0):
                ...
                aspectRatio = self.__configAspectRatio or self.getAspectRatio()
