...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\showbase\ElementTree.py
__all__ = [
 'Comment', 'dump', 'Element', 'ElementTree', 'fromstring', 'iselement', 'iterparse', 'parse', 'PI', 'ProcessingInstruction', 'QName', 'SubElement', 'tostring', 'TreeBuilder', 'VERSION', 'XML', 'XMLTreeBuilder']
...
_escape_map = {'&': '&amp;', '<': '&lt;', '>': '&gt;', '"': '&quot;'}
_namespace_map = {'http://www.w3.org/XML/1998/namespace': 'xml', 'http://www.w3.org/1999/xhtml': 'html', 'http://www.w3.org/1999/02/22-rdf-syntax-ns#': 'rdf', 'http://schemas.xmlsoap.org/wsdl/': 'wsdl'}
