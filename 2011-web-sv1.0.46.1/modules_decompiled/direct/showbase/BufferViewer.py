...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\showbase\BufferViewer.py
__all__ = [
 'BufferViewer']
...
class BufferViewer(DirectObject):
    ...
    def setPosition(self, pos):
        valid = [
         'llcorner', 'lrcorner', 'ulcorner', 'urcorner', 'window']
