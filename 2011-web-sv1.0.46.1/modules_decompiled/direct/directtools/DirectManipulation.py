...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\directtools\DirectManipulation.py
...
class DirectManipulationControl(DirectObject):
    ...
    def manipulationStart(self, modifiers):
        ...
        if base.direct.cameraControl.useMayaCamControls:
            ...
            if self.fScaling1D == 0 and self.fScaling3D == 0:
                ...
                entry = None
            if base.direct.gotAlt(modifiers) or entry:
    ...
    def manipulateObjectTask(self, state):
        if self.fScaling1D:
            ...
            if 0:
                if (self.fScaling1D or self.fScaling3D) and not base.direct.fAlt:
                    if hasattr(base.direct, 'widget'):
                ...
                if base.direct.fControl and not self.currEditTypes & EDIT_TYPE_UNSCALABLE:
                    ...
                    self.rotate2D(state)
                elif self.currEditTypes & EDIT_TYPE_UNMOVABLE or base.direct.fShift or base.direct.fControl:
