...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\direct\src\directtools\DirectSession.py
...
class DirectSession(DirectObject):
    ...
    def __init__(self):
        ...
        self.modifierEvents = [
         'control', 'control-up', 'control-repeat', 'shift', 'shift-up', 'shift-repeat', 'alt', 'alt-up', 'alt-repeat']
