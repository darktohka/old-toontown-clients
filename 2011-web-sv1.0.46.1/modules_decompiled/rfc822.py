...
# Embedded file name: C:\cygwin\home\toonpub\player\wintools\sdk\python\Python-2.4.1\Lib\rfc822.py
import time
__all__ = [
        ...
        if self.pos >= len(self.field):
            ...
            if self.field[self.pos] == '<':
                ...
                if self.commentlist:
                    returnlist = [
                     (
                      (' ').join(plist) + ' (' + (' ').join(self.commentlist) + ')', routeaddr)]
                else:
                    returnlist = [
                     (
...
def formatdate(timeval=None):
    ...
    return '%s, %02d %s %04d %02d:%02d:%02d GMT' % (['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][timeval[6]], timeval[2], ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'][(timeval[1] - 1)], timeval[0], timeval[3], timeval[4], timeval[5])
