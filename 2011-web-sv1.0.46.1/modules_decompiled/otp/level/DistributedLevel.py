...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\otp\src\level\DistributedLevel.py
...
class DistributedLevel(DistributedObject.DistributedObject, Level.Level):
    ...
    def __init__(self, cr):
        ...
        self.titleText = OnscreenText.OnscreenText('', fg=self.titleColor, shadow=(0,
                                                                                   0,
                                                                                   0,
                                                                                   1), font=ToontownGlobals.getSuitFont(), pos=(0, -0.5), scale=0.16, drawOrder=0, mayChange=1)
