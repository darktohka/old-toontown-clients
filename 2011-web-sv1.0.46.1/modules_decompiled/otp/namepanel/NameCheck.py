...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\otp\src\namepanel\NameCheck.py
import string
...
def checkName(name, otherCheckFuncs=[], font=None):
    ...
    checks = [
     printableChars, badCharacters, fontHasCharacters, longEnough, emptyName, hasLetters, hasVowels, monoLetter, checkDashes, checkCommas, checkPeriods, checkApostrophes, tooManyWords, allCaps, mixedCase, repeatedChars] + otherCheckFuncs
    symmetricChecks = []
