...
# Embedded file name: C:\Cygwin\home\toonpub\player_1_0_46_qa\otp\src\friends\GuildManager.py
    ...
    def recvAvatarOnline(self, avatarId, avatarName, bandManagerId, bandId):
        ...
        if hasattr(base, 'localAvatar'):
            if avatarId != base.localAvatar.doId:
                self.cr.avatarFriendsManager.checkIgnored(avatarId) or base.talkAssistant.receiveGuildUpdate(avatarId, avatarName, True)
        else:
            return
