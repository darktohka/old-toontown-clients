...
class Multifile(FFIExternalObject.FFIExternalObject):
    ...
    def updateSubfile(self, subfileName, filename, compressionLevel):
        returnValue = libpandaexpress._inPJoxt03H7(self.this, subfileName, filename.this, compressionLevel)
        return returnValue
    ...
    def compareSubfile(self, index, filename):
        returnValue = libpandaexpress._inPJoxt0DCF(self.this, index, filename.this)
        return returnValue
