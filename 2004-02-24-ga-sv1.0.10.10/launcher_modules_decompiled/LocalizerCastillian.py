...
QuestsDeliverGagQuestInstructions = 'T\xc3\xba puedes comprar esta broma en la Tienda de Bromas una vez que tengas acceso a la broma.'
...
ShardPageHelpWhere = 'Ahora t\xc3\xba est\xc3\xa1s en el distrito "%s".'
ShardPageHelpWelcomeValley = 'Ahora t\xc3\xba est\xc3\xa1s en el distrito "Valle Bienvenido", dentro de "%s".'
...
SpeedChatStaticText = {
    ...
    106: '\xc2\xa1Bienvenido a Toontown!',
...
zone2TitleDict = {
    ...
    4728: ('Ablandamiento de O\xc3\xaddos Duros', 'el'),
