...
class Event(TypedReferenceCount.TypedReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def getClassType():
        returnValue = libpanda._inPekxoUXdZ()
        import TypeHandle
    ...
    def assign(self, copy):
        returnValue = libpanda._inPekxoyjne(self.this, copy.this)
    ...
    def setName(self, name):
        returnValue = libpanda._inPekxo0_7n(self.this, name)
        return returnValue

    
    def clearName(self):
        returnValue = libpanda._inPekxosUk3(self.this)
        return returnValue

    
    def hasName(self):
        returnValue = libpanda._inPekxo8bdj(self.this)
        return returnValue

    
    def getName(self):
        returnValue = libpanda._inPekxoCka7(self.this)
        return returnValue

    
    def addParameter(self, obj):
        returnValue = libpanda._inPekxo7aTn(self.this, obj.this)
        return returnValue

    
    def getNumParameters(self):
        returnValue = libpanda._inPekxouadO(self.this)
        return returnValue

    
    def getParameter(self, n):
        returnValue = libpanda._inPekxoDpxs(self.this, n)
    ...
    def hasReceiver(self):
        returnValue = libpanda._inPekxouqic(self.this)
        return returnValue

    
    def getReceiver(self):
        returnValue = libpanda._inPekxov9f0(self.this)
    ...
    def setReceiver(self, receiver):
        returnValue = libpanda._inPekxoe1ch(self.this, receiver.this)
        return returnValue

    
    def clearReceiver(self):
        returnValue = libpanda._inPekxoVAhd(self.this)
        return returnValue

    
    def output(self, out):
        returnValue = libpanda._inPekxoYPzc(self.this, out.this)
        return returnValue
