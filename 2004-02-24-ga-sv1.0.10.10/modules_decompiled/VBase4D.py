...
class VBase4D(FFIExternalObject.FFIExternalObject):
    ...
    def addToCell(self, i, value):
        returnValue = libpanda._inPUZN3fMae(self.this, i, value)
        return returnValue

    
    def addX(self, value):
        returnValue = libpanda._inPUZN3ARia(self.this, value)
        return returnValue

    
    def addY(self, value):
        returnValue = libpanda._inPUZN3A1af(self.this, value)
        return returnValue

    
    def addZ(self, value):
        returnValue = libpanda._inPUZN3DZTk(self.this, value)
        return returnValue

    
    def addW(self, value):
        returnValue = libpanda._inPUZN3ANqV(self.this, value)
        return returnValue
