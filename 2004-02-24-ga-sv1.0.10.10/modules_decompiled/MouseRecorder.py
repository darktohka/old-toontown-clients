...
class MouseRecorder(DataNode.DataNode, RecorderBase.RecorderBase, FFIExternalObject.FFIExternalObject):
    ...
    def constructor(self, name):
        self.this = libpanda._inPc5FLqf6S(name)
    ...
    def destructor(self):
        if libpanda and libpanda._inPc5FLiKj1:
            libpanda._inPc5FLiKj1(self.this)
        

    
    def getClassType():
        returnValue = libpanda._inPc5FLGvdt()
        import TypeHandle
    ...
    def upcastToRecorderBase(self):
        returnValue = libpanda._inPc5FLKZwc(self.this)
        import RecorderBase
    ...
    def _MouseRecorder__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(self, childNode, sort):
        upcastSelf = self
        returnValue = libpanda._inPkJyoA9tQ(upcastSelf.this, childNode.this, sort)
        return returnValue

    
    def _MouseRecorder__overloaded_addChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        returnValue = libpanda._inPkJyo37ri(upcastSelf.this, childNode.this)
        return returnValue

    
    def _MouseRecorder__overloaded_removeChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        returnValue = libpanda._inPkJyozFZb(upcastSelf.this, childNode.this)
        return returnValue

    
    def _MouseRecorder__overloaded_removeChild_ptrPandaNode_int(self, n):
        upcastSelf = self
    ...
    def _MouseRecorder__overloaded_stashChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        returnValue = libpanda._inPkJyokC1w(upcastSelf.this, childNode.this)
        return returnValue

    
    def _MouseRecorder__overloaded_stashChild_ptrPandaNode_int(self, childIndex):
        upcastSelf = self
        returnValue = libpanda._inPkJyoqWqz(upcastSelf.this, childIndex)
        return returnValue

    
    def _MouseRecorder__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
        returnValue = libpanda._inPkJyoqJGM(upcastSelf.this, childNode.this)
        return returnValue

    
    def _MouseRecorder__overloaded_unstashChild_ptrPandaNode_int(self, stashedIndex):
        upcastSelf = self
    ...
    def _MouseRecorder__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(self, childNode, sort):
        upcastSelf = self
        returnValue = libpanda._inPkJyoQQ0n(upcastSelf.this, childNode.this, sort)
        return returnValue

    
    def _MouseRecorder__overloaded_addStashed_ptrPandaNode_ptrPandaNode(self, childNode):
        upcastSelf = self
    ...
    def _MouseRecorder__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(self, attrib, override):
        upcastSelf = self
        returnValue = libpanda._inPkJyo48Bd(upcastSelf.this, attrib.this, override)
        return returnValue

    
    def _MouseRecorder__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(self, attrib):
        upcastSelf = self
    ...
    def _MouseRecorder__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(self, out, separator):
        upcastSelf = self
        returnValue = libpanda._inPkJyo2itg(upcastSelf.this, out.this, separator)
        return returnValue

    
    def _MouseRecorder__overloaded_listTags_ptrConstPandaNode_ptrOstream(self, out):
        upcastSelf = self
    ...
    def _MouseRecorder__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(self, type):
        upcastSelf = self
        returnValue = libpanda._inPkJyond5g(upcastSelf.this, type)
        return returnValue

    
    def _MouseRecorder__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(self, volume):
        upcastSelf = self
    ...
    def setBound(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], types.IntType):
                return self._MouseRecorder__overloaded_setBound_ptrPandaNode___enum__BoundingVolumeType(_args[0])
            elif isinstance(_args[0], BoundingVolume.BoundingVolume):
                return self._MouseRecorder__overloaded_setBound_ptrPandaNode_ptrConstBoundingVolume(_args[0])
            else:
    ...
    def addChild(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._MouseRecorder__overloaded_addChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
            ...
            if isinstance(_args[0], PandaNode.PandaNode):
                if isinstance(_args[1], types.IntType):
                    return self._MouseRecorder__overloaded_addChild_ptrPandaNode_ptrPandaNode_int(_args[0], _args[1])
                else:
    ...
    def unstashChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._MouseRecorder__overloaded_unstashChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._MouseRecorder__overloaded_unstashChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
    ...
    def listTags(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._MouseRecorder__overloaded_listTags_ptrConstPandaNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.StringType):
                    return self._MouseRecorder__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(_args[0], _args[1])
                else:
    ...
    def setAttrib(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                return self._MouseRecorder__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib(_args[0])
            else:
            ...
            if isinstance(_args[0], RenderAttrib.RenderAttrib):
                if isinstance(_args[1], types.IntType):
                    return self._MouseRecorder__overloaded_setAttrib_ptrPandaNode_ptrConstRenderAttrib_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <RenderAttrib.RenderAttrib> '
    ...
    def stashChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._MouseRecorder__overloaded_stashChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._MouseRecorder__overloaded_stashChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> <PandaNode.PandaNode> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def removeChild(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], types.IntType):
                return self._MouseRecorder__overloaded_removeChild_ptrPandaNode_int(_args[0])
            elif isinstance(_args[0], PandaNode.PandaNode):
                return self._MouseRecorder__overloaded_removeChild_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> <PandaNode.PandaNode> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    def addStashed(self, *_args):
        ...
        if numArgs == 1:
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                return self._MouseRecorder__overloaded_addStashed_ptrPandaNode_ptrPandaNode(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <PandaNode.PandaNode> '
        elif numArgs == 2:
            import PandaNode
            if isinstance(_args[0], PandaNode.PandaNode):
                if isinstance(_args[1], types.IntType):
                    return self._MouseRecorder__overloaded_addStashed_ptrPandaNode_ptrPandaNode_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <PandaNode.PandaNode> '
    ...
    def isRecording(self):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToRecorderBase()
        returnValue = libpanda._inPc5FLK8hL(upcastSelf.this)
        return returnValue
    ...
    def isPlaying(self):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToRecorderBase()
        returnValue = libpanda._inPc5FLXULh(upcastSelf.this)
        return returnValue
    ...
    def upcastToReferenceCount(self):
        upcastSelf = self
        upcastSelf = upcastSelf.upcastToRecorderBase()
        returnValue = libpanda._inPc5FLZ6Qp(upcastSelf.this)
        import ReferenceCount
        returnObject = ReferenceCount.ReferenceCount(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
