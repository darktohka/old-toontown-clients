...
def genericReadDatagram(*_args):
    ...
    if numArgs == 2:
        ...
        if isinstance(_args[0], Mat4D.Mat4D):
            import DatagramIterator
            if isinstance(_args[1], DatagramIterator.DatagramIterator):
                return __overloaded_genericReadDatagram_ptrLMatrix4d_ptrDatagramIterator(_args[0], _args[1])
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <DatagramIterator.DatagramIterator> '
        elif isinstance(_args[0], Mat4.Mat4):
            import DatagramIterator
            if isinstance(_args[1], DatagramIterator.DatagramIterator):
                return __overloaded_genericReadDatagram_ptrLMatrix4f_ptrDatagramIterator(_args[0], _args[1])
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <DatagramIterator.DatagramIterator> '
        elif isinstance(_args[0], Mat3D.Mat3D):
            import DatagramIterator
            if isinstance(_args[1], DatagramIterator.DatagramIterator):
                return __overloaded_genericReadDatagram_ptrLMatrix3d_ptrDatagramIterator(_args[0], _args[1])
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <DatagramIterator.DatagramIterator> '
        elif isinstance(_args[0], Mat3.Mat3):
            import DatagramIterator
            if isinstance(_args[1], DatagramIterator.DatagramIterator):
                return __overloaded_genericReadDatagram_ptrLMatrix3f_ptrDatagramIterator(_args[0], _args[1])
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <DatagramIterator.DatagramIterator> '
        else:
...
def invert(*_args):
    ...
    if numArgs == 1:
        ...
        if isinstance(_args[0], QuatD.QuatD):
            return __overloaded_invert_ptrConstLQuaterniond(_args[0])
        elif isinstance(_args[0], Quat.Quat):
            return __overloaded_invert_ptrConstLQuaternionf(_args[0])
        elif isinstance(_args[0], Mat4D.Mat4D):
            return __overloaded_invert_ptrConstLMatrix4d(_args[0])
        elif isinstance(_args[0], Mat4.Mat4):
            return __overloaded_invert_ptrConstLMatrix4f(_args[0])
        elif isinstance(_args[0], Mat3D.Mat3D):
            return __overloaded_invert_ptrConstLMatrix3d(_args[0])
        elif isinstance(_args[0], Mat3.Mat3):
            return __overloaded_invert_ptrConstLMatrix3f(_args[0])
        else:
...
def transpose(*_args):
    ...
    if numArgs == 1:
        ...
        import Mat3
        if isinstance(_args[0], Mat4D.Mat4D):
            return __overloaded_transpose_ptrConstLMatrix4d(_args[0])
        elif isinstance(_args[0], Mat4.Mat4):
            return __overloaded_transpose_ptrConstLMatrix4f(_args[0])
        elif isinstance(_args[0], Mat3D.Mat3D):
            return __overloaded_transpose_ptrConstLMatrix3d(_args[0])
        elif isinstance(_args[0], Mat3.Mat3):
            return __overloaded_transpose_ptrConstLMatrix3f(_args[0])
        else:
            raise TypeError, 'Invalid argument 0, expected one of: <Mat4D.Mat4D> <Mat4.Mat4> <Mat3D.Mat3D> <Mat3.Mat3> '
    else:
        raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 1 '
    ...
    if numArgs == 2:
        ...
        if isinstance(_args[0], Datagram.Datagram):
            ...
            if isinstance(_args[1], Mat4D.Mat4D):
                return __overloaded_genericWriteDatagram_ptrDatagram_ptrConstLMatrix4d(_args[0], _args[1])
            elif isinstance(_args[1], Mat4.Mat4):
                return __overloaded_genericWriteDatagram_ptrDatagram_ptrConstLMatrix4f(_args[0], _args[1])
            elif isinstance(_args[1], Mat3D.Mat3D):
                return __overloaded_genericWriteDatagram_ptrDatagram_ptrConstLMatrix3d(_args[0], _args[1])
            elif isinstance(_args[1], Mat3.Mat3):
                return __overloaded_genericWriteDatagram_ptrDatagram_ptrConstLMatrix3f(_args[0], _args[1])
            else:
        ...
        if isinstance(_args[0], Mat4D.Mat4D):
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    elif isinstance(_args[3], VBase3D.VBase3D):
                        return __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d(_args[0], _args[1], _args[2], _args[3])
                    else:
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    elif isinstance(_args[3], VBase3.VBase3):
                        return __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                    else:
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], VBase3D.VBase3D):
                        ...
                        elif isinstance(_args[4], VBase3D.VBase3D):
                            return __overloaded_decomposeMatrix_ptrConstLMatrix4d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], VBase3.VBase3):
                        ...
                        elif isinstance(_args[4], VBase3.VBase3):
                            return __overloaded_decomposeMatrix_ptrConstLMatrix4f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                        ...
                        if isinstance(_args[4], types.IntType):
                            return __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> <VBase3D.VBase3D> '
                else:
                    raise TypeError, 'Invalid argument 2, expected one of: <VBase3D.VBase3D> '
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <VBase3D.VBase3D> '
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                        ...
                        if isinstance(_args[4], types.IntType):
                            return __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
                    ...
                    if isinstance(_args[3], VBase3D.VBase3D):
                        ...
                        if isinstance(_args[4], VBase3D.VBase3D):
                            if isinstance(_args[5], types.IntType):
                                return __overloaded_decomposeMatrix_ptrConstLMatrix4d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                            else:
                                raise TypeError, 'Invalid argument 5, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <VBase3D.VBase3D> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <VBase3D.VBase3D> '
                else:
                    raise TypeError, 'Invalid argument 2, expected one of: <VBase3D.VBase3D> '
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], VBase3.VBase3):
                        ...
                        if isinstance(_args[4], VBase3.VBase3):
                            if isinstance(_args[5], types.IntType):
                                return __overloaded_decomposeMatrix_ptrConstLMatrix4f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                            else:
                                raise TypeError, 'Invalid argument 5, expected one of: <types.IntType> '
                        else:
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], types.IntType):
                        ...
                        return __overloaded_composeMatrix_ptrLMatrix3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d(_args[0], _args[1], _args[2], _args[3])
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <types.IntType> <VBase3D.VBase3D> '
                else:
                    raise TypeError, 'Invalid argument 2, expected one of: <VBase3D.VBase3D> '
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], types.IntType):
                        ...
                        return __overloaded_composeMatrix_ptrLMatrix3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <types.IntType> <VBase3.VBase3> '
                else:
                    raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
        ...
        if isinstance(_args[0], Mat4D.Mat4D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], VBase3D.VBase3D):
                        ...
                        if isinstance(_args[4], types.IntType):
                            ...
                            return __overloaded_composeMatrix_ptrLMatrix4d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> <VBase3D.VBase3D> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <VBase3D.VBase3D> '
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], VBase3.VBase3):
                        ...
                        if isinstance(_args[4], types.IntType):
                            ...
                            return __overloaded_composeMatrix_ptrLMatrix4f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> <VBase3.VBase3> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <VBase3.VBase3> '
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], VBase3D.VBase3D):
                        if isinstance(_args[4], types.IntType):
                            return __overloaded_composeMatrix_ptrLMatrix3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <VBase3D.VBase3D> '
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], VBase3.VBase3):
                        if isinstance(_args[4], types.IntType):
                            return __overloaded_composeMatrix_ptrLMatrix3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4])
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <types.IntType> '
                    else:
                        raise TypeError, 'Invalid argument 3, expected one of: <VBase3.VBase3> '
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    ...
                    if isinstance(_args[3], VBase3D.VBase3D):
                        ...
                        if isinstance(_args[4], VBase3D.VBase3D):
                            if isinstance(_args[5], types.IntType):
                                return __overloaded_composeMatrix_ptrLMatrix4d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                            else:
                                raise TypeError, 'Invalid argument 5, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <VBase3D.VBase3D> '
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    ...
                    if isinstance(_args[3], VBase3.VBase3):
                        ...
                        if isinstance(_args[4], VBase3.VBase3):
                            if isinstance(_args[5], types.IntType):
                                return __overloaded_composeMatrix_ptrLMatrix4f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                            else:
                                raise TypeError, 'Invalid argument 5, expected one of: <types.IntType> '
                        else:
                            raise TypeError, 'Invalid argument 4, expected one of: <VBase3.VBase3> '
...
def __mul__(*_args):
    ...
    if numArgs == 2:
        ...
        if isinstance(_args[0], Vec3.Vec3):
            ...
            raise TypeError, 'Invalid argument 0, expected one of: <Vec3.Vec3> <VBase4D.VBase4D> <VBase3D.VBase3D> <Vec3D.Vec3D> <Vec2D.Vec2D> <Vec2.Vec2> <VBase4.VBase4> <VBase3.VBase3> <Point3D.Point3D> <Point3.Point3> <Point2D.Point2D> <Point2.Point2> <Mat4D.Mat4D> <Mat4.Mat4> <Mat3D.Mat3D> <Mat3.Mat3> '
    else:
        raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 2 '
...
def __overloaded_transpose_ptrConstLMatrix3d(a):
    returnValue = libpanda._inPUZN3p_eQ(a.this)
    import Mat3D
...
def __overloaded_transpose_ptrConstLMatrix3f(a):
    returnValue = libpanda._inPUZN3N4ee(a.this)
    import Mat3
...
def __overloaded_transpose_ptrConstLMatrix4d(a):
    returnValue = libpanda._inPUZN3m_ss(a.this)
    import Mat4D
...
def __overloaded_transpose_ptrConstLMatrix4f(a):
    returnValue = libpanda._inPUZN3K4s6(a.this)
    import Mat4
...
def __overloaded_invert_ptrConstLMatrix3d(a):
    returnValue = libpanda._inPUZN3_Gem(a.this)
    import Mat3D
    returnObject = Mat3D.Mat3D(None)
    returnObject.this = returnValue
    if returnObject.this == 0:
...
def __overloaded_invert_ptrConstLMatrix3f(a):
    returnValue = libpanda._inPUZN3Ogym(a.this)
    import Mat3
    returnObject = Mat3.Mat3(None)
    returnObject.this = returnValue
    if returnObject.this == 0:
...
def __overloaded_invert_ptrConstLMatrix4d(a):
    returnValue = libpanda._inPUZN3YJfW(a.this)
    import Mat4D
    returnObject = Mat4D.Mat4D(None)
    returnObject.this = returnValue
    if returnObject.this == 0:
...
def __overloaded_invert_ptrConstLMatrix4f(a):
    returnValue = libpanda._inPUZN3orzW(a.this)
    import Mat4
    returnObject = Mat4.Mat4(None)
    returnObject.this = returnValue
    if returnObject.this == 0:
...
def __overloaded_invert_ptrConstLQuaterniond(a):
    returnValue = libpanda._inPUZN3H8wm(a.this)
    import QuatD
...
def __overloaded_invert_ptrConstLQuaternionf(a):
    returnValue = libpanda._inPUZN3rBx0(a.this)
    import Quat
...
def __overloaded_composeMatrix_ptrLMatrix3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(mat, scale, shear, hpr, cs):
    returnValue = libpanda._inPUZN33KHb(mat.this, scale.this, shear.this, hpr.this, cs)
    return returnValue


def __overloaded_composeMatrix_ptrLMatrix3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d(mat, scale, shear, hpr):
    returnValue = libpanda._inPUZN3QK2_(mat.this, scale.this, shear.this, hpr.this)
    return returnValue
...
def __overloaded_composeMatrix_ptrLMatrix3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(mat, scale, shear, hpr, cs):
    returnValue = libpanda._inPUZN3s_WG(mat.this, scale.this, shear.this, hpr.this, cs)
    return returnValue


def __overloaded_composeMatrix_ptrLMatrix3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(mat, scale, shear, hpr):
    returnValue = libpanda._inPUZN3n7Er(mat.this, scale.this, shear.this, hpr.this)
    return returnValue
...
def __overloaded_composeMatrix_ptrLMatrix4d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d___enum__CoordinateSystem(mat, scale, shear, hpr, translate, cs):
    returnValue = libpanda._inPUZN3pQjw(mat.this, scale.this, shear.this, hpr.this, translate.this, cs)
    return returnValue
...
def __overloaded_composeMatrix_ptrLMatrix4d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d_ptrConstLVecBase3d(mat, scale, shear, hpr, translate):
    returnValue = libpanda._inPUZN3_vLl(mat.this, scale.this, shear.this, hpr.this, translate.this)
    return returnValue
...
def __overloaded_composeMatrix_ptrLMatrix4f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(mat, scale, shear, hpr, translate, cs):
    returnValue = libpanda._inPUZN31X_c(mat.this, scale.this, shear.this, hpr.this, translate.this, cs)
    return returnValue
...
def __overloaded_composeMatrix_ptrLMatrix4f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(mat, scale, shear, hpr, translate):
    returnValue = libpanda._inPUZN3CknR(mat.this, scale.this, shear.this, hpr.this, translate.this)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d___enum__CoordinateSystem(mat, scale, shear, hpr, cs):
    returnValue = libpanda._inPUZN3xk1_(mat.this, scale.this, shear.this, hpr.this, cs)
    return returnValue


def __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d(mat, scale, shear, hpr):
    returnValue = libpanda._inPUZN3vyts(mat.this, scale.this, shear.this, hpr.this)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f___enum__CoordinateSystem(mat, scale, shear, hpr, cs):
    returnValue = libpanda._inPUZN3Y5Pi(mat.this, scale.this, shear.this, hpr.this, cs)
    return returnValue


def __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(mat, scale, shear, hpr):
    returnValue = libpanda._inPUZN3FoHP(mat.this, scale.this, shear.this, hpr.this)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix4d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d___enum__CoordinateSystem(mat, scale, shear, hpr, translate, cs):
    returnValue = libpanda._inPUZN3Gy__(mat.this, scale.this, shear.this, hpr.this, translate.this, cs)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix4d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d_ptrLVecBase3d(mat, scale, shear, hpr, translate):
    returnValue = libpanda._inPUZN3ioSK(mat.this, scale.this, shear.this, hpr.this, translate.this)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix4f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f___enum__CoordinateSystem(mat, scale, shear, hpr, translate, cs):
    returnValue = libpanda._inPUZN3u1gv(mat.this, scale.this, shear.this, hpr.this, translate.this, cs)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix4f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f_ptrLVecBase3f(mat, scale, shear, hpr, translate):
    returnValue = libpanda._inPUZN3Klz6(mat.this, scale.this, shear.this, hpr.this, translate.this)
    return returnValue
