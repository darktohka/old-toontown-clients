...
class TextNode(PandaNode.PandaNode, TextEncoder.TextEncoder, FFIExternalObject.FFIExternalObject):
    ...
    def setTabWidth(self, tabWidth):
        returnValue = libpanda._inPmUk_YrKk(self.this, tabWidth)
        return returnValue

    
    def getTabWidth(self):
        returnValue = libpanda._inPmUk_fSAe(self.this)
        return returnValue
    ...
    def listTags(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._TextNode__overloaded_listTags_ptrConstPandaNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.StringType):
                    return self._TextNode__overloaded_listTags_ptrConstPandaNode_ptrOstream_atomicstring(_args[0], _args[1])
                else:
