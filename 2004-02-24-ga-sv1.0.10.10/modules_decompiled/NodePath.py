...
class NodePath(FFIExternalObject.FFIExternalObject):
    ...
    def isSameGraph(self, other):
        returnValue = libpanda._inPkJyoRlGb(self.this, other.this)
        return returnValue
    ...
    def getStashedChildren(self):
        returnValue = libpanda._inPkJyowedS(self.this)
        import NodePathCollection
        returnObject = NodePathCollection.NodePathCollection(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def getSort(self):
        returnValue = libpanda._inPkJyoFeVI(self.this)
        return returnValue
    ...
    def _NodePath__overloaded_setState_ptrNodePath_ptrConstNodePath_ptrConstRenderState(self, other, state):
        returnValue = libpanda._inPkJyoojNF(self.this, other.this, state.this)
        return returnValue

    
    def _NodePath__overloaded_setState_ptrNodePath_ptrConstRenderState(self, state):
        returnValue = libpanda._inPkJyoYTbI(self.this, state.this)
        return returnValue
    ...
    def _NodePath__overloaded_getPrevTransform_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyoaXOe(self.this)
        import TransformState
        returnObject = TransformState.TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_getPrevTransform_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoIeYC(self.this, other.this)
        import TransformState
        returnObject = TransformState.TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_setPrevTransform_ptrNodePath_ptrConstNodePath_ptrConstTransformState(self, other, transform):
        returnValue = libpanda._inPkJyoKELE(self.this, other.this, transform.this)
        return returnValue

    
    def _NodePath__overloaded_setPrevTransform_ptrNodePath_ptrConstTransformState(self, transform):
        returnValue = libpanda._inPkJyohmBw(self.this, transform.this)
        return returnValue

    
    def getNetPrevTransform(self):
        returnValue = libpanda._inPkJyoq_Pd(self.this)
        import TransformState
        returnObject = TransformState.TransformState(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_setFluidPos_ptrNodePath_ptrConstLVecBase3f(self, pos):
        returnValue = libpanda._inPkJyojI31(self.this, pos.this)
        return returnValue

    
    def _NodePath__overloaded_setFluidPos_ptrNodePath_float_float_float(self, x, y, z):
        returnValue = libpanda._inPkJyoAckh(self.this, x, y, z)
        return returnValue

    
    def setFluidX(self, x):
        returnValue = libpanda._inPkJyoEku5(self.this, x)
        return returnValue

    
    def setFluidY(self, y):
        returnValue = libpanda._inPkJyoUKB6(self.this, y)
        return returnValue

    
    def setFluidZ(self, z):
        returnValue = libpanda._inPkJyokrV6(self.this, z)
        return returnValue
    ...
    def _NodePath__overloaded_getPosDelta_ptrConstNodePath(self):
        returnValue = libpanda._inPkJyodM8H(self.this)
        import Vec3
    ...
    def _NodePath__overloaded_getPosDelta_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyojYBa(self.this, other.this)
        import Vec3
        returnObject = Vec3.Vec3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_setScale_ptrNodePath_ptrConstNodePath_float(self, other, scale):
        returnValue = libpanda._inPkJyo89Ct(self.this, other.this, scale)
        return returnValue
    ...
    def _NodePath__overloaded_getShear_ptrConstNodePath_ptrConstNodePath(self, other):
        returnValue = libpanda._inPkJyoQxss(self.this, other.this)
        import VBase3
        returnObject = VBase3.VBase3(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def _NodePath__overloaded_setPosHprScaleShear_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(self, pos, hpr, scale, shear):
        returnValue = libpanda._inPkJyo8p1n(self.this, pos.this, hpr.this, scale.this, shear.this)
        return returnValue
    ...
    def _NodePath__overloaded_setPosHprScaleShear_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other, pos, hpr, scale, shear):
        returnValue = libpanda._inPkJyoyreF(self.this, other.this, pos.this, hpr.this, scale.this, shear.this)
        return returnValue
    ...
    def _NodePath__overloaded_setPosQuatScaleShear_ptrNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f_ptrConstLVecBase3f(self, pos, quat, scale, shear):
        returnValue = libpanda._inPkJyoFwaK(self.this, pos.this, quat.this, scale.this, shear.this)
        return returnValue
    ...
    def _NodePath__overloaded_setPosQuatScaleShear_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f_ptrConstLVecBase3f(self, other, pos, quat, scale, shear):
        returnValue = libpanda._inPkJyoRPDh(self.this, other.this, pos.this, quat.this, scale.this, shear.this)
        return returnValue
    ...
    def _NodePath__overloaded_setColorScale_ptrNodePath_ptrConstLVecBase4f_int(self, scale, priority):
        returnValue = libpanda._inPkJyo5CtZ(self.this, scale.this, priority)
        return returnValue
    ...
    def _NodePath__overloaded_setColorScale_ptrNodePath_float_float_float_float_int(self, sx, sy, sz, sa, priority):
        returnValue = libpanda._inPkJyoP7kn(self.this, sx, sy, sz, sa, priority)
        return returnValue
    ...
    def _NodePath__overloaded_show_ptrNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyodfbj(self.this, cameraMask.this)
        return returnValue
    ...
    def _NodePath__overloaded_hide_ptrNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyocq1K(self.this, cameraMask.this)
        return returnValue

    
    def _NodePath__overloaded_isHidden_ptrConstNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyolQR5(self.this, cameraMask.this)
        return returnValue
    ...
    def _NodePath__overloaded_getHiddenAncestor_ptrConstNodePath_ptrBitMask32(self, cameraMask):
        returnValue = libpanda._inPkJyoDHru(self.this, cameraMask.this)
        returnObject = NodePath(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _NodePath__overloaded_stash_ptrNodePath_int(self, sort):
        returnValue = libpanda._inPkJyo5Ms1(self.this, sort)
        return returnValue
    ...
    def _NodePath__overloaded_unstash_ptrNodePath_int(self, sort):
        returnValue = libpanda._inPkJyocNQv(self.this, sort)
        return returnValue
    ...
    def unstashAll(self):
        returnValue = libpanda._inPkJyow2AF(self.this)
        return returnValue
    ...
    def setTag(self, key, value):
        returnValue = libpanda._inPkJyoGD_p(self.this, key, value)
        return returnValue

    
    def getTag(self, key):
        returnValue = libpanda._inPkJyo8T5q(self.this, key)
        return returnValue

    
    def hasTag(self, key):
        returnValue = libpanda._inPkJyoWQGT(self.this, key)
        return returnValue

    
    def clearTag(self, key):
        returnValue = libpanda._inPkJyoYk6_(self.this, key)
        return returnValue

    
    def getNetTag(self, key):
        returnValue = libpanda._inPkJyo5VAu(self.this, key)
        return returnValue

    
    def hasNetTag(self, key):
        returnValue = libpanda._inPkJyobVNW(self.this, key)
        return returnValue

    
    def findNetTag(self, key):
        returnValue = libpanda._inPkJyo2Jhq(self.this, key)
        returnObject = NodePath(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def setName(self, name):
        returnValue = libpanda._inPkJyoxRjw(self.this, name)
        return returnValue

    
    def getName(self):
        returnValue = libpanda._inPkJyobkeW(self.this)
        return returnValue
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        ...
                        if isinstance(_args[3], VBase3.VBase3):
                            return self._NodePath__overloaded_setPosHprScaleShear_ptrNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                        else:
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        ...
                        if isinstance(_args[3], VBase3.VBase3):
                            ...
                            if isinstance(_args[4], VBase3.VBase3):
                                return self._NodePath__overloaded_setPosHprScaleShear_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                            else:
    ...
    def setShear(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self._NodePath__overloaded_setShear_ptrNodePath_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        elif numArgs == 2:
            if isinstance(_args[0], NodePath):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return self._NodePath__overloaded_setShear_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        return self._NodePath__overloaded_setShear_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
            ...
            if isinstance(_args[0], NodePath):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            return self._NodePath__overloaded_setShear_ptrNodePath_ptrConstNodePath_float_float_float(_args[0], _args[1], _args[2], _args[3])
                        else:
                            raise TypeError, 'Invalid argument 3, expected one of: <types.FloatType> '
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
    ...
    def getShear(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getShear_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getShear_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setShyz(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_setShyz_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        elif numArgs == 2:
            if isinstance(_args[0], NodePath):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setShyz_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def setShxz(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_setShxz_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        elif numArgs == 2:
            if isinstance(_args[0], NodePath):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setShxz_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def getShxz(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getShxz_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getShxz_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setAlphaScale(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_setAlphaScale_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        elif numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setAlphaScale_ptrNodePath_float_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
    ...
    def setTransform(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], TransformState.TransformState):
                return self._NodePath__overloaded_setTransform_ptrNodePath_ptrConstTransformState(_args[0])
            else:
            ...
            if isinstance(_args[0], NodePath):
                ...
                if isinstance(_args[1], TransformState.TransformState):
                    return self._NodePath__overloaded_setTransform_ptrNodePath_ptrConstNodePath_ptrConstTransformState(_args[0], _args[1])
                else:
    ...
    def getShxy(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getShxy_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getShxy_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setScale(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], NodePath):
                import VBase3
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setScale_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
    ...
    def setPrevTransform(self, *_args):
        ...
        if numArgs == 1:
            import TransformState
            if isinstance(_args[0], TransformState.TransformState):
                return self._NodePath__overloaded_setPrevTransform_ptrNodePath_ptrConstTransformState(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <TransformState.TransformState> '
        elif numArgs == 2:
            if isinstance(_args[0], NodePath):
                import TransformState
                if isinstance(_args[1], TransformState.TransformState):
                    return self._NodePath__overloaded_setPrevTransform_ptrNodePath_ptrConstNodePath_ptrConstTransformState(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <TransformState.TransformState> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def getPrevTransform(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getPrevTransform_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getPrevTransform_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setState(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], RenderState.RenderState):
                return self._NodePath__overloaded_setState_ptrNodePath_ptrConstRenderState(_args[0])
            else:
            ...
            if isinstance(_args[0], NodePath):
                ...
                if isinstance(_args[1], RenderState.RenderState):
                    return self._NodePath__overloaded_setState_ptrNodePath_ptrConstNodePath_ptrConstRenderState(_args[0], _args[1])
                else:
    ...
    def setColorScale(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], VBase4.VBase4):
                if isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setColorScale_ptrNodePath_ptrConstLVecBase4f_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase4.VBase4> '
                    ...
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            if isinstance(_args[4], types.IntType):
                                return self._NodePath__overloaded_setColorScale_ptrNodePath_float_float_float_float_int(_args[0], _args[1], _args[2], _args[3], _args[4])
                            else:
    ...
    def getPosDelta(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getPosDelta_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getPosDelta_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
            ...
            if isinstance(_args[0], VBase3.VBase3):
                ...
                if isinstance(_args[1], Quat.Quat):
                    ...
                    if isinstance(_args[2], VBase3.VBase3):
                        import VBase3
                        if isinstance(_args[3], VBase3.VBase3):
                            return self._NodePath__overloaded_setPosQuatScaleShear_ptrNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3])
                        else:
                            raise TypeError, 'Invalid argument 3, expected one of: <VBase3.VBase3> '
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <VBase3.VBase3> '
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    ...
                    if isinstance(_args[2], Quat.Quat):
                        ...
                        if isinstance(_args[3], VBase3.VBase3):
                            import VBase3
                            if isinstance(_args[4], VBase3.VBase3):
                                return self._NodePath__overloaded_setPosQuatScaleShear_ptrNodePath_ptrConstNodePath_ptrConstLVecBase3f_ptrConstLQuaternionf_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1], _args[2], _args[3], _args[4])
                            else:
                                raise TypeError, 'Invalid argument 4, expected one of: <VBase3.VBase3> '
                        else:
                            raise TypeError, 'Invalid argument 3, expected one of: <VBase3.VBase3> '
    ...
    def unstash(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_unstash_ptrNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_unstash_ptrNodePath_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def reverseLs(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_reverseLs_ptrConstNodePath()
        elif numArgs == 1:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                return self._NodePath__overloaded_reverseLs_ptrConstNodePath_ptrOstream(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
        elif numArgs == 2:
            import Ostream
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_reverseLs_ptrConstNodePath_ptrOstream_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <Ostream.Ostream> '
    ...
    def setAllColorScale(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_setAllColorScale_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        elif numArgs == 2:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setAllColorScale_ptrNodePath_float_int(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.IntType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
    ...
    def getShyz(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_getShyz_ptrConstNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_getShyz_ptrConstNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setShxy(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_setShxy_ptrNodePath_float(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.FloatType> '
        elif numArgs == 2:
            if isinstance(_args[0], NodePath):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    return self._NodePath__overloaded_setShxy_ptrNodePath_ptrConstNodePath_float(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
    ...
    def stash(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_stash_ptrNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self._NodePath__overloaded_stash_ptrNodePath_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
    ...
    def setFluidPos(self, *_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return self._NodePath__overloaded_setFluidPos_ptrNodePath_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        elif numArgs == 3:
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        return self._NodePath__overloaded_setFluidPos_ptrNodePath_float_float_float(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
    ...
    def clearTransform(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._NodePath__overloaded_clearTransform_ptrNodePath()
        elif numArgs == 1:
            if isinstance(_args[0], NodePath):
                return self._NodePath__overloaded_clearTransform_ptrNodePath_ptrConstNodePath(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <NodePath> '
        else:
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 1 '
