...
class Light(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPkJyo9QsN:
            libpanda._inPkJyo9QsN(self.this)
        

    
    def getClassType():
        returnValue = libpanda._inPkJyopidT()
        import TypeHandle
    ...
    def getColor(self):
        returnValue = libpanda._inPkJyolF_a(self.this)
        import VBase4
    ...
    def upcastToReferenceCount(self):
        returnValue = libpanda._inPkJyopIAk(self.this)
        import ReferenceCount
