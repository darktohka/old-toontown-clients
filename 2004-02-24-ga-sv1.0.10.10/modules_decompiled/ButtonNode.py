...
class ButtonNode(DataNode.DataNode, FFIExternalObject.FFIExternalObject):
    ...
    def constructor(self, client, deviceName):
        self.this = libpanda._inPOfOPM3Xg(client.this, deviceName)
    ...
    def isValid(self):
        returnValue = libpanda._inPOfOPXoo7(self.this)
        return returnValue
    ...
    def setButtonMap(self, index, button):
        returnValue = libpanda._inPOfOPnucs(self.this, index, button.this)
        return returnValue

    
    def getButtonMap(self, index):
        returnValue = libpanda._inPOfOPT5W8(self.this, index)
        import ButtonHandle
