...
class DNAStorage(FFIExternalObject.FFIExternalObject):
    ...
    def _DNAStorage__overloaded_storeNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(self, codeString, node, codeCategory):
        returnValue = libtoontown._inPet4ykLDF(self.this, codeString, node.this, codeCategory)
        return returnValue
    ...
    def _DNAStorage__overloaded_storeHoodNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(self, codeString, node, codeCategory):
        returnValue = libtoontown._inPet4yFFup(self.this, codeString, node.this, codeCategory)
        return returnValue
    ...
    def _DNAStorage__overloaded_storePlaceNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(self, codeString, node, codeCategory):
        returnValue = libtoontown._inPet4yNIgc(self.this, codeString, node.this, codeCategory)
        return returnValue
    ...
    def storeBlockArticle(self, block, article):
        returnValue = libtoontown._inPet4ycNsd(self.this, block, article)
        return returnValue
    ...
    def resetBlockArticle(self):
        returnValue = libtoontown._inPet4y5HVk(self.this)
        return returnValue
    ...
    def getArticleFromBlockNumber(self, blockNumber):
        returnValue = libtoontown._inPet4yxhU1(self.this, blockNumber)
        return returnValue
    ...
    def getSuitPath(self, startPoint, endPoint, minLength, maxLength):
        returnValue = libtoontown._inPet4ywYaP(self.this, startPoint.this, endPoint.this, minLength, maxLength)
        import DNASuitPath
    ...
    def discoverContinuity(self):
        returnValue = libtoontown._inPet4ytx_x(self.this)
        return returnValue
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                ...
                if isinstance(_args[1], NodePath.NodePath):
                    return self._DNAStorage__overloaded_storeHoodNode_ptrDNAStorage_atomicstring_ptrNodePath(_args[0], _args[1])
                else:
            ...
            if isinstance(_args[0], types.StringType):
                ...
                if isinstance(_args[1], NodePath.NodePath):
                    if isinstance(_args[2], types.StringType):
                        return self._DNAStorage__overloaded_storeHoodNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(_args[0], _args[1], _args[2])
                    else:
    ...
    def storeNode(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                import NodePath
                if isinstance(_args[1], NodePath.NodePath):
                    return self._DNAStorage__overloaded_storeNode_ptrDNAStorage_atomicstring_ptrNodePath(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <NodePath.NodePath> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
            ...
            if isinstance(_args[0], types.StringType):
                ...
                if isinstance(_args[1], NodePath.NodePath):
                    if isinstance(_args[2], types.StringType):
                        return self._DNAStorage__overloaded_storeNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.StringType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <NodePath.NodePath> '
    ...
    def storePlaceNode(self, *_args):
        ...
        if numArgs == 2:
            if isinstance(_args[0], types.StringType):
                import NodePath
                if isinstance(_args[1], NodePath.NodePath):
                    return self._DNAStorage__overloaded_storePlaceNode_ptrDNAStorage_atomicstring_ptrNodePath(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <NodePath.NodePath> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> '
            ...
            if isinstance(_args[0], types.StringType):
                ...
                if isinstance(_args[1], NodePath.NodePath):
                    if isinstance(_args[2], types.StringType):
                        return self._DNAStorage__overloaded_storePlaceNode_ptrDNAStorage_atomicstring_ptrNodePath_atomicstring(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.StringType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <NodePath.NodePath> '
