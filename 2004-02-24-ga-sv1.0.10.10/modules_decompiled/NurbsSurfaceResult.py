...
class NurbsSurfaceResult(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPHc9WmrIg:
            libpanda._inPHc9WmrIg(self.this)
    ...
    def getEndV(self):
        returnValue = libpanda._inPHc9WIL57(self.this)
        return returnValue

    
    def evalPoint(self, u, v, point):
        returnValue = libpanda._inPHc9WuQQk(self.this, u, v, point.this)
        return returnValue
    ...
    def getNumUSegments(self):
        returnValue = libpanda._inPHc9WRs85(self.this)
        return returnValue
    ...
    def evalSegmentPoint(self, ui, vi, u, v, point):
        returnValue = libpanda._inPHc9WpiBr(self.this, ui, vi, u, v, point.this)
        return returnValue
    ...
    def evalSegmentExtendedPoint(self, ui, vi, u, v, d):
        returnValue = libpanda._inPHc9Wm0qy(self.this, ui, vi, u, v, d)
        return returnValue

    
    def getSegmentU(self, ui, u):
        returnValue = libpanda._inPHc9WAEBw(self.this, ui, u)
        return returnValue
