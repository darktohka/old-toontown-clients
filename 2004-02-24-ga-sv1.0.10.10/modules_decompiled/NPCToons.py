...
NPCToonDict = {
    ...
    1008: (1000, lnames[1008], 'r', 'm', 1, NPC_FISHERMAN),
    ...
    5305: (5804, lnames[5305], 'r', 'f', 0, NPC_REGULAR),
    5306: (5805, lnames[5306], 'r', 'm', 0, NPC_REGULAR),
    5307: (5809, lnames[5307], 'r', 'm', 0, NPC_REGULAR),
    5308: (5810, lnames[5308], 'r', 'f', 0, NPC_REGULAR),
    5309: (5811, lnames[5309], 'r', 'f', 0, NPC_REGULAR),
    5310: (5815, lnames[5310], 'r', 'm', 0, NPC_REGULAR),
    5311: (5817, lnames[5311], 'r', 'f', 0, NPC_REGULAR),
    5312: (5819, lnames[5312], 'r', 'm', 0, NPC_REGULAR),
    5313: (5821, lnames[5313], 'r', 'm', 0, NPC_REGULAR),
    5314: (5826, lnames[5314], 'r', 'f', 0, NPC_REGULAR),
    5315: (5827, lnames[5315], 'r', 'm', 0, NPC_REGULAR),
    5316: (5828, lnames[5316], 'r', 'm', 0, NPC_REGULAR),
    5317: (5830, lnames[5317], 'r', 'm', 0, NPC_REGULAR),
    5318: (5833, lnames[5318], 'r', 'm', 0, NPC_REGULAR),
    5319: (5835, lnames[5319], 'r', 'f', 0, NPC_REGULAR),
    5320: (5836, lnames[5320], 'r', 'f', 0, NPC_REGULAR),
    5321: (5837, lnames[5321], 'r', 'f', 0, NPC_REGULAR),
...
del lnames
BlockerPositions = {
    Localizer.Flippy: (Point3(207.40000000000001, 18.809999999999999, -0.47499999999999998), 90.0) }
zone2NpcDict = { }
...
def getBuildingArticle(zoneId):
    return Localizer.zone2TitleDict.get(zoneId, 'Toon Building')[1]


def getBuildingTitle(zoneId):
    return Localizer.zone2TitleDict.get(zoneId, 'Toon Building')[0]
