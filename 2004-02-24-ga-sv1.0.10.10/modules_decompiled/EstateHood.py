...
class EstateHood(Hood.Hood):
    ...
    def _EstateHood__popupKickoutMessage(self, msg):
        ...
        DirectButton(self.popupInfo, image = okButtonImage, relief = None, text = Localizer.EstatePopupOK, text_scale = 0.050000000000000003, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.0, 0.0, -0.29999999999999999), command = self._EstateHood__handleKickoutOk)
        buttons.removeNode()
    ...
    def startSky(self):
        ...
        if toonbase.cloudPlatformsEnabled:
