...
class ZSpinParticleFactory(BaseParticleFactory.BaseParticleFactory, FFIExternalObject.FFIExternalObject):
    ...
    def _ZSpinParticleFactory__overloaded_constructor(self):
        self.this = libpandaphysics._inPKBUADYSj()
    ...
    def getInitialAngle(self):
        returnValue = libpandaphysics._inPKBUAY6E9(self.this)
        return returnValue

    
    def getFinalAngle(self):
        returnValue = libpandaphysics._inPKBUAVZT9(self.this)
        return returnValue
    ...
    def getFinalAngleSpread(self):
        returnValue = libpandaphysics._inPKBUAhV0_(self.this)
        return returnValue
    ...
    def getAngularVelocity(self):
        returnValue = libpandaphysics._inPKBUAT1Y8(self.this)
        return returnValue
    ...
    def getAngularVelocityEnabled(self):
        returnValue = libpandaphysics._inPKBUA1hT8(self.this)
        return returnValue
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._ZSpinParticleFactory__overloaded_constructor()
        elif numArgs == 1:
            if isinstance(_args[0], ZSpinParticleFactory):
                return self._ZSpinParticleFactory__overloaded_constructor_ptrConstZSpinParticleFactory(_args[0])
            else:
