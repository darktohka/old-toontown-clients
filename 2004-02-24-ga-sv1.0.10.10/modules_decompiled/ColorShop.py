...
class ColorShop(PandaObject.PandaObject, StateData.StateData):
    ...
    def load(self):
        ...
        self.headLButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), image_scale = (-1, 1, 1), text = Localizer.ColorShopHead, text_scale = 0.0625, text_pos = (0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (-0.90000000000000002, 0, 0.29999999999999999), command = self._ColorShop__swapHeadColor, extraArgs = [
            -1])
        self.headRButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), text = Localizer.ColorShopHead, text_scale = 0.0625, text_pos = (-0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (0, 0, 0.29999999999999999), command = self._ColorShop__swapHeadColor, extraArgs = [
            1])
        self.armLButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), image_scale = (-1, 1, 1), text = Localizer.ColorShopBody, text_scale = 0.0625, text_pos = (0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (-0.90000000000000002, 0, -0.10000000000000001), command = self._ColorShop__swapArmColor, extraArgs = [
            -1])
        self.armRButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), text = Localizer.ColorShopBody, text_scale = 0.0625, text_pos = (-0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (0, 0, -0.10000000000000001), command = self._ColorShop__swapArmColor, extraArgs = [
            1])
        self.allLButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), image_scale = (-1, 1, 1), text = Localizer.ColorShopToon, text_scale = 0.0625, text_pos = (0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (-0.90000000000000002, 0, -0.10000000000000001), command = self._ColorShop__swapAllColor, extraArgs = [
            -1])
        self.allRButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), text = Localizer.ColorShopToon, text_scale = 0.0625, text_pos = (-0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (0, 0, -0.10000000000000001), command = self._ColorShop__swapAllColor, extraArgs = [
            1])
        self.legLButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), image_scale = (-1, 1, 1), text = Localizer.ColorShopLegs, text_scale = 0.0625, text_pos = (0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (-0.90000000000000002, 0, -0.5), command = self._ColorShop__swapLegColor, extraArgs = [
            -1])
        self.legRButton = DirectButton(relief = None, image = (guiRArrowUp, guiRArrowDown, guiRArrowRollover, guiRArrowUp), image3_color = Vec4(0.5, 0.5, 0.5, 0.75), text = Localizer.ColorShopLegs, text_scale = 0.0625, text_pos = (-0.025000000000000001, 0), text_fg = (0.80000000000000004, 0.10000000000000001, 0, 1), pos = (0, 0, -0.5), command = self._ColorShop__swapLegColor, extraArgs = [
            1])
        guiButton = loader.loadModelOnce('phase_3/models/gui/quit_button')
        self.toggleAllButton = DirectButton(parent = aspect2d, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (0.80000000000000004, 1.1000000000000001, 1.1000000000000001), pos = (-0.10000000000000001, 0, 0.55000000000000004), text = Localizer.ColorShopParts, text_scale = 0.059999999999999998, text_pos = (0.0, -0.02), command = self._ColorShop__toggleAllColor)
