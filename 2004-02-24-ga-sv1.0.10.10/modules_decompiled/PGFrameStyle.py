...
class PGFrameStyle(FFIExternalObject.FFIExternalObject):
    ...
    def setTexture(self, texture):
        returnValue = libpanda._inPWvimiaIb(self.this, texture.this)
        return returnValue

    
    def hasTexture(self):
        returnValue = libpanda._inPWvimKRv2(self.this)
        return returnValue

    
    def getTexture(self):
        returnValue = libpanda._inPWvimWoMM(self.this)
        import Texture
    ...
    def clearTexture(self):
        returnValue = libpanda._inPWvimpcTv(self.this)
        return returnValue
