...
class DistributedFurnitureManager(DistributedObject.DistributedObject):
    ...
    def disable(self):
        ...
        toonbase.localToon.setFurnitureDirector(0, self)
        self.director = 0
    ...
    def setOwnerId(self, ownerId):
        ...
        if self.ownerId == toonbase.localToon.doId:
    ...
    def releaseDirector(self):
        if self.director == toonbase.localToon.doId:
    ...
    def setDirector(self, avId):
        ...
        toonbase.localToon.setFurnitureDirector(avId, self)
        self.director = avId
    ...
    def moveItemFromAtticResponse(self, retcode, objectId, context):
        if retcode >= 0:
            dfitem = toonbase.tcr.doId2do[objectId]
        else:
            dfitem = None
        self.doCallbackContext(context, [
            retcode,
