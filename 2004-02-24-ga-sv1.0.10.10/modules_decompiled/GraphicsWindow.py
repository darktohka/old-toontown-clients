...
class GraphicsWindow(TypedWritableReferenceCount.TypedWritableReferenceCount, ClearableRegion.ClearableRegion, FFIExternalObject.FFIExternalObject):
    ...
    def _GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow_ptrConstFilename(self, filename):
        returnValue = libpanda._inPO9cY3aIS(self.this, filename.this)
        return returnValue

    
    def _GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow_atomicstring(self, prefix):
        returnValue = libpanda._inPO9cYOciA(self.this, prefix)
        import Filename
    ...
    def _GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow(self):
        returnValue = libpanda._inPO9cYT2wc(self.this)
        import Filename
        returnObject = Filename.Filename(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def takeScreenshot(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow()
        elif numArgs == 1:
            import Filename
            if isinstance(_args[0], types.StringType):
                return self._GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow_atomicstring(_args[0])
            elif isinstance(_args[0], Filename.Filename):
                return self._GraphicsWindow__overloaded_takeScreenshot_ptrGraphicsWindow_ptrConstFilename(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.StringType> <Filename.Filename> '
        else:
