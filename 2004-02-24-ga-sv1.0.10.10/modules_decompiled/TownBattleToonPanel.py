...
class TownBattleToonPanel(DirectFrame):
    ...
    def __init__(self, id):
        ...
        self.avatar = None
        self.sosText = DirectLabel(parent = self, relief = None, pos = (0.10000000000000001, 0, 0.014999999999999999), text = Localizer.TownBattleToonSOS, text_scale = 0.059999999999999998)
        self.sosText.hide()
        self.undecidedText = DirectLabel(parent = self, relief = None, pos = (0.10000000000000001, 0, 0.014999999999999999), text = Localizer.TownBattleUndecided, text_scale = 0.10000000000000001)
    ...
    def setHealthText(self, hp, maxHp):
        self.healthText['text'] = Localizer.TownBattleHealthText % {
            'hitPoints': hp,
            'maxHit': maxHp }
        return None
    ...
    def setValues(self, index, track, level = None, numTargets = None, targetIndex = None, localNum = None):
        ...
        elif track == BattleBase.SOS or track == BattleBase.NPCSOS:
            self.sosText.show()
