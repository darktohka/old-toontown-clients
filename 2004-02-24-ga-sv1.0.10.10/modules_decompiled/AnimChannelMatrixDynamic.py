...
class AnimChannelMatrixDynamic(AnimChannelACMatrixSwitchType.AnimChannelACMatrixSwitchType, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPn9gMrIUu:
            libpanda._inPn9gMrIUu(self.this)
    ...
    def setValue(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], TransformState.TransformState):
                return self._AnimChannelMatrixDynamic__overloaded_setValue_ptrAnimChannelMatrixDynamic_ptrConstTransformState(_args[0])
            elif isinstance(_args[0], Mat4.Mat4):
                return self._AnimChannelMatrixDynamic__overloaded_setValue_ptrAnimChannelMatrixDynamic_ptrConstLMatrix4f(_args[0])
            else:
