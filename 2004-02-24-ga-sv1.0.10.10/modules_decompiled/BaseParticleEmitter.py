...
class BaseParticleEmitter(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def _BaseParticleEmitter__overloaded_write_ptrConstBaseParticleEmitter_ptrOstream_int(self, out, indent):
        returnValue = libpandaphysics._inPKBUAlUM2(self.this, out.this, indent)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._BaseParticleEmitter__overloaded_write_ptrConstBaseParticleEmitter_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._BaseParticleEmitter__overloaded_write_ptrConstBaseParticleEmitter_ptrOstream_int(_args[0], _args[1])
                else:
