...
class Mat4(FFIExternalObject.FFIExternalObject):
    ...
    def _Mat4__overloaded_shearMat_ptrConstLVecBase3f___enum__CoordinateSystem(shear, cs):
        returnValue = libpanda._inPUZN3HFPp(shear.this, cs)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_shearMat_ptrConstLVecBase3f(shear):
        returnValue = libpanda._inPUZN3J0aS(shear.this)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_shearMat_float_float_float___enum__CoordinateSystem(shxy, shxz, shyz, cs):
        returnValue = libpanda._inPUZN3lQ9A(shxy, shxz, shyz, cs)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_shearMat_float_float_float(shxy, shxz, shyz):
        returnValue = libpanda._inPUZN3xxJO(shxy, shxz, shyz)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_scaleShearMat_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(scale, shear, cs):
        returnValue = libpanda._inPUZN3bl56(scale.this, shear.this, cs)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_scaleShearMat_ptrConstLVecBase3f_ptrConstLVecBase3f(scale, shear):
        returnValue = libpanda._inPUZN3gpnU(scale.this, shear.this)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_scaleShearMat_float_float_float_float_float_float___enum__CoordinateSystem(sx, sy, sz, shxy, shxz, shyz, cs):
        returnValue = libpanda._inPUZN38lik(sx, sy, sz, shxy, shxz, shyz, cs)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def _Mat4__overloaded_scaleShearMat_float_float_float_float_float_float(sx, sy, sz, shxy, shxz, shyz):
        returnValue = libpanda._inPUZN3j__t(sx, sy, sz, shxy, shxz, shyz)
        returnObject = Mat4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def shearMat(*_args):
        ...
        if numArgs == 1:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                return Mat4._Mat4__overloaded_shearMat_ptrConstLVecBase3f(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
        elif numArgs == 2:
            import VBase3
            if isinstance(_args[0], VBase3.VBase3):
                if isinstance(_args[1], types.IntType):
                    return Mat4._Mat4__overloaded_shearMat_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1])
                else:
            ...
            if isinstance(_args[0], types.FloatType) or isinstance(_args[0], types.IntType):
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        return Mat4._Mat4__overloaded_shearMat_float_float_float(_args[0], _args[1], _args[2])
                    else:
                        raise TypeError, 'Invalid argument 2, expected one of: <types.FloatType> '
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <types.FloatType> '
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.IntType):
                            return Mat4._Mat4__overloaded_shearMat_float_float_float___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3])
                        else:
    ...
    def scaleShearMat(*_args):
        ...
        if numArgs == 2:
            ...
            if isinstance(_args[0], VBase3.VBase3):
                import VBase3
                if isinstance(_args[1], VBase3.VBase3):
                    return Mat4._Mat4__overloaded_scaleShearMat_ptrConstLVecBase3f_ptrConstLVecBase3f(_args[0], _args[1])
                else:
                    raise TypeError, 'Invalid argument 1, expected one of: <VBase3.VBase3> '
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <VBase3.VBase3> '
            ...
            if isinstance(_args[0], VBase3.VBase3):
                ...
                if isinstance(_args[1], VBase3.VBase3):
                    if isinstance(_args[2], types.IntType):
                        return Mat4._Mat4__overloaded_scaleShearMat_ptrConstLVecBase3f_ptrConstLVecBase3f___enum__CoordinateSystem(_args[0], _args[1], _args[2])
                    else:
                ...
                if isinstance(_args[1], types.FloatType) or isinstance(_args[1], types.IntType):
                    if isinstance(_args[2], types.FloatType) or isinstance(_args[2], types.IntType):
                        if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                            if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    return Mat4._Mat4__overloaded_scaleShearMat_float_float_float_float_float_float(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5])
                                else:
                                    raise TypeError, 'Invalid argument 5, expected one of: <types.FloatType> '
                            else:
                                raise TypeError, 'Invalid argument 4, expected one of: <types.FloatType> '
                            ...
                            if isinstance(_args[4], types.FloatType) or isinstance(_args[4], types.IntType):
                                if isinstance(_args[5], types.FloatType) or isinstance(_args[5], types.IntType):
                                    if isinstance(_args[6], types.IntType):
                                        return Mat4._Mat4__overloaded_scaleShearMat_float_float_float_float_float_float___enum__CoordinateSystem(_args[0], _args[1], _args[2], _args[3], _args[4], _args[5], _args[6])
                                    else:
