...
class NurbsCurveEvaluator(ReferenceCount.ReferenceCount, FFIExternalObject.FFIExternalObject):
    ...
    def _NurbsCurveEvaluator__overloaded_getVertex_ptrConstNurbsCurveEvaluator_int_ptrConstNodePath(self, i, relTo):
        returnValue = libpanda._inPHc9WdIW3(self.this, i, relTo.this)
        import VBase4
        returnObject = VBase4.VBase4(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
    ...
    def getExtendedVertex(self, i, d):
        returnValue = libpanda._inPHc9WLQQ_(self.this, i, d)
        return returnValue
    ...
    def normalizeKnots(self):
        returnValue = libpanda._inPHc9Wnh_4(self.this)
        return returnValue

    
    def getNumSegments(self):
        returnValue = libpanda._inPHc9WHL14(self.this)
        return returnValue
    ...
    def output(self, out):
        returnValue = libpanda._inPHc9Wi3t0(self.this, out.this)
        return returnValue
    ...
    def getVertex(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], types.IntType):
                return self._NurbsCurveEvaluator__overloaded_getVertex_ptrConstNurbsCurveEvaluator_int(_args[0])
            else:
                raise TypeError, 'Invalid argument 0, expected one of: <types.IntType> '
        elif numArgs == 2:
            if isinstance(_args[0], types.IntType):
                ...
                if isinstance(_args[1], NodePath.NodePath):
                    return self._NurbsCurveEvaluator__overloaded_getVertex_ptrConstNurbsCurveEvaluator_int_ptrConstNodePath(_args[0], _args[1])
                else:
