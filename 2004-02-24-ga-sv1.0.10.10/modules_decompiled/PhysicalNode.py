...
class PhysicalNode(PandaNode.PandaNode, FFIExternalObject.FFIExternalObject):
    ...
    def _PhysicalNode__overloaded_write_ptrConstPhysicalNode_ptrOstream_unsignedint(self, out, indent):
        returnValue = libpandaphysics._inP9fJJWwip(self.this, out.this, indent)
        return returnValue
    ...
    def write(self, *_args):
        ...
        if numArgs == 1:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                return self._PhysicalNode__overloaded_write_ptrConstPhysicalNode_ptrOstream(_args[0])
            else:
            ...
            if isinstance(_args[0], Ostream.Ostream):
                if isinstance(_args[1], types.IntType):
                    return self._PhysicalNode__overloaded_write_ptrConstPhysicalNode_ptrOstream_unsignedint(_args[0], _args[1])
                else:
