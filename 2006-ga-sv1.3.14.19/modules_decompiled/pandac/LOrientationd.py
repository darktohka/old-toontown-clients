...
class LOrientationd(QuatD.QuatD, FFIExternalObject.FFIExternalObject):
    ...
    def _LOrientationd__overloaded___mul___ptrConstLOrientationd_ptrConstLOrientationd(self, other):
        returnValue = libpanda._inPVZN3HPvB(self.this, other.this)
    ...
    def __mul__(self, *_args):
        ...
        if numArgs == 1:
            if isinstance(_args[0], LOrientationd):
                return self._LOrientationd__overloaded___mul___ptrConstLOrientationd_ptrConstLOrientationd(*_args)
            
            import QuatD
            if isinstance(_args[0], QuatD.QuatD):
                return self._LOrientationd__overloaded___mul___ptrConstLOrientationd_ptrConstLQuaterniond(*_args)
            
            raise TypeError, 'Invalid argument 0, expected one of: <LOrientationd> <QuatD.QuatD> '
        else:
