    ...
    if numArgs == 3:
            ...
            if isinstance(_args[1], VBase3D.VBase3D):
                ...
                if isinstance(_args[2], VBase3D.VBase3D):
                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                        return __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_double___enum__CoordinateSystem(*_args)
        ...
        if isinstance(_args[0], Mat3.Mat3):
            ...
            if isinstance(_args[1], VBase3.VBase3):
                ...
                if isinstance(_args[2], VBase3.VBase3):
                    if isinstance(_args[3], types.FloatType) or isinstance(_args[3], types.IntType):
                        return __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_float___enum__CoordinateSystem(*_args)
...
def __overloaded_decomposeMatrix_ptrConstLMatrix3d_ptrLVecBase3d_ptrLVecBase3d_double___enum__CoordinateSystem(mat, scale, hpr, roll, cs):
    returnValue = libpanda._inPVZN3TW8r(mat.this, scale.this, hpr.this, roll, cs)
    return returnValue
...
def __overloaded_decomposeMatrix_ptrConstLMatrix3f_ptrLVecBase3f_ptrLVecBase3f_float___enum__CoordinateSystem(mat, scale, hpr, roll, cs):
    returnValue = libpanda._inPVZN3t0v6(mat.this, scale.this, hpr.this, roll, cs)
    return returnValue
