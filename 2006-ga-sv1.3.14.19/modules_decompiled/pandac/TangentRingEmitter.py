...
class TangentRingEmitter(BaseParticleEmitter.BaseParticleEmitter, FFIExternalObject.FFIExternalObject):
    ...
    def _TangentRingEmitter__overloaded_constructor(self):
        self.this = libpandaphysics._inPKBUAH572()
    ...
    def getRadius(self):
        returnValue = libpandaphysics._inPKBUA72eo(self.this)
        return returnValue
    ...
    def constructor(self, *_args):
        numArgs = len(_args)
        if numArgs == 0:
            return self._TangentRingEmitter__overloaded_constructor(*_args)
        elif numArgs == 1:
            return self._TangentRingEmitter__overloaded_constructor_ptrConstTangentRingEmitter(*_args)
        else:
