...
class DCClass(DCDeclaration.DCDeclaration, FFIExternalObject.FFIExternalObject):
    ...
    def aiFormatGenerate(self, distobj, doId, zoneId, districtChannelId, fromChannelId, optionalFields):
        returnValue = libdirect._inP5HfQbTT6(self.this, distobj, doId, zoneId, districtChannelId, fromChannelId, optionalFields)
        import Datagram
        returnObject = Datagram.Datagram(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
