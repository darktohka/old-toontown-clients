...
class Texture(ImageBuffer.ImageBuffer, FFIExternalObject.FFIExternalObject):
    ...
    def _Texture__overloaded_constructor_int_int_int_int___enum__Type___enum__Format_bool(self, xsize, ysize, components, componentWidth, type, format, bAllocateRAM):
        self.this = libpanda._inPMAKPwxuL(xsize, ysize, components, componentWidth, type, format, bAllocateRAM)
        self.userManagesMemory = 1
    ...
    def constructor(self, *_args):
        ...
        if numArgs == 0:
            ...
            raise TypeError, 'Invalid number of arguments: ' + `numArgs` + ', expected one of: 0 7 '
