...
class PartGroup(TypedWritableReferenceCount.TypedWritableReferenceCount, Namable.Namable, FFIExternalObject.FFIExternalObject):
    ...
    def destructor(self):
        if libpanda and libpanda._inPn9gMKbig:
            libpanda._inPn9gMKbig(self.this)
    ...
    def getNumChildren(self):
        returnValue = libpanda._inPn9gMwfp4(self.this)
        return returnValue
    ...
    def findChild(self, name):
        returnValue = libpanda._inPn9gM6aSh(self.this, name)
        returnObject = PartGroup(None)
        returnObject.this = returnValue
        if returnObject.this == 0:
            return None
    ...
    def upcastToNamable(self):
        returnValue = libpanda._inPn9gMEyTs(self.this)
        import Namable
