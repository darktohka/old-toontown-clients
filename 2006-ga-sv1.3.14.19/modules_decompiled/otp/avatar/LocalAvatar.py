...
class LocalAvatar(DistributedAvatar.DistributedAvatar, DistributedSmoothNode.DistributedSmoothNode):
    ...
    def setupControls(self):
        ...
        walkControls.initializeCollisions(self.cTrav, self, wallBitmask, floorBitmask, avatarRadius, floorOffset, reach)
        ...
        swimControls.initializeCollisions(self.cTrav, self, wallBitmask, floorBitmask, avatarRadius, floorOffset, reach)
        ...
        ghostControls.initializeCollisions(self.cTrav, self, ghostBitmask, floorBitmask, avatarRadius, floorOffset, reach)
    ...
    def clearPageUpDown(self):
        if self.isPageDown or self.isPageUp:
            self.lerpCameraFov(OTPGlobals.DefaultCameraFov, 0.59999999999999998)
            self.isPageDown = 0
            self.isPageUp = 0
            self.setCameraPositionByIndex(self.cameraIndex)
