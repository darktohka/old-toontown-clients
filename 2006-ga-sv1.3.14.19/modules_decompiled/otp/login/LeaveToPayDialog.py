...
class LeaveToPayDialog:
    ...
    def show(self):
        ...
        if self.dialog == None:
            ...
            DirectButton(self.dialog, image = okButtonImage, relief = None, text = directButtonYesText, text_scale = OTPLocalizer.LTPDdirectButtonYesText, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (-0.29999999999999999, 0.0, -0.10000000000000001), command = self.okHandler)
            DirectButton(self.dialog, image = cancelButtonImage, relief = None, text = directButtonNoText, text_scale = OTPLocalizer.LTPDdirectButtonNoText, text_pos = (0.0, -0.10000000000000001), textMayChange = 0, pos = (0.29999999999999999, 0.0, -0.10000000000000001), command = self.cancelHandler)
            buttons.removeNode()
