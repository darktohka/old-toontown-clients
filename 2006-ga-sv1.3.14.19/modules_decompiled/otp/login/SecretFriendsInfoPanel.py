...
class SecretFriendsInfoPanel(getGlobalDialogClass()):
    ...
    def __init__(self, doneEvent, hidePageNum = 0, pageChangeCallback = None):
        ...
        dialogClass.__init__(self, parent = aspect2d, dialogName = 'secretFriendsInfoDialog', doneEvent = doneEvent, okButtonText = OTPLocalizer.PrivacyPolicyClose, style = OTPDialog.Acknowledge, text = '', topPad = 1.5, sidePad = 1.2, pos = (0, 0, 0.10000000000000001), scale = 0.90000000000000002)
