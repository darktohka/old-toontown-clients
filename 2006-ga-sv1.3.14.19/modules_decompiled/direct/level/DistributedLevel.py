...
class DistributedLevel(DistributedObject.DistributedObject, Level.Level):
    ...
    def __init__(self, cr):
        ...
        self.titleText = OnscreenText.OnscreenText('', fg = self.titleColor, shadow = (0, 0, 0, 1), font = ToontownGlobals.getSuitFont(), pos = (0, -0.5), scale = 0.16 * self.getTitleTextScale(), drawOrder = 0, mayChange = 1)
