...
class OnScreenDebug:
    ...
    def load(self):
        ...
        self.onScreenText = OnscreenText.OnscreenText(pos = (-1.0, 0.90000000000000002), bg = Vec4(1, 1, 1, 0.84999999999999998), scale = (fontScale, fontScale, 0.0), align = TextNode.ALeft, mayChange = 1, font = font)
