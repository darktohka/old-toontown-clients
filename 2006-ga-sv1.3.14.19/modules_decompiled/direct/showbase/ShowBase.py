...
class ShowBase(DirectObject.DirectObject):
    ...
    def __init__(self):
        ...
        self.winBackgroundColor = VBase4(self.config.GetFloat('win-background-r', 0.40999999999999998), self.config.GetFloat('win-background-g', 0.40999999999999998), self.config.GetFloat('win-background-b', 0.40999999999999998), 1.0)
    ...
    def openWindow(self, props = None, pipe = None, gsg = None, type = None, name = None):
        if pipe == None:
            pipe = self.pipe
            if pipe == None:
                self.makeDefaultPipe()
    ...
    def makeCamera2d(self, win, chan = None, layer = None, layerSort = 10, displayRegion = (0, 1, 0, 1), coords = (-1, 1, -1, 1)):
        if chan == None:
            chan = win.getChannel(0)
    ...
    def makeCamera2dp(self, win, chan = None, layer = None, layerSort = 20, displayRegion = (0, 1, 0, 1), coords = (-1, 1, -1, 1)):
        if chan == None:
            chan = win.getChannel(0)
