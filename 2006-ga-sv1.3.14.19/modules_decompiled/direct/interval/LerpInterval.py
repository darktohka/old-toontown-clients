...
class LerpHprInterval(LerpNodePathInterval):
    ...
    def __init__(self, nodePath, duration, hpr, startHpr = None, other = None, blendType = 'noBlend', bakeInStart = 1, fluid = 0, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, fluid, nodePath, other)
...
class LerpPosHprInterval(LerpNodePathInterval):
    ...
    def __init__(self, nodePath, duration, pos, hpr, startPos = None, startHpr = None, other = None, blendType = 'noBlend', bakeInStart = 1, fluid = 0, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, fluid, nodePath, other)
...
class LerpHprScaleInterval(LerpNodePathInterval):
    ...
    def __init__(self, nodePath, duration, hpr, scale, startHpr = None, startScale = None, other = None, blendType = 'noBlend', bakeInStart = 1, fluid = 0, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, fluid, nodePath, other)
...
class LerpPosHprScaleInterval(LerpNodePathInterval):
    ...
    def __init__(self, nodePath, duration, pos, hpr, scale, startPos = None, startHpr = None, startScale = None, other = None, blendType = 'noBlend', bakeInStart = 1, fluid = 0, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, fluid, nodePath, other)
...
class LerpPosHprScaleShearInterval(LerpNodePathInterval):
    ...
    def __init__(self, nodePath, duration, pos, hpr, scale, shear, startPos = None, startHpr = None, startScale = None, startShear = None, other = None, blendType = 'noBlend', bakeInStart = 1, fluid = 0, name = None):
        LerpNodePathInterval.__init__(self, name, duration, blendType, bakeInStart, fluid, nodePath, other)
