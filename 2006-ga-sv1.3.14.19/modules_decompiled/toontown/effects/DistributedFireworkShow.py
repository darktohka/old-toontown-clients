...
class DistributedFireworkShow(DistributedObject.DistributedObject):
    ...
    def getFireworkShowIval(self, holidayId, index, startT):
        ...
        elif holidayId == OCTOBER31_FIREWORKS:
        ...
        elif holidayId == NOVEMBER19_FIREWORKS:
            startMessage = TTLocalizer.FireworksNovember19Beginning
            endMessage = TTLocalizer.FireworksNovember19Ending
            musicFile = 'phase_4/audio/bgm/firework_music.mid'
            holidayId = JULY4_FIREWORKS
        elif holidayId == FEBRUARY14_FIREWORKS:
            startMessage = TTLocalizer.FireworksFebruary14Beginning
