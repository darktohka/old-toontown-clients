...
class Toon(Avatar.Avatar, ToonHead):
    ...
    def _Toon__doToonGhostColorScale(self, scale, lerpTime):
        if scale == None:
            scale = VBase4(1, 1, 1, 1)
    ...
    def _Toon__doCheesyEffect(self, effect, lerpTime):
        if effect == ToontownGlobals.CEBigHead:
            ...
            return Sequence(self._Toon__doToonGhostColorScale(VBase4(1, 1, 1, alpha), lerpTime), Func(self.nametag3d.hide))
    ...
    def _Toon__undoCheesyEffect(self, effect, lerpTime):
        ...
        if effect == ToontownGlobals.CEBigLegs:
            ...
            return Sequence(Func(self.nametag3d.show), self._Toon__doToonGhostColorScale(None, lerpTime))
