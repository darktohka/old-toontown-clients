...
class InventoryNew(InventoryBase.InventoryBase, DirectFrame):
    ...
    def load(self):
        ...
        for track in range(0, len(Tracks)):
            ...
            self.trackNameLabels.append(DirectLabel(text = TextEncoder.upper(Tracks[track]), parent = self.trackRows[track], pos = (-0.71999999999999997, -0.10000000000000001, 0.01), scale = TTLocalizer.INtrackNameLabels, relief = None, text_fg = (0.20000000000000001, 0.20000000000000001, 0.20000000000000001, 1), text_font = getInterfaceFont(), text_align = TextNode.ALeft, textMayChange = 0))
