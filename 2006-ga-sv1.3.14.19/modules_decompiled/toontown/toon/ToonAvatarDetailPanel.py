...
class ToonAvatarDetailPanel(DirectFrame):
    ...
    def __init__(self, avId, avName, parent = aspect2d, **kw):
        ...
        self.bCancel = DirectButton(self, image = (buttons.find('**/CloseBtn_UP'), buttons.find('**/CloseBtn_DN'), buttons.find('**/CloseBtn_Rllvr')), relief = None, text = TTLocalizer.AvatarDetailPanelCancel, text_scale = TTLocalizer.TADPcancelButton, text_pos = (0.12, -0.01), pos = (-0.68000000000000005, 0.0, -0.76000000000000001), scale = 2.0, command = self._ToonAvatarDetailPanel__handleCancel)
        self.bCancel.hide()
    ...
    def _ToonAvatarDetailPanel__updateTrackInfo(self):
        ...
        for track in range(0, len(Tracks)):
            DirectLabel(parent = self, relief = None, text = TextEncoder.upper(TTLocalizer.BattleGlobalTracks[track]), text_scale = TTLocalizer.TADPtrackLabel, text_align = TextNode.ALeft, pos = (-0.70999999999999996, 0, 0.17000000000000001 + track * ySpacing))
