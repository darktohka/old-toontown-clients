...
class DistributedFireworksCannon(DistributedFireworkShow.DistributedFireworkShow):
    ...
    def generateInit(self):
        ...
        self.collSphere = CollisionSphere.CollisionSphere(0, 0, 0, 2.5)
        self.collSphere.setTangible(1)
        self.collNode = CollisionNode.CollisionNode(self.fireworksSphereEvent)
    ...
    def announceGenerate(self):
        ...
        self.accept(self.fireworksSphereEnterEvent, self._DistributedFireworksCannon__handleEnterSphere)
    ...
    def setMovie(self, mode, avId, timestamp):
        ...
        if mode == FIREWORKS_MOVIE_CLEAR:
            ...
            if isLocalToon:
                ...
                self.accept(self.fireworksGuiDoneEvent, self._DistributedFireworksCannon__handleFireworksDone)
