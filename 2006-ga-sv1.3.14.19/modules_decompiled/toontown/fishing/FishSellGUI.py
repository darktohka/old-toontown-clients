...
class FishSellGUI(DirectFrame):
    ...
    def __init__(self, doneEvent):
        ...
        self.cancelButton = DirectButton(parent = self, relief = None, image = cancelImageList, pos = (0.29999999999999999, 0, -0.57999999999999996), text = TTLocalizer.FishGuiCancel, text_scale = TTLocalizer.FSGcancelButton, text_pos = (0, -0.10000000000000001), command = self._FishSellGUI__cancel)
        self.okButton = DirectButton(parent = self, relief = None, image = okImageList, pos = (0.59999999999999998, 0, -0.57999999999999996), text = TTLocalizer.FishGuiOk, text_scale = TTLocalizer.FSGokButton, text_pos = (0, -0.10000000000000001), command = self._FishSellGUI__sellFish)
        buttons.removeNode()
