...
class DirectRegion(NodePath):
    ...
    def load(self):
        if not hasattr(self, 'cRender'):
            ...
            self.cDr = apply(self.cLayer.makeDisplayRegion, newBounds)
    ...
    def show(self, showBackground = 0):
        ...
        if showBackground:
            if not hasattr(self, 'background'):
                background = loader.loadModelCopy('phase_3.5/models/gui/stickerbook_gui')
