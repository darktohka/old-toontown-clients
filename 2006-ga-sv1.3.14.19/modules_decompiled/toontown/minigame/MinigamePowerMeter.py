...
class MinigamePowerMeter(DirectFrame):
    ...
    def _MinigamePowerMeter__createSpeedGauge(self):
        gaugeA = DirectWaitBar(parent = self, relief = RAISED, range = self.gaugeSize, frameSize = (-0.59999999999999998, 0.59999999999999998, -0.20000000000000001, 0.20000000000000001), borderWidth = (0.02, 0.02), scale = TTLocalizer.MPMgaugeA, pos = (0, 0, 0), frameColor = (0.0, 0.0, 0.0, 0.0), barColor = (0, 1, 0, 0.59999999999999998), sortOrder = FOREGROUND_SORT_INDEX)
        gaugeA.setR(90)
        gaugeA['value'] = 0
        self.largeGauge.append(gaugeA)
        gaugeTargetTop = DirectWaitBar(parent = self, relief = RAISED, range = self.gaugeSize, frameSize = (-0.59999999999999998, 0.59999999999999998, -0.20000000000000001, 0.20000000000000001), borderWidth = (0.02, 0.02), scale = TTLocalizer.MPMgaugeTargetTop, pos = (0, 0, 0), frameColor = (1, 1, 1, 1), barColor = (1, 0, 0, 1), sortOrder = BACKGROUND_SORT_INDEX + 1)
        gaugeTargetTop.setR(90)
        gaugeTargetTop['value'] = 1
        self.largeGauge.append(gaugeTargetTop)
        gaugeTargetBot = DirectWaitBar(parent = self, relief = RAISED, range = self.gaugeSize, frameSize = (-0.59999999999999998, 0.59999999999999998, -0.20000000000000001, 0.20000000000000001), borderWidth = (0.02, 0.02), scale = TTLocalizer.MPMgaugeTargetBot, pos = (0, 0, 0), frameColor = (1, 1, 1, 0), barColor = (1, 1, 1, 1), sortOrder = BACKGROUND_SORT_INDEX + 2)
