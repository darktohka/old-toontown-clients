...
class DistributedTugOfWarGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.roundText = DirectLabel(text = '     ', text_fg = (0, 1, 0, 1), frameColor = (1, 1, 1, 0), text_font = ToontownGlobals.getBuildingNametagFont(), pos = (0.014, 0, -0.83999999999999997), scale = 0.20000000000000001)
