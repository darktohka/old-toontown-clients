...
class DistributedRaceGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.chanceCard.text = OnscreenText('', fg = (1.0, 0, 0, 1), scale = 0.14000000000000001, font = ToontownGlobals.getBuildingNametagFont(), wordwrap = 14, pos = (0.0, 0.20000000000000001), mayChange = 1)
