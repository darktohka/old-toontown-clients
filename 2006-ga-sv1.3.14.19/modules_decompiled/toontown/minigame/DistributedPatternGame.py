...
class DistributedPatternGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.waitingText = DirectLabel(text = self.strPleaseWait, text_fg = (0.90000000000000002, 0.90000000000000002, 0.90000000000000002, 1.0), frameColor = (1, 1, 1, 0), text_font = ToontownGlobals.getBuildingNametagFont(), pos = (0, 0, -0.78000000000000003), scale = 0.12)
        self.roundText = DirectLabel(text = self.strRound % 1, text_fg = self.normalTextColor, frameColor = (1, 1, 1, 0), text_font = ToontownGlobals.getBuildingNametagFont(), pos = (0.014, 0, -0.83999999999999997), scale = 0.12)
        self.roundText.hide()
