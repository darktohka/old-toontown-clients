...
class DistributedTagGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.itText = OnscreenText.OnscreenText('itText', fg = (0.94999999999999996, 0.94999999999999996, 0.65000000000000002, 1), scale = 0.14000000000000001, font = ToontownGlobals.getBuildingNametagFont(), pos = (0.0, -0.80000000000000004), wordwrap = 15, mayChange = 1)
        self.itText.hide()
