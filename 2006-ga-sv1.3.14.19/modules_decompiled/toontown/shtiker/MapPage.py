...
class MapPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.hoodLabel = DirectLabel(parent = self.map, relief = None, pos = (-0.42999999999999999, 0, -0.72599999999999998), text = '', text_scale = TTLocalizer.MPhoodLabel, text_pos = (0, 0), text_wordwrap = TTLocalizer.MPhoodWordwrap)
        self.hoodLabel.hide()
