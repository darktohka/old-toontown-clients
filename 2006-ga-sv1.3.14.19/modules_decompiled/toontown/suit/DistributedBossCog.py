...
class DistributedBossCog(DistributedAvatar.DistributedAvatar, BossCog.BossCog):
    ...
    def __init__(self, cr):
        ...
        self.fsm = ClassicFSM.ClassicFSM('DistributedBossCog', [
    ...
    def announceGenerate(self):
        ...
        self.setName(TTLocalizer.BossCogName)
        ...
        self.prevCogSuitLevel = base.localAvatar.getCogLevels()[CogDisguiseGlobals.dept2deptIndex(self.style.dept)]
        if OneBossCog != None:
    ...
    def makeCageDropMovie(self, hasLocalToon):
        ...
        if hasLocalToon:
            seq += [
                Func(self.show),
                Func(camera.reparentTo, base.localAvatar),
                Func(camera.setPos, base.localAvatar.cameraPositions[0][0]),
    ...
    def _DistributedBossCog__makeCageOpenMovie(self):
        ...
        if self.prevCogSuitLevel < ToontownGlobals.MaxCogSuitLevel:
            ...
            newCogSuitLevel = base.localAvatar.getCogLevels()[CogDisguiseGlobals.dept2deptIndex(self.style.dept)]
    ...
    def _DistributedBossCog__showWaitingMessage(self, task):
        self._DistributedBossCog__showOnscreenMessage(TTLocalizer.BuildingWaitingForVictors)
    ...
    def enterReward(self):
        ...
        (victory, camVictory) = MovieToonVictory.doToonVictory(1, self.involvedToons, self.toonRewardIds, self.toonRewardDicts, self.deathList, self.rewardPanel)
    ...
    def _DistributedBossCog__outOfPies(self):
        self._DistributedBossCog__showOnscreenMessage(TTLocalizer.BossBattleNeedMorePies)
    ...
    def _DistributedBossCog__howToGetPies(self, task):
        self._DistributedBossCog__showOnscreenMessage(TTLocalizer.BossBattleHowToGetPies)

    
    def _DistributedBossCog__howToThrowPies(self, task):
        self._DistributedBossCog__showOnscreenMessage(TTLocalizer.BossBattleHowToThrowPies)
