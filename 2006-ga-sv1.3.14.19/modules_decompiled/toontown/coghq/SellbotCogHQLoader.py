...
class SellbotCogHQLoader(CogHQLoader.CogHQLoader):
    ...
    def loadPlaceGeom(self, zoneId):
        ...
        if zoneId == ToontownGlobals.SellbotHQ:
            ...
            dgText = DirectGui.OnscreenText(text = TTLocalizer.DaisyGardens[-1], font = ToontownGlobals.getSuitFont(), pos = (0, -0.29999999999999999), scale = TTLocalizer.SCLdgSign, parent = dgSign)
            ...
            factoryText = DirectGui.OnscreenText(text = TTLocalizer.Factory, font = ToontownGlobals.getSuitFont(), pos = (0, -0.34000000000000002), scale = 0.074999999999999997, parent = factorySign)
            ...
            fdTypeText = DirectGui.OnscreenText(text = TTLocalizer.Factory, font = ToontownGlobals.getSuitFont(), pos = (0, -0.25), scale = TTLocalizer.SCLfdSign, parent = fdSign)
