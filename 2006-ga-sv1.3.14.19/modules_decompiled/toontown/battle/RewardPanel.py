...
class RewardPanel(DirectFrame):
    ...
    def __init__(self, name):
        DirectFrame.__init__(self, relief = None, geom = getDefaultDialogGeom(), geom_color = ToontownGlobals.GlobalDialogColor, geom_scale = TTLocalizer.RPdirectFrame, pos = (0, 0, 0.58699999999999997))
        ...
        self.meritIncLabels = []
        self.meritBars = []
        self.meritBarTopLabel = DirectLabel(parent = self.gagExpFrame, relief = None, pos = (0.82499999999999996, 0, -0.050000000000000003), text = TTLocalizer.RewardPanelMeritBarLabel, text_pos = (0, 0), text_scale = 0.050000000000000003)
