...
class NameShop(PandaObject.PandaObject, StateData.StateData):
    ...
    def load(self):
        ...
        self.nameEntry = DirectEntry(parent = aspect2d, relief = None, scale = TTLocalizer.NSnameEntry, entryFont = getToonFont(), width = MAX_NAME_WIDTH, numLines = 2, focus = 0, cursorKeys = 1, pos = (0.0, 0.0, 0.39000000000000001), text_align = TextNode.ACenter, command = self._NameShop__typedAName)
        ...
        self.typeANameButton = DirectButton(parent = aspect2d, relief = None, image = (guiButton.find('**/QuitBtn_UP'), guiButton.find('**/QuitBtn_DN'), guiButton.find('**/QuitBtn_RLVR')), image_scale = (1, 1.1000000000000001, 0.90000000000000002), pos = (0.01, 0, -0.69499999999999995), scale = (1.6000000000000001, 1, 1.7), text = TTLocalizer.TypeANameButton, text_scale = TTLocalizer.NStypeANameButton, text_pos = (0, -0.02), command = self._NameShop__typeAName)
        ...
        self.nameResult = DirectLabel(parent = aspect2d, relief = None, scale = TTLocalizer.NSnameResult, pos = (0.040000000000000001, 0, 0.69999999999999996), text = ' \n ', text_align = TextNode.ACenter, text_wordwrap = MAX_NAME_WIDTH)
