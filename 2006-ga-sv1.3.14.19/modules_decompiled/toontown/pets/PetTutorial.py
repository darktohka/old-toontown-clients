...
class PetTutorial(DirectFrame, FSM.FSM):
    ...
    def __init__(self, doneEvent):
        ...
        self.title = DirectLabel(self, relief = None, text = '', text_pos = (0.0, 0.32000000000000001), text_fg = (1, 0, 0, 1), text_scale = TTLocalizer.PTtitle, text_font = ToontownGlobals.getSignFont())
