...
class FriendInviter(DirectFrame):
    ...
    def __init__(self, avId, avName, avDisableName):
        DirectFrame.__init__(self, pos = (0.29999999999999999, 0.10000000000000001, 0.65000000000000002), image_color = GlobalDialogColor, image_scale = (1.0, 1.0, 0.59999999999999998), text = '', text_wordwrap = 13.5, text_scale = TTLocalizer.FIdialog, text_pos = (0.0, 0.13))
        ...
        self.bCancel.hide()
        self.bStop = DirectButton(self, image = (gui.find('**/Ignore_Btn_UP'), gui.find('**/Ignore_Btn_DN'), gui.find('**/Ignore_Btn_RLVR')), relief = None, text = OTPLocalizer.FriendInviterStopBeingFriends, text_scale = TTLocalizer.FIstopButton, text_pos = (0.25, -0.014999999999999999), pos = (-0.20000000000000001, 0.0, 0.050000000000000003), command = self._FriendInviter__handleStop)
        self.bStop.hide()
